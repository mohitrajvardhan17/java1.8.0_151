  ...
  extends CDROutputStream
{
  ...
  {
    this(paramORB, GIOPVersion.V1_2);
  }
  
  public EncapsOutputStream(ORB paramORB, GIOPVersion paramGIOPVersion)
  {
    this(paramORB, paramGIOPVersion, false);
  }
  
  public EncapsOutputStream(ORB paramORB, boolean paramBoolean)
  {
    this(paramORB, GIOPVersion.V1_2, paramBoolean);
  }
  
  public EncapsOutputStream(ORB paramORB, GIOPVersion paramGIOPVersion, boolean paramBoolean)
  {
    super(paramORB, paramGIOPVersion, (byte)0, paramBoolean, BufferManagerFactory.newBufferManagerWrite(0, (byte)0, paramORB), (byte)1, false);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\corba\se\impl\encoding\EncapsOutputStream.class
