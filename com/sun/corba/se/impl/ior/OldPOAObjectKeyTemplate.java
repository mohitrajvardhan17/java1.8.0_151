  ...
  extends OldObjectKeyTemplateBase
{
  ...
  {
    this(paramORB, paramInt1, paramInt2, paramInputStream.read_long(), paramInputStream.read_long(), paramInputStream.read_long());
  }
  ...
  {
    super(paramORB, paramInt1, paramInt2, paramInt3, Integer.toString(paramInt4), new ObjectAdapterIdNumber(paramInt5));
  }
  ...
  public void writeTemplate(OutputStream paramOutputStream)
  {
    ...
    ObjectAdapterIdNumber localObjectAdapterIdNumber = (ObjectAdapterIdNumber)getObjectAdapterId();
    int j = localObjectAdapterIdNumber.getOldPOAId();
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\corba\se\impl\ior\OldPOAObjectKeyTemplate.class
