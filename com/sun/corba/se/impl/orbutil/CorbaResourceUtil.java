...
public class CorbaResourceUtil
{
  ...
  {
    return getText(paramString, Integer.toString(paramInt), null, null);
  }
  
  public static String getText(String paramString1, String paramString2)
  {
    return getText(paramString1, paramString2, null, null);
  }
  
  public static String getText(String paramString1, String paramString2, String paramString3)
  {
    return getText(paramString1, paramString2, paramString3, null);
  }
  ...
  private static void initResources()
  {
    ...
    {
      throw new Error("fatal: missing resource bundle: " + localMissingResourceException.getClassName());
    }
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\corba\se\impl\orbutil\CorbaResourceUtil.class
