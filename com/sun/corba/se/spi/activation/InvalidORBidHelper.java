...
public abstract class InvalidORBidHelper
{
    ...
    if (__typeCode == null) {
      synchronized (TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          __typeCode = ORB.init().create_exception_tc(id(), "InvalidORBid", arrayOfStructMember);
          __active = false;
        }
      }
    }
  ...
  {
    InvalidORBid localInvalidORBid = new InvalidORBid();
    paramInputStream.read_string();
    return localInvalidORBid;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\corba\se\spi\activation\InvalidORBidHelper.class
