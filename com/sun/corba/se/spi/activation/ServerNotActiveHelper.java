...
public abstract class ServerNotActiveHelper
{
  ...
  {
    ServerNotActive localServerNotActive = new ServerNotActive();
    paramInputStream.read_string();
    serverId = paramInputStream.read_long();
    return localServerNotActive;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\corba\se\spi\activation\ServerNotActiveHelper.class
