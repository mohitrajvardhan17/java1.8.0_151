  ...
  extends ComponentDirContext
{
  ...
  protected abstract NamingEnumeration<SearchResult> a_search(Attributes paramAttributes, String[] paramArrayOfString, Continuation paramContinuation)
    throws NamingException;
  
  protected abstract NamingEnumeration<SearchResult> a_search(String paramString1, String paramString2, Object[] paramArrayOfObject, SearchControls paramSearchControls, Continuation paramContinuation)
    throws NamingException;
  
  protected abstract NamingEnumeration<SearchResult> a_search(String paramString1, String paramString2, SearchControls paramSearchControls, Continuation paramContinuation)
    throws NamingException;
  ...
  protected NamingEnumeration<SearchResult> a_search_nns(Attributes paramAttributes, String[] paramArrayOfString, Continuation paramContinuation)
    throws NamingException
  {
  ...
  protected NamingEnumeration<SearchResult> a_search_nns(String paramString1, String paramString2, Object[] paramArrayOfObject, SearchControls paramSearchControls, Continuation paramContinuation)
    throws NamingException
  {
  ...
  protected NamingEnumeration<SearchResult> a_search_nns(String paramString1, String paramString2, SearchControls paramSearchControls, Continuation paramContinuation)
    throws NamingException
  {
    a_processJunction_nns(paramString1, paramContinuation);
    return null;
  ...
  protected DirContext a_getSchema_nns(Continuation paramContinuation)
    throws NamingException
  {
    a_processJunction_nns(paramContinuation);
    return null;
  ...
  protected DirContext a_getSchemaDefinition_nns(Continuation paramContinuation)
    throws NamingException
  {
    a_processJunction_nns(paramContinuation);
    return null;
    ...
    throws NamingException
  {
    if (resolve_to_penultimate_context(paramName, paramContinuation)) {
      return a_getAttributes(paramName.toString(), paramArrayOfString, paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_penultimate_context(paramName, paramContinuation)) {
      return a_createSubcontext(paramName.toString(), paramAttributes, paramContinuation);
    }
    return null;
  }
    ...
    throws NamingException
  {
    if (resolve_to_context(paramName, paramContinuation)) {
      return a_search(paramAttributes, paramArrayOfString, paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_penultimate_context(paramName, paramContinuation)) {
      return a_search(paramName.toString(), paramString, paramSearchControls, paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_penultimate_context(paramName, paramContinuation)) {
      return a_search(paramName.toString(), paramString, paramArrayOfObject, paramSearchControls, paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_context(paramName, paramContinuation)) {
      return a_getSchema(paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_context(paramName, paramContinuation)) {
      return a_getSchemaClassDefinition(paramContinuation);
    }
    return null;
  }
    ...
    throws NamingException
  {
    if (resolve_to_penultimate_context_nns(paramName, paramContinuation)) {
      return a_getAttributes_nns(paramName.toString(), paramArrayOfString, paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_penultimate_context_nns(paramName, paramContinuation)) {
      return a_createSubcontext_nns(paramName.toString(), paramAttributes, paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_penultimate_context_nns(paramName, paramContinuation)) {
      return a_search_nns(paramName.toString(), paramString, paramSearchControls, paramContinuation);
    }
    return null;
  }
  ...
  {
    if (resolve_to_penultimate_context_nns(paramName, paramContinuation)) {
      return a_search_nns(paramName.toString(), paramString, paramArrayOfObject, paramSearchControls, paramContinuation);
    }
    return null;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\jndi\toolkit\ctx\AtomicDirContext.class
