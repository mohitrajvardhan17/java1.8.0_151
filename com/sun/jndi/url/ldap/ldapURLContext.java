  ...
  extends GenericURLDirContext
{
  ...
  {
    return ldapURLContextFactory.getUsingURLIgnoreRootDN(paramString, paramHashtable);
  }
  
  protected Name getURLSuffix(String paramString1, String paramString2)
    throws NamingException
  {
    LdapURL localLdapURL = new LdapURL(paramString2);
  ...
  {
    if (LdapURL.hasQueryComponents(paramString)) {
      return searchUsingURL(paramString);
    }
    return super.search(paramString, paramAttributes);
  }
    ...
    throws NamingException
  {
    ...
    return super.search(paramString, paramAttributes, paramArrayOfString);
  }
  ...
  {
    if (LdapURL.hasQueryComponents(paramString1)) {
      return searchUsingURL(paramString1);
    }
    return super.search(paramString1, paramString2, paramSearchControls);
  }
    ...
    throws NamingException
  {
    ...
    return super.search(paramString1, paramString2, paramArrayOfObject, paramSearchControls);
  }
  ...
  private NamingEnumeration<SearchResult> searchUsingURL(String paramString)
    throws NamingException
  {
    ...
    try
    {
      NamingEnumeration localNamingEnumeration = localDirContext.search(localResolveResult.getRemainingName(), setFilterUsingURL(localLdapURL), setSearchControlsUsingURL(localLdapURL));
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\jndi\url\ldap\ldapURLContext.class
