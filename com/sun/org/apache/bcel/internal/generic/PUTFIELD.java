  ...
  implements PopInstruction, ExceptionThrower
{
  ...
  public PUTFIELD(int paramInt)
  {
    super((short)181, paramInt);
  }
  
  public int consumeStack(ConstantPoolGen paramConstantPoolGen)
  {
    return getFieldSize(paramConstantPoolGen) + 1;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\bcel\internal\generic\PUTFIELD.class
