  ...
  implements Scanner
{
  ...
  private char[] yy_buffer = new char['Ȁ'];
  ...
  private int[] yy_acpt = { 0, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 0, 4, 4, 4, 4, 0, 4, 4, 0, 4, 4, 0, 4, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 0, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 0, 0, 4, 0, 4, 0, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4 };
  ...
  {
    return (paramInt == 32) || (paramInt == 9) || (paramInt == 13) || (paramInt == 10) || (paramInt == 12);
  }
  
  Symbol disambiguateAxisOrFunction(int paramInt)
    throws Exception
  {
    for (int i = yy_buffer_index; (i < yy_buffer_read) && (isWhitespace(yy_buffer[i])); i++) {}
    if (i >= yy_buffer_read) {
      return new Symbol(paramInt);
    }
    return ((yy_buffer[i] == ':') && (yy_buffer[(i + 1)] == ':')) || (yy_buffer[i] == '(') ? newSymbol(paramInt) : newSymbol(27, yytext());
  }
  
  Symbol disambiguateOperator(int paramInt)
    throws Exception
  {
    switch (last)
    {
    ...
    throws IOException
  {
    ...
    if (0 != yy_buffer_start)
    {
      ...
      for (int k = 0; j < yy_buffer_read; k++)
      {
    ...
    for (yy_buffer_read += i; yy_buffer_index >= yy_buffer_read; yy_buffer_read += i)
    {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xalan\internal\xsltc\compiler\XPathLexer.class
