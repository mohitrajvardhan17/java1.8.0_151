  ...
  implements Attr, TypeInfo
{
    ...
    if (value != null)
    {
      if (localCoreDocumentImpl.getMutationEvents())
      {
        if (hasStringValue())
        {
          str = (String)value;
          if (textNode == null) {
            textNode = ((TextImpl)localCoreDocumentImpl.createTextNode((String)value));
          } else {
    ...
    throws DOMException
  {
    ...
    {
      ChildNode localChildNode4;
      if (localChildNode2 == null)
      {
        localChildNode4 = previousSibling;
        nextSibling = localChildNode1;
        previousSibling = localChildNode4;
        previousSibling = localChildNode1;
      }
      else if (paramNode2 == localChildNode3)
      {
        localChildNode3.isFirstChild(false);
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\dom\AttrImpl.class
