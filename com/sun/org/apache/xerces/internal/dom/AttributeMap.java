  ...
  extends NamedNodeMapImpl
{
  ...
  protected void reconcileDefaults(NamedNodeMapImpl paramNamedNodeMapImpl)
  {
    ...
    else
    {
      ...
      for (int k = 0; k < j; k++)
      {
        AttrImpl localAttrImpl2 = (AttrImpl)nodes.get(k);
        int m = findNamePoint(localAttrImpl2.getNodeName(), 0);
        if (m < 0)
        {
          m = -1 - m;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\dom\AttributeMap.class
