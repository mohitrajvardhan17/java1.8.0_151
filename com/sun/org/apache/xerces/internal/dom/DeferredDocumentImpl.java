  ...
  implements DeferredNode
{
  ...
  public int lookupElementDefinition(String paramString)
  {
    if (fNodeCount > 1)
    {
      ...
      j = i >> 8;
      k = i & 0xFF;
      for (m = getChunkIndex(fNodeLastChild, j, k); m != -1; m = getChunkIndex(fNodePrevSib, j, k))
      {
        j = m >> 8;
        k = m & 0xFF;
  ...
  public DeferredNode getNodeObject(int paramInt)
  {
    ...
    if (localObject != null) {
      return (DeferredNode)localObject;
    }
  ...
  public Object getTypeInfo(int paramInt)
  {
    ...
    {
      fNodeValue[i][j] = null;
      RefCount localRefCount = (RefCount)fNodeValue[i]['Ā'];
      fCount -= 1;
      if (fCount == 0) {
        fNodeValue[i] = null;
      }
  ...
  protected void synchronizeChildren()
  {
    ...
    for (int i = getLastChild(0); i != -1; i = getPrevSibling(i))
    {
      ...
      nextSibling = ((ChildNode)localObject1);
    ...
    {
      firstChild = ((ChildNode)localObject1);
      ((ChildNode)localObject1).isFirstChild(true);
      lastChild((ChildNode)localObject2);
    }
    mutationEvents = bool;
  }
  ...
  protected final void synchronizeChildren(AttrImpl paramAttrImpl, int paramInt)
  {
    ...
    else
    {
      ...
      if (localObject2 != null)
      {
        value = localObject1;
        ((ChildNode)localObject1).isFirstChild(true);
        paramAttrImpl.lastChild((ChildNode)localObject2);
      }
  ...
  protected final void synchronizeChildren(ParentNode paramParentNode, int paramInt)
  {
    ...
    if (localObject2 != null)
    {
      firstChild = ((ChildNode)localObject1);
      ((ChildNode)localObject1).isFirstChild(true);
      paramParentNode.lastChild((ChildNode)localObject2);
    }
    setMutationEvents(bool);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\dom\DeferredDocumentImpl.class
