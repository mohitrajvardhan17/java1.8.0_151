  ...
  implements Node, NodeList, EventTarget, Cloneable, Serializable
{
    ...
    throws DOMException
  {
    ...
    try
    {
      NodeImpl localNodeImpl = (NodeImpl)paramNode;
    }
    ...
    if (getNodeType() == 9) {
      localDocument = (Document)this;
    } else {
      localDocument = getOwnerDocument();
    }
    if (paramNode.getNodeType() == 9) {
      localObject1 = (Document)paramNode;
    } else {
      localObject1 = paramNode.getOwnerDocument();
    }
    if ((localDocument != localObject1) && (localDocument != null) && (localObject1 != null))
    {
      int i = ((CoreDocumentImpl)localObject1).getNodeNumber();
      int j = ((CoreDocumentImpl)localDocument).getNodeNumber();
      if (i > j) {
        return 37;
      }
      return 35;
    ...
    case 6: 
    case 12: 
      localDocumentType = localDocument.getDoctype();
      ...
      localObject5 = localObject3 = localDocument;
      break;
    case 10: 
      if (localObject6 == localDocument) {
        return 10;
      }
      if ((localDocument != null) && (localDocument == localObject1)) {
        return 4;
      }
      break;
    case 2: 
    ...
    case 12: 
      ...
      localObject6 = localObject4 = localDocument;
      break;
    case 10: 
      if (localObject5 == localObject1) {
        return 20;
      }
      if ((localObject1 != null) && (localDocument == localObject1)) {
        return 2;
      }
      break;
    case 2: 
  ...
  public String lookupPrefix(String paramString)
  {
    ...
    if (localObject != null) {
      return ((NodeImpl)localObject).lookupPrefix(paramString);
    }
    return null;
  }
  ...
  {
    flags = ((short)(paramBoolean ? flags | 0x8 : flags & 0xFFFFFFF7));
  }
  ...
  {
    flags = ((short)(paramBoolean ? flags | 0x10 : flags & 0xFFFFFFEF));
  }
  ...
  {
    flags = ((short)(paramBoolean ? flags | 0x20 : flags & 0xFFFFFFDF));
  }
  ...
  {
    flags = ((short)(paramBoolean ? flags | 0x40 : flags & 0xFFFFFFBF));
  }
  ...
  {
    flags = ((short)(paramBoolean ? flags | 0x80 : flags & 0xFF7F));
  }
  ...
  final void isNormalized(boolean paramBoolean)
  {
    ...
    flags = ((short)(paramBoolean ? flags | 0x100 : flags & 0xFEFF));
  }
  ...
  {
    flags = ((short)(paramBoolean ? flags | 0x200 : flags & 0xFDFF));
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\dom\NodeImpl.class
