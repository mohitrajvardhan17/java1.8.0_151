  ...
  extends ChildNode
{
  ...
  private Node nodeListItem(int paramInt)
  {
    ...
    if ((i != -1) && (localChildNode != null))
    {
      j = 0;
      if (i < paramInt) {
        while ((i < paramInt) && (localChildNode != null))
        {
          i++;
          localChildNode = nextSibling;
        }
  ...
  protected class UserDataRecord
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\dom\ParentNode.class
