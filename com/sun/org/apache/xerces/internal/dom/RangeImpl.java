  ...
  implements Range
{
  ...
  public Node getCommonAncestorContainer()
  {
    ...
    for (localNode = fEndContainer; localNode != null; localNode = localNode.getParentNode()) {
      localVector2.addElement(localNode);
    }
    int i = localVector1.size() - 1;
    int j = localVector2.size() - 1;
    Object localObject = null;
    while ((i >= 0) && (j >= 0) && (localVector1.elementAt(i) == localVector2.elementAt(j)))
    {
      localObject = localVector1.elementAt(i);
      i--;
      j--;
    }
    ...
    throws DOMException
  {
    ...
    int m;
    for (Object localObject4 = ((Node)localObject3).getParentNode(); localObject4 != null; localObject4 = ((Node)localObject4).getParentNode())
    {
      if (localObject4 == localObject1)
      {
        m = indexOf((Node)localObject3, (Node)localObject1);
        if (i <= m) {
          return 1;
        }
        return -1;
    ...
    for (localObject4 = ((Node)localObject3).getParentNode(); localObject4 != null; localObject4 = ((Node)localObject4).getParentNode())
    {
      if (localObject4 == localObject2)
      {
        m = indexOf((Node)localObject3, (Node)localObject2);
        if (m < j) {
          return 1;
        }
        return -1;
    ...
    int k = 0;
    for (localObject4 = localObject1; localObject4 != null; localObject4 = ((Node)localObject4).getParentNode()) {
      k++;
    }
    for (localObject4 = localObject2; localObject4 != null; localObject4 = ((Node)localObject4).getParentNode()) {
      k--;
    }
    while (k > 0)
    {
    ...
    localObject4 = ((Node)localObject1).getParentNode();
    for (Node localNode = ((Node)localObject2).getParentNode(); localObject4 != localNode; localNode = localNode.getParentNode())
    {
      localObject1 = localObject4;
      localObject2 = localNode;
      localObject4 = ((Node)localObject4).getParentNode();
    }
    for (localObject4 = ((Node)localObject1).getNextSibling(); localObject4 != null; localObject4 = ((Node)localObject4).getNextSibling()) {
      if (localObject4 == localObject2) {
        return 1;
      }
    }
  ...
  public String toString()
  {
    ...
    while ((localNode1 != localNode2) && (localNode1 != null))
    {
  ...
  void receiveDeletedText(Node paramNode, int paramInt1, int paramInt2)
  {
    ...
    if (fDeleteNode == paramNode) {
      return;
    }
    if ((paramNode == fStartContainer) && (fStartContainer.getNodeType() == 3)) {
    ...
    if ((paramNode == fEndContainer) && (fEndContainer.getNodeType() == 3)) {
  ...
  void receiveInsertedText(Node paramNode, int paramInt1, int paramInt2)
  {
    ...
    if ((paramNode == fStartContainer) && (fStartContainer.getNodeType() == 3) && (paramInt1 < fStartOffset)) {
      fStartOffset += paramInt2;
    }
    if ((paramNode == fEndContainer) && (fEndContainer.getNodeType() == 3) && (paramInt1 < fEndOffset)) {
      fEndOffset += paramInt2;
    }
  }
  
  void receiveReplacedText(Node paramNode)
  {
    if (paramNode == null) {
      return;
    }
    ...
    throws DOMException
  {
    ...
    for (Object localObject2 = ((Node)localObject1).getParentNode(); localObject2 != null; localObject2 = ((Node)localObject2).getParentNode())
    {
      if (localObject2 == fStartContainer) {
    ...
    int j = 0;
    localObject2 = fStartContainer;
    for (Object localObject3 = ((Node)localObject2).getParentNode(); localObject3 != null; localObject3 = ((Node)localObject3).getParentNode())
    {
      if (localObject3 == fEndContainer) {
    ...
    Node localNode1 = ((Node)localObject3).getParentNode();
    for (Node localNode2 = ((Node)localObject4).getParentNode(); localNode1 != localNode2; localNode2 = localNode2.getParentNode())
    {
  ...
  private Node traverseRightBoundary(Node paramNode, int paramInt)
  {
    ...
    Node localNode2;
    for (Object localObject2 = traverseNode(localNode1, false, false, paramInt); localNode1 != null; localObject2 = localNode2)
    {
      ...
      localNode1 = localNode1.getParentNode();
      localNode2 = traverseNode(localNode1, false, false, paramInt);
      if (paramInt != 3) {
  ...
  private Node traverseLeftBoundary(Node paramNode, int paramInt)
  {
    ...
    Node localNode1 = ((Node)localObject1).getParentNode();
    Node localNode2;
    for (Object localObject2 = traverseNode(localNode1, false, true, paramInt); localNode1 != null; localObject2 = localNode2)
    {
      while (localObject1 != null)
      {
      ...
      localNode1 = localNode1.getParentNode();
      localNode2 = traverseNode(localNode1, false, true, paramInt);
      if (paramInt != 3) {
        localNode2.appendChild((Node)localObject2);
      }
    }
  ...
  private Node traverseNode(Node paramNode, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    if (paramNode.getNodeType() == 3) {
      return traverseTextNode(paramNode, paramBoolean2, paramInt);
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\dom\RangeImpl.class
