  ...
  implements CharacterData, Text
{
  ...
  public String getWholeText()
  {
    ...
    getWholeTextBackward(getPreviousSibling(), fBufferStr, getParentNode());
    String str = fBufferStr.toString();
    fBufferStr.setLength(0);
    getWholeTextForward(getNextSibling(), fBufferStr, getParentNode());
    return str + fBufferStr.toString();
  }
    ...
    throws DOMException
  {
    ...
    for (Object localObject2 = ((Text)localObject1).getPreviousSibling(); (localObject2 != null) && ((((Node)localObject2).getNodeType() == 3) || (((Node)localObject2).getNodeType() == 4) || ((((Node)localObject2).getNodeType() == 5) && (hasTextOnlyChildren((Node)localObject2)))); localObject2 = ((Node)localObject2).getPreviousSibling())
    {
      localNode.removeChild((Node)localObject2);
      localObject2 = localObject1;
    }
    for (Object localObject3 = ((Text)localObject1).getNextSibling(); (localObject3 != null) && ((((Node)localObject3).getNodeType() == 3) || (((Node)localObject3).getNodeType() == 4) || ((((Node)localObject3).getNodeType() == 5) && (hasTextOnlyChildren((Node)localObject3)))); localObject3 = ((Node)localObject3).getNextSibling())
    {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\dom\TextImpl.class
