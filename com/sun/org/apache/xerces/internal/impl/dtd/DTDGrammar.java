  ...
  implements XMLDTDHandler, XMLDTDContentModelHandler, EntityState, Grammar
{
  ...
  {
    if ((paramString == null) || (fEntityIndexMap.get(paramString) == null)) {
      return -1;
    }
    return ((Integer)fEntityIndexMap.get(paramString)).intValue();
  }
  ...
  {
    if ((paramString == null) || (fNotationIndexMap.get(paramString) == null)) {
      return -1;
    }
    return ((Integer)fNotationIndexMap.get(paramString)).intValue();
  }
  ...
  public String getContentSpecAsString(int paramInt)
  {
    ...
    if (getContentSpec(k, localXMLContentSpec))
    {
      ...
      case 0: 
        ...
        break;
      case 1: 
        getContentSpec(((int[])(int[])value)[0], localXMLContentSpec);
        n = type;
        if (n == 0)
        {
          localStringBuffer.append('(');
  ...
  protected void setEntityDecl(int paramInt, XMLEntityDecl paramXMLEntityDecl)
  {
    ...
    fEntityIndexMap.put(name, Integer.valueOf(paramInt));
  }
  ...
  protected void setNotationDecl(int paramInt, XMLNotationDecl paramXMLNotationDecl)
  {
    ...
    fNotationIndexMap.put(name, Integer.valueOf(paramInt));
  }
  ...
  private void appendContentSpec(XMLContentSpec paramXMLContentSpec, StringBuffer paramStringBuffer, boolean paramBoolean, int paramInt)
  {
    ...
    case 1: 
      ...
      {
        getContentSpec(((int[])(int[])value)[0], paramXMLContentSpec);
  ...
  private synchronized ContentModelValidator createChildModel(int paramInt)
  {
    ...
    if (((type & 0xF) != 6) && ((type & 0xF) != 7) && ((type & 0xF) != 8))
    {
      ...
      if ((type == 4) || (type == 5))
      {
        ...
        getContentSpec(((int[])(int[])value)[0], (XMLContentSpec)localObject);
        getContentSpec(((int[])(int[])otherValue)[0], localXMLContentSpec2);
        if ((type == 0) && (type == 0))
        {
          fQName.setValues(null, (String)value, (String)value, (String)otherValue);
  ...
  private void contentSpecTree(int paramInt, XMLContentSpec paramXMLContentSpec, ChildrenList paramChildrenList)
  {
    ...
    int i = value != null ? ((int[])(int[])value)[0] : -1;
    int j = -1;
    if (otherValue != null) {
      j = ((int[])(int[])otherValue)[0];
    } else {
      return;
    }
    if ((type == 4) || (type == 5))
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\dtd\DTDGrammar.class
