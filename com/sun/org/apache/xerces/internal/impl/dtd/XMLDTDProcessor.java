  ...
  implements XMLComponent, XMLDTDFilter, XMLDTDContentModelFilter
{
    ...
    throws XMLConfigurationException
  {
    ...
    fDTDValidation = (!paramXMLComponentManager.getFeature("http://apache.org/xml/features/validation/schema", false));
    fWarnDuplicateAttdef = paramXMLComponentManager.getFeature("http://apache.org/xml/features/validation/warn-on-duplicate-attdef", false);
    fWarnOnUndeclaredElemdef = paramXMLComponentManager.getFeature("http://apache.org/xml/features/validation/warn-on-undeclared-elemdef", false);
    ...
    try
    {
      fValidator = ((XMLDTDValidator)paramXMLComponentManager.getProperty("http://apache.org/xml/properties/internal/validator/dtd", null));
    }
      ...
      if ((paramString3 == XMLSymbols.fENUMERATIONSymbol) || (paramString3 == XMLSymbols.fNOTATIONSymbol)) {
        for (m = 0; m < paramArrayOfString.length; m++) {
          for (int n = m + 1; n < paramArrayOfString.length; n++) {
            ...
            {
              fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", paramString3 == XMLSymbols.fENUMERATIONSymbol ? "MSG_DISTINCT_TOKENS_IN_ENUMERATION" : "MSG_DISTINCT_NOTATION_IN_ENUMERATION", new Object[] { paramString1, paramArrayOfString[m], paramString2 }, (short)1);
              break label466;
            }
          }
        }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\dtd\XMLDTDProcessor.class
