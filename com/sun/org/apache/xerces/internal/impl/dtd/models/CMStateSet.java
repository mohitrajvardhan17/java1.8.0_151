...
public class CMStateSet
{
  ...
  public final void intersection(CMStateSet paramCMStateSet)
  {
    ...
    else
    {
      ...
      {
        int tmp54_53 = i;
        byte[] tmp54_50 = fByteArray;
        tmp54_50[tmp54_53] = ((byte)(tmp54_50[tmp54_53] & fByteArray[i]));
      }
    }
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\dtd\models\CMStateSet.class
