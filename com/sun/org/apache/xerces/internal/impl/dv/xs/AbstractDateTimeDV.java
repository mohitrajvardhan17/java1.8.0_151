  ...
  extends TypeValidator
{
  ...
  protected int parseIntYear(String paramString, int paramInt)
  {
    ...
    while (m < paramInt)
    {
      i2 = getDigit(paramString.charAt(m++));
      if (i2 < 0) {
        throw new NumberFormatException("'" + paramString + "' has wrong format");
      }
      if (j < i1) {
    ...
    implements XSDateTime
  {
    ...
    public int hashCode()
    {
      DateTimeData localDateTimeData = new DateTimeData(null, type);
      type.cloneDate(this, localDateTimeData);
      type.normalize(localDateTimeData);
      return type.dateToString(localDateTimeData).hashCode();
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\dv\xs\AbstractDateTimeDV.class
