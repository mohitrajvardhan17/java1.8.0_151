  ...
  extends TypeValidator
{
    ...
    implements XSDecimal
  {
    ...
    public int hashCode()
    {
      ...
      i = 17 * i + intDigits;
      i = 17 * i + fracDigits;
      i = 17 * i + Objects.hashCode(ivalue);
      i = 17 * i + Objects.hashCode(fvalue);
      return i;
    }
    ...
    private void makeCanonical()
    {
      ...
      StringBuilder localStringBuilder = new StringBuilder(totalDigits + 3);
      if (sign == -1) {
        localStringBuilder.append('-');
      }
      if (intDigits != 0) {
        localStringBuilder.append(ivalue);
      } else {
      ...
      if (!integer)
      {
        localStringBuilder.append('.');
        if (fracDigits != 0) {
          localStringBuilder.append(fvalue);
        } else {
          localStringBuilder.append('0');
        }
      }
      canonical = localStringBuilder.toString();
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\dv\xs\DecimalDV.class
