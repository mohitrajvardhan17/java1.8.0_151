  ...
  extends AbstractDateTimeDV
{
  ...
  protected String dateToString(AbstractDateTimeDV.DateTimeData paramDateTimeData)
  {
    ...
    localStringBuffer.append('M');
    append2(localStringBuffer, (second < 0.0D ? -1 : 1) * second);
  ...
  protected Duration getDuration(AbstractDateTimeDV.DateTimeData paramDateTimeData)
  {
    ...
    return datatypeFactory.newDuration(i == 1, year != Integer.MIN_VALUE ? BigInteger.valueOf(i * year) : null, month != Integer.MIN_VALUE ? BigInteger.valueOf(i * month) : null, day != Integer.MIN_VALUE ? BigInteger.valueOf(i * day) : null, hour != Integer.MIN_VALUE ? BigInteger.valueOf(i * hour) : null, minute != Integer.MIN_VALUE ? BigInteger.valueOf(i * minute) : null, second != -2.147483648E9D ? new BigDecimal(String.valueOf(i * second)) : null);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\dv\xs\DurationDV.class
