  ...
  extends AbstractDateTimeDV
{
  ...
  {
    return datatypeFactory.newXMLGregorianCalendar(Integer.MIN_VALUE, unNormMonth, unNormDay, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, paramDateTimeData.hasTimeZone() ? timezoneHr * 60 + timezoneMin : Integer.MIN_VALUE);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\dv\xs\MonthDayDV.class
