...
public class CaseInsensitiveMap
{
  ...
  private static void buildCaseInsensitiveMap()
  {
    ...
    {
      i = Character.toLowerCase(k);
      int j = Character.toUpperCase(k);
      if ((i != j) || (i != k))
      {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xpath\regex\CaseInsensitiveMap.class
