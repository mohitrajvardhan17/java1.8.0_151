...
public final class REUtil
{
  ...
  public static void main(String[] paramArrayOfString)
  {
    ...
    try
    {
      ...
      for (int m = 0; m < localMatch.getNumberOfGroups(); m++)
      {
        if (m == 0) {
        ...
        if (localMatch.getBeginning(m) < 0)
        {
          System.out.println("-1");
        }
        else
        {
          System.out.print(localMatch.getBeginning(m) + ", " + localMatch.getEnd(m) + ", ");
          System.out.println("\"" + localMatch.getCapturedText(m) + "\"");
        }
      }
    }
    catch (ParseException localParseException)
    {
      ...
      {
        System.err.println("com.sun.org.apache.xerces.internal.utils.regex.ParseException: " + localParseException.getMessage());
        str3 = "        ";
        System.err.println(str3 + str1);
        int j = localParseException.getLocation();
        if (j >= 0)
        {
    ...
    throws ParseException
  {
    ...
    return (RegularExpression)localObject1;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xpath\regex\REUtil.class
