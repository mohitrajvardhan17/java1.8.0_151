...
class RegexParser
{
  ...
  public void setLocale(Locale paramLocale)
  {
    ...
    {
      if (paramLocale != null) {
        resources = SecuritySupport.getResourceBundle("com.sun.org.apache.xerces.internal.impl.xpath.regex.message", paramLocale);
      } else {
        resources = SecuritySupport.getResourceBundle("com.sun.org.apache.xerces.internal.impl.xpath.regex.message");
      }
    }
    ...
    throws ParseException
  {
    ...
    if (parenCount < 0) {
      throw ex("parser.factor.0", offset);
    }
    if (references != null)
    {
    ...
    throws ParseException
  {
    ...
    if ((i == 2) || (i == 7) || (i == 1))
    {
      localObject = Token.createEmpty();
    }
    else
    {
      localObject = parseFactor();
      Token.UnionToken localUnionToken = null;
    ...
    throws ParseException
  {
    ...
    case 0: 
      ...
      j = chardata;
      next();
      if ((REUtil.isHighSurrogate(j)) && (read() == 0) && (REUtil.isLowSurrogate(chardata)))
      {
    ...
    throws ParseException
  {
    ...
    int j;
    for (int k = 1; ((j = read()) != 1) && ((j != 0) || (chardata != 93) || (k != 0)); k = 0)
    {
      int m = chardata;
      int n = 0;
      int i1;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xpath\regex\RegexParser.class
