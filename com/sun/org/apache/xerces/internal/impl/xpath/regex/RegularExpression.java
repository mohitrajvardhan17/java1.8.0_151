  ...
  implements Serializable
{
  ...
  public boolean matches(char[] paramArrayOfChar, int paramInt1, int paramInt2, Match paramMatch)
  {
    ...
    {
      ??? = context.inuse ? new Context() : context;
      ((Context)???).reset(paramArrayOfChar, paramInt1, paramInt2, numberOfClosures);
    }
    if (paramMatch != null)
    {
    ...
    {
      i = match((Context)???, operations, start, 1, options);
      if (i == limit)
      {
        if (match != null)
        {
    ...
    if ((operations != null) && (operations.type == 7) && (operations.getChild().type == 0))
    {
      ...
      {
        j = start;
        k = match((Context)???, operations, start, 1, options);
      }
      else
      {
        int m = 1;
        for (j = start; j <= i; j++)
        {
          ...
          {
            if ((m != 0) && (0 <= (k = match((Context)???, operations, j, 1, options)))) {
              break;
            }
            m = 0;
          }
    ...
    else if (firstChar != null)
    {
      ...
      for (j = start; j <= i; j++)
      {
        ...
        if ((localRangeToken.match(n)) && (0 <= (k = match((Context)???, operations, j, 1, options)))) {
          break;
        }
      }
    }
    ...
    {
      for (j = start; (j <= i) && (0 > (k = match((Context)???, operations, j, 1, options))); j++) {}
    }
    if (k >= 0)
    {
      if (match != null)
  ...
  public boolean matches(String paramString, int paramInt1, int paramInt2, Match paramMatch)
  {
    ...
    {
      ??? = context.inuse ? new Context() : context;
      ((Context)???).reset(paramString, paramInt1, paramInt2, numberOfClosures);
    }
    if (paramMatch != null)
    {
      paramMatch.setNumberOfGroups(nofparen);
  ...
  public boolean matches(CharacterIterator paramCharacterIterator, Match paramMatch)
  {
    ...
    {
      ??? = context.inuse ? new Context() : context;
      ((Context)???).reset(paramCharacterIterator, i, j, numberOfClosures);
    }
    if (paramMatch != null)
    {
      paramMatch.setNumberOfGroups(nofparen);
    ...
    if ((operations != null) && (operations.type == 7) && (operations.getChild().type == 0))
    {
      ...
      {
        m = start;
        n = match((Context)???, operations, start, 1, options);
      }
      else
      {
        int i1 = 1;
        for (m = start; m <= k; m++)
        {
          ...
          {
            if ((i1 != 0) && (0 <= (n = match((Context)???, operations, m, 1, options)))) {
              break;
            }
            i1 = 0;
          }
    ...
    else if (firstChar != null)
    {
      ...
      for (m = start; m <= k; m++)
      {
        ...
        if ((localRangeToken.match(i2)) && (0 <= (n = match((Context)???, operations, m, 1, options)))) {
          break;
        }
      }
    }
    ...
    {
      for (m = start; (m <= k) && (0 > (n = match((Context)???, operations, m, 1, options))); m++) {}
    }
    if (n >= 0)
    {
      if (match != null)
    ...
    private final boolean regionMatchesIgnoreCase(int paramInt1, int paramInt2, String paramString, int paramInt3)
    {
      ...
      while (paramInt3-- > 0)
      {
        ...
        if (c1 != c2)
        {
          ...
          if (c3 != c4) {
            if (Character.toLowerCase(c3) != Character.toLowerCase(c4)) {
              return false;
            }
          }
        }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xpath\regex\RegularExpression.class
