  ...
  implements Serializable
{
  ...
  final int analyzeFirstCharacter(RangeToken paramRangeToken, int paramInt)
  {
    ...
    case 2: 
      ...
      for (m = 0; m < size(); m++)
      {
        j = getChild(m).analyzeFirstCharacter(paramRangeToken, paramInt);
        if (j == 2) {
          break;
        }
        if (j == 0) {
      ...
      return k != 0 ? 0 : j;
    case 26: 
      m = getChild(0).analyzeFirstCharacter(paramRangeToken, paramInt);
      if (size() == 1) {
        return 0;
      }
      if (m == 2) {
      ...
      int n = getChild(1).analyzeFirstCharacter(paramRangeToken, paramInt);
      if (n == 2) {
        return n;
      }
      return (m == 0) || (n == 0) ? 0 : 1;
    ...
    case 12: 
      ...
      return 2;
    case 10: 
      int i2 = getString().charAt(0);
      int i3;
      if ((REUtil.isHighSurrogate(i2)) && (getString().length() >= 2) && (REUtil.isLowSurrogate(i3 = getString().charAt(1)))) {
        i2 = REUtil.composeFromSurrogates(i2, i3);
      }
      paramRangeToken.addRange(i2, i2);
      if ((i2 < 65536) && (isSet(paramInt, 2)))
      {
        i2 = Character.toUpperCase((char)i2);
        paramRangeToken.addRange(i2, i2);
  ...
  protected static RangeToken getRange(String paramString, boolean paramBoolean)
  {
    if (categories.size() == 0) {
      synchronized (categories)
      {
        ...
        for (j = 0; j < arrayOfToken.length; j++) {
          if (categoryNames[j] != null)
          {
            if (j == 0) {
              arrayOfToken[j].addRange(65536, 1114111);
            }
            categories.put(categoryNames[j], arrayOfToken[j]);
            categories2.put(categoryNames[j], complementRanges(arrayOfToken[j]));
          }
        }
        StringBuilder localStringBuilder = new StringBuilder(50);
        for (int k = 0; k < blockNames.length; k++)
        {
          localRangeToken2 = createRange();
          int m;
          int i1;
          if (k < 84)
          {
            m = k * 2;
            int n = "\000ÿĀſƀɏɐʯʰ˿̀ͯͰϿЀӿ԰֏֐׿؀ۿ܀ݏހ޿ऀॿঀ৿਀੿઀૿଀୿஀௿ఀ౿ಀ೿ഀൿ඀෿฀๿຀໿ༀ࿿က႟Ⴀჿᄀᇿሀ፿Ꭰ᏿᐀ᙿ ᚟ᚠ᛿ក៿᠀᢯Ḁỿἀ῿ ⁯⁰₟₠⃏⃐⃿℀⅏⅐↏←⇿∀⋿⌀⏿␀␿⑀⑟①⓿─╿▀▟■◿☀⛿✀➿⠀⣿⺀⻿⼀⿟⿰⿿　〿぀ゟ゠ヿ㄀ㄯ㄰㆏㆐㆟ㆠㆿ㈀㋿㌀㏿㐀䶵一鿿ꀀ꒏꒐꓏가힣豈﫿ﬀﭏﭐ﷿︠︯︰﹏﹐﹯ﹰ﻾﻿﻿＀￯".charAt(m);
            i1 = "\000ÿĀſƀɏɐʯʰ˿̀ͯͰϿЀӿ԰֏֐׿؀ۿ܀ݏހ޿ऀॿঀ৿਀੿઀૿଀୿஀௿ఀ౿ಀ೿ഀൿ඀෿฀๿຀໿ༀ࿿က႟Ⴀჿᄀᇿሀ፿Ꭰ᏿᐀ᙿ ᚟ᚠ᛿ក៿᠀᢯Ḁỿἀ῿ ⁯⁰₟₠⃏⃐⃿℀⅏⅐↏←⇿∀⋿⌀⏿␀␿⑀⑟①⓿─╿▀▟■◿☀⛿✀➿⠀⣿⺀⻿⼀⿟⿰⿿　〿぀ゟ゠ヿ㄀ㄯ㄰㆏㆐㆟ㆠㆿ㈀㋿㌀㏿㐀䶵一鿿ꀀ꒏꒐꓏가힣豈﫿ﬀﭏﭐ﷿︠︯︰﹏﹐﹯ﹰ﻾﻿﻿＀￯".charAt(m + 1);
            localRangeToken2.addRange(n, i1);
          }
          else
          {
            m = (k - 84) * 2;
            localRangeToken2.addRange(nonBMPBlockRanges[m], nonBMPBlockRanges[(m + 1)]);
          }
          localObject1 = blockNames[k];
          if (((String)localObject1).equals("Specials")) {
            localRangeToken2.addRange(65520, 65533);
          }
          if (((String)localObject1).equals("Private Use"))
          {
            localRangeToken2.addRange(983040, 1048573);
            localRangeToken2.addRange(1048576, 1114109);
          }
          categories.put(localObject1, localRangeToken2);
          categories2.put(localObject1, complementRanges(localRangeToken2));
          localStringBuilder.setLength(0);
          localStringBuilder.append("Is");
          if (((String)localObject1).indexOf(' ') >= 0) {
            for (i1 = 0; i1 < ((String)localObject1).length(); i1++) {
              if (((String)localObject1).charAt(i1) != ' ') {
                localStringBuilder.append(((String)localObject1).charAt(i1));
              }
            }
          } else {
            localStringBuilder.append((String)localObject1);
          }
          setAlias(localStringBuilder.toString(), (String)localObject1, true);
        }
        ...
        localRangeToken3.mergeRanges(localRangeToken2);
        localRangeToken3.mergeRanges(arrayOfToken[9]);
        categories.put("IsAlnum", localRangeToken3);
        categories2.put("IsAlnum", complementRanges(localRangeToken3));
        registerNonXS("IsAlnum");
        Object localObject1 = createRange();
        ((Token)localObject1).mergeRanges(token_spaces);
        ((Token)localObject1).mergeRanges(arrayOfToken[34]);
        categories.put("IsSpace", localObject1);
        categories2.put("IsSpace", complementRanges((Token)localObject1));
        registerNonXS("IsSpace");
        RangeToken localRangeToken4 = createRange();
        localRangeToken4.mergeRanges(localRangeToken3);
    ...
    implements Serializable
  {
    ...
    void addChild(Token paramToken)
    {
      ...
      Object localObject = (Token)children.get(i - 1);
      ...
      if (type == 0)
      {
        localStringBuilder = new StringBuilder(2 + j);
        k = ((Token)localObject).getChar();
        if (k >= 65536) {
          localStringBuilder.append(REUtil.decomposeToSurrogates(k));
        } else {
          localStringBuilder.append((char)k);
        }
        localObject = Token.createString(null);
        children.set(i - 1, localObject);
      }
      else
      {
        localStringBuilder = new StringBuilder(((Token)localObject).getString().length() + j);
        localStringBuilder.append(((Token)localObject).getString());
      }
      if (type == 0)
      {
      ...
      {
        localStringBuilder.append(paramToken.getString());
      }
      string = new String(localStringBuilder);
    }
    ...
    Token getChild(int paramInt)
    {
      return (Token)children.get(paramInt);
    }
    ...
    public String toString(int paramInt)
    {
      ...
      if (type == 1)
      {
        ...
        else
        {
          ...
          for (i = 0; i < children.size(); i++) {
            ((StringBuilder)localObject).append(((Token)children.get(i)).toString(paramInt));
          }
          str = new String((StringBuilder)localObject);
        }
        return str;
      }
      ...
      {
        localObject = new StringBuilder();
        ((StringBuilder)localObject).append(((Token)children.get(0)).toString(paramInt));
    ...
    private void writeObject(ObjectOutputStream paramObjectOutputStream)
      throws IOException
    {
      Vector localVector = children == null ? null : new Vector(children);
      ObjectOutputStream.PutField localPutField = paramObjectOutputStream.putFields();
      localPutField.put("children", localVector);
      ...
      throws IOException, ClassNotFoundException
    {
      ...
      Vector localVector = (Vector)localGetField.get("children", null);
      if (localVector != null) {
        children = new ArrayList(localVector);
      }
    }
  }
}
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xpath\regex\Token.class
