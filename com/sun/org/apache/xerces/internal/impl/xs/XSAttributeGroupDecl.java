  ...
  implements XSAttributeGroupDefinition
{
  ...
  public Object[] validRestrictionOf(String paramString, XSAttributeGroupDecl paramXSAttributeGroupDecl)
  {
    ...
    for (int i = 0; i < fAttrUseNum; i++)
    {
      ...
      if (localXSAttributeUseImpl2 != null)
      {
        ...
        if (fUse != 2)
        {
          ...
          int j = fConstraintType != 0 ? fConstraintType : localXSAttributeDecl2.getConstraintType();
    ...
    for (i = 0; i < fAttrUseNum; i++)
    {
      localXSAttributeUseImpl2 = fAttributeUses[i];
      if (fUse == 1)
      {
        localXSAttributeDecl2 = fAttrDecl;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xs\XSAttributeGroupDecl.class
