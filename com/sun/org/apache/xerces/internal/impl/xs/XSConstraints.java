  ...
  public static void fullSchemaChecking(XSGrammarBucket paramXSGrammarBucket, SubstitutionGroupHandler paramSubstitutionGroupHandler, CMBuilder paramCMBuilder, XMLErrorReporter paramXMLErrorReporter)
  {
    ...
    for (int j = arrayOfSchemaGrammar.length - 1; j >= 0; j--)
    {
      ...
      while (k < localObject1.length)
      {
        ...
        localObject3 = fModelGroup;
        Object localObject4 = localObject1[(k++)];
        XSModelGroupImpl localXSModelGroupImpl = fModelGroup;
        fValue = ((XSTerm)localObject3);
        fValue = localXSModelGroupImpl;
        ...
        else if (localObject3 == null)
        {
          ...
          catch (XMLSchemaException localXMLSchemaException1)
          {
            ...
            reportSchemaError(paramXMLErrorReporter, arrayOfSimpleLocator[(k / 2 - 1)], "src-redefine.6.2.2", new Object[] { fName, localObject6 });
          }
        }
      }
    }
    ...
    for (int n = arrayOfSchemaGrammar.length - 1; n >= 0; n--)
    {
      ...
      for (int i1 = 0; i1 < arrayOfXSComplexTypeDecl.length; i1++)
      {
        if ((!bool2) && (fParticle != null))
        {
          ...
          try
          {
            checkElementDeclsConsistent(arrayOfXSComplexTypeDecl[i1], fParticle, (SymbolHash)localObject3, paramSubstitutionGroupHandler);
          }
        ...
        {
          localObject5 = fParticle;
          localObject6 = fBaseType).fParticle;
          if (localObject5 == null)
          {
            if ((localObject6 != null) && (!((XSParticleDecl)localObject6).emptiable())) {
              reportSchemaError(paramXMLErrorReporter, localObject1[i1], "derivation-ok-restriction.5.3.2", new Object[] { fName, fBaseType.getName() });
            }
          }
            ...
            catch (XMLSchemaException localXMLSchemaException4)
            {
              ...
              reportSchemaError(paramXMLErrorReporter, localObject1[i1], "derivation-ok-restriction.5.4.2", new Object[] { fName });
            }
          } else {
            reportSchemaError(paramXMLErrorReporter, localObject1[i1], "derivation-ok-restriction.5.4.2", new Object[] { fName });
          }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xs\XSConstraints.class
