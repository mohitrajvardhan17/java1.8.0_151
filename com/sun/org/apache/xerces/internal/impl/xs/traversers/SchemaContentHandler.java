  ...
  private void addNamespaceDeclarations(int paramInt)
  {
    ...
    for (int i = 0; i < paramInt; i++)
    {
      ...
      if (str3.length() > 0)
      {
        ...
        localObject = str3;
        str2 = fSymbolTable.addSymbol(str1 + ":" + (String)localObject);
      }
      else
      {
      ...
      fAttributes.addAttribute(fAttributeQName, XMLSymbols.fCDATASymbol, str4);
    }
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xs\traversers\SchemaContentHandler.class
