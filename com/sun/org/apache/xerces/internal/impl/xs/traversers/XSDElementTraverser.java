  ...
  extends XSDAbstractTraverser
{
  ...
  XSElementDecl traverseNamedElement(Element paramElement, Object[] paramArrayOfObject, XSDocumentInfo paramXSDocumentInfo, SchemaGrammar paramSchemaGrammar, boolean paramBoolean, XSObject paramXSObject)
  {
    ...
    if (localXInt1 == null)
    {
      fBlock = fBlockDefault;
      if (fBlock != 31)
      {
        Object tmp282_280 = localObject1;
        282280fBlock = ((short)(282280fBlock & 0x7));
      }
    }
    else
    {
      fBlock = localXInt1.shortValue();
      if ((fBlock != 31) && ((fBlock | 0x7) != 7)) {
        reportSchemaError("s4s-att-invalid-value", new Object[] { fName, "block", "must be (#all | List of (extension | restriction | substitution))" }, paramElement);
      }
    }
    fFinal = (localXInt2 == null ? fFinalDefault : localXInt2.shortValue());
    Object tmp382_380 = localObject1;
    382380fFinal = ((short)(382380fFinal & 0x3));
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\impl\xs\traversers\XSDElementTraverser.class
