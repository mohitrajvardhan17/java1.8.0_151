  ...
  extends DatatypeFactory
{
  ...
  {
    return new DurationYearMonthImpl(paramBoolean, paramBigInteger1, paramBigInteger2);
  }
  
  public Duration newDurationYearMonth(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    return new DurationYearMonthImpl(paramBoolean, paramInt1, paramInt2);
  }
  
  public Duration newDurationYearMonth(String paramString)
  {
    return new DurationYearMonthImpl(paramString);
  }
  
  public Duration newDurationYearMonth(long paramLong)
  {
    return new DurationYearMonthImpl(paramLong);
  }
  ...
  {
    return new DurationDayTimeImpl(paramLong);
  }
  ...
  {
    return new DurationDayTimeImpl(paramBoolean, paramInt1, paramInt2, paramInt3, paramInt4);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\jaxp\datatype\DatatypeFactoryImpl.class
