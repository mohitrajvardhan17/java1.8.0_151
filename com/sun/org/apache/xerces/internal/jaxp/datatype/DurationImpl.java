  ...
  implements Serializable
{
  ...
  protected int calcSignum(boolean paramBoolean)
  {
  ...
  {
    this(paramBoolean, wrap(paramInt1), wrap(paramInt2), wrap(paramInt3), wrap(paramInt4), wrap(paramInt5), paramInt6 != Integer.MIN_VALUE ? new BigDecimal(String.valueOf(paramInt6)) : null);
  }
  
  protected static BigInteger wrap(int paramInt)
  {
  ...
  protected DurationImpl(long paramLong)
  {
    ...
    long l2 = 0L;
    l2 = localGregorianCalendar.get(1) - 1970;
    years = BigInteger.valueOf(l2);
    l2 = localGregorianCalendar.get(2);
    months = BigInteger.valueOf(l2);
    l2 = localGregorianCalendar.get(5) - 1;
    days = BigInteger.valueOf(l2);
    l2 = localGregorianCalendar.get(11);
    hours = BigInteger.valueOf(l2);
    l2 = localGregorianCalendar.get(12);
    minutes = BigInteger.valueOf(l2);
    l2 = localGregorianCalendar.get(13) * 1000 + localGregorianCalendar.get(14);
    seconds = BigDecimal.valueOf(l2, 3);
  }
  ...
  public int compare(Duration paramDuration)
  {
    ...
    if ((seconds != null) && (seconds.toBigInteger().compareTo(localBigInteger1) == 1)) {
      throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", new Object[] { getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.SECONDS.toString(), seconds.toString() }));
    }
  ...
  public String toString()
  {
    ...
    if (years != null) {
      localStringBuffer.append(years + "Y");
    }
    if (months != null) {
      localStringBuffer.append(months + "M");
    }
    if (days != null) {
      localStringBuffer.append(days + "D");
    }
    if ((hours != null) || (minutes != null) || (seconds != null))
    {
      localStringBuffer.append('T');
      if (hours != null) {
        localStringBuffer.append(hours + "H");
      }
      if (minutes != null) {
        localStringBuffer.append(minutes + "M");
      }
      if (seconds != null) {
        localStringBuffer.append(toString(seconds) + "S");
      }
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\jaxp\datatype\DurationImpl.class
