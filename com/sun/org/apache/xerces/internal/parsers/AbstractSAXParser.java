  ...
  implements PSVIProvider, Parser, XMLReader
{
    ...
    throws SAXException, IOException
  {
    ...
    catch (XMLParseException localXMLParseException)
    {
      ...
      {
        LocatorImpl local1 = new LocatorImpl()
        {
        ...
        local1.setPublicId(localXMLParseException.getPublicId());
        local1.setSystemId(localXMLParseException.getExpandedSystemId());
        local1.setLineNumber(localXMLParseException.getLineNumber());
        local1.setColumnNumber(localXMLParseException.getColumnNumber());
        throw new SAXParseException(localXMLParseException.getMessage(), local1);
      }
    ...
    throws SAXException, IOException
  {
    ...
    catch (XMLParseException localXMLParseException)
    {
      ...
      if (localException == null)
      {
        LocatorImpl local2 = new LocatorImpl()
        {
          public String getXMLVersion()
          {
            return fVersion;
        ...
        local2.setPublicId(localXMLParseException.getPublicId());
        local2.setSystemId(localXMLParseException.getExpandedSystemId());
        local2.setLineNumber(localXMLParseException.getLineNumber());
        local2.setColumnNumber(localXMLParseException.getColumnNumber());
        throw new SAXParseException(localXMLParseException.getMessage(), local2);
      }
      if ((localException instanceof SAXException)) {
        throw ((SAXException)localException);
      }
    ...
    throws SAXNotRecognizedException, SAXNotSupportedException
  {
    try
    {
      ...
      else if ((paramString.equals("http://javax.xml.XMLConstants/feature/secure-processing")) && (paramBoolean) && (fConfiguration.getProperty("http://apache.org/xml/properties/security-manager") == null))
      {
        fConfiguration.setProperty("http://apache.org/xml/properties/security-manager", new XMLSecurityManager());
      }
      fConfiguration.setFeature(paramString, paramBoolean);
    }
    catch (XMLConfigurationException localXMLConfigurationException)
    ...
    throws SAXNotRecognizedException, SAXNotSupportedException
  {
    try
    {
      if (paramString.startsWith("http://xml.org/sax/features/"))
      {
        ...
        if ((i == "namespace-prefixes".length()) && (paramString.endsWith("namespace-prefixes")))
        {
          boolean bool = fConfiguration.getFeature(paramString);
          return bool;
        }
        if ((i == "string-interning".length()) && (paramString.endsWith("string-interning"))) {
          return true;
    ...
    throws XNIException
  {
    ...
    fNamespacePrefixes = fConfiguration.getFeature("http://xml.org/sax/features/namespace-prefixes");
    fAugmentations = null;
    fDeclaredAttrs = null;
  }
    ...
    implements AttributeList, Attributes2
  {
    ...
    {
      return paramString1.equals("") ? fAttributes.getType(null, paramString2) : fAttributes.getType(paramString1, paramString2);
    }
    ...
    {
      return paramString1.equals("") ? fAttributes.getValue(null, paramString2) : fAttributes.getValue(paramString1, paramString2);
    }
    ...
    {
      return paramString1.equals("") ? fAttributes.getIndex(null, paramString2) : fAttributes.getIndex(paramString1, paramString2);
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\parsers\AbstractSAXParser.class
