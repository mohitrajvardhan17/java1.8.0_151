...
public class DOMUtil
{
  ...
  {
    for (Node localNode = paramNode.getFirstChild(); localNode != null; localNode = localNode.getNextSibling()) {
      if ((localNode.getNodeType() == 1) && (!isHidden(localNode, paramMap))) {
        return (Element)localNode;
      }
    }
    return null;
  ...
  {
    if ((paramNode instanceof com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)) {
      ((com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)paramNode).setReadOnly(true, false);
    } else if ((paramNode instanceof com.sun.org.apache.xerces.internal.dom.NodeImpl)) {
      ((com.sun.org.apache.xerces.internal.dom.NodeImpl)paramNode).setReadOnly(true, false);
    }
  }
  ...
  {
    if ((paramNode instanceof com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)) {
      ((com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)paramNode).setReadOnly(false, false);
    } else if ((paramNode instanceof com.sun.org.apache.xerces.internal.dom.NodeImpl)) {
      ((com.sun.org.apache.xerces.internal.dom.NodeImpl)paramNode).setReadOnly(false, false);
    }
  }
  ...
  {
    if ((paramNode instanceof com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)) {
      return ((com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)paramNode).getReadOnly();
    }
    if ((paramNode instanceof com.sun.org.apache.xerces.internal.dom.NodeImpl)) {
      return ((com.sun.org.apache.xerces.internal.dom.NodeImpl)paramNode).getReadOnly();
    }
    return false;
  }
  
  public static boolean isHidden(Node paramNode, Map<Node, String> paramMap)
  {
    if ((paramNode instanceof com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)) {
      return ((com.sun.org.apache.xerces.internal.impl.xs.opti.NodeImpl)paramNode).getReadOnly();
    }
    return paramMap.containsKey(paramNode);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\util\DOMUtil.class
