...
public class XMLChar
{
  ...
  public static String trim(String paramString)
  {
    ...
    for (int i = 0; (i <= k) && (isSpace(paramString.charAt(i))); i++) {}
    for (int j = k; (j >= i) && (isSpace(paramString.charAt(j))); j--) {}
    if ((i == 0) && (j == k)) {
      return paramString;
    }
    if (i > k) {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\util\XMLChar.class
