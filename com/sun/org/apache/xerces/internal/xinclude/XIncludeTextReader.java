...
public class XIncludeTextReader
{
    ...
    throws IOException
  {
    ...
    if (((String)localObject2).equals("UTF-8")) {
      return new UTF8Reader((InputStream)localObject1, fTempString.ch.length, fErrorReporter.getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210"), fErrorReporter.getLocale());
    }
    ...
    if (str1.equals("ASCII")) {
      return new ASCIIReader((InputStream)localObject1, fTempString.ch.length, fErrorReporter.getMessageFormatter("http://www.w3.org/TR/1998/REC-xml-19980210"), fErrorReporter.getLocale());
    }
    ...
    throws IOException
  {
    ...
    fSource = null;
    for (int i = fReader.read(fTempString.ch, 0, fTempString.ch.length - 1); i != -1; i = fReader.read(fTempString.ch, 0, fTempString.ch.length - 1))
    {
      for (int j = 0; j < i; j++)
      {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xerces\internal\xinclude\XIncludeTextReader.class
