  ...
  extends TransformSpi
{
    ...
    throws CanonicalizationException
  {
    try
    {
      ...
      Object localObject = new Canonicalizer20010315ExclWithComments();
      if (paramOutputStream != null) {
        ((Canonicalizer20010315ExclWithComments)localObject).setWriter(paramOutputStream);
      }
      byte[] arrayOfByte = ((Canonicalizer20010315ExclWithComments)localObject).engineCanonicalize(paramXMLSignatureInput, str);
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xml\internal\security\transforms\implementations\TransformC14NExclusiveWithComments.class
