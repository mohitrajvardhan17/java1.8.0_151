...
public final class HTMLdtd
{
  ...
  public static String fromChar(int paramInt)
  {
    ...
    initialize();
    String str = (String)_byChar.get(Integer.valueOf(paramInt));
    return str;
  }
  ...
  private static void initialize()
  {
    ...
    {
      throw new RuntimeException(DOMMessageFormatter.formatMessage("http://apache.org/xml/serializer", "ResourceNotLoaded", new Object[] { "HTMLEntities.res", localException2.toString() }));
    }
    finally
    {
      if (localInputStream != null) {
  ...
  {
    _elemDefs.put(paramString, Integer.valueOf(paramInt));
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xml\internal\serialize\HTMLdtd.class
