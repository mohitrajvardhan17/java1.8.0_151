...
public final class SystemIDResolver
{
  ...
  public static String getAbsoluteURI(String paramString1, String paramString2)
    throws TransformerException
  {
    ...
    try
    {
      URI localURI2 = new URI(str);
      localURI1 = new URI(localURI2, paramString1);
    }
    catch (URI.MalformedURIException localMalformedURIException)
    {
      throw new TransformerException(localMalformedURIException);
    }
    return replaceChars(localURI1.toString());
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xml\internal\serializer\utils\SystemIDResolver.class
