  ...
  implements Serializable
{
    ...
    throws URI.MalformedURIException
  {
    ...
    {
      if (paramURI == null) {
        throw new MalformedURIException(XMLMessages.createXMLMessage("ER_NO_SCHEME_IN_URI", new Object[] { str1 }));
      }
    }
    else
    {
      ...
      if ((m_scheme != null) && (paramURI != null) && ((str1.startsWith("/")) || (!m_scheme.equals(m_scheme)) || (!paramURI.getSchemeSpecificPart().startsWith("/")))) {
        paramURI = null;
      }
      i = str1.length();
    }
  ...
  {
    int i = 7;
    i = 59 * i + Objects.hashCode(m_scheme);
    i = 59 * i + Objects.hashCode(m_userinfo);
    i = 59 * i + Objects.hashCode(m_host);
    i = 59 * i + m_port;
    i = 59 * i + Objects.hashCode(m_path);
    i = 59 * i + Objects.hashCode(m_queryString);
    i = 59 * i + Objects.hashCode(m_fragment);
    return i;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\org\apache\xml\internal\utils\URI.class
