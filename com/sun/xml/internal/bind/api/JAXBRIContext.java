  ...
  extends JAXBContext
{
  ...
  public static JAXBRIContext newInstance(@NotNull Class[] paramArrayOfClass, @Nullable Collection<TypeReference> paramCollection, @Nullable Map<Class, Class> paramMap, @Nullable String paramString, boolean paramBoolean, @Nullable RuntimeAnnotationReader paramRuntimeAnnotationReader)
    throws JAXBException
  {
    return newInstance(paramArrayOfClass, paramCollection, paramMap, paramString, paramBoolean, paramRuntimeAnnotationReader, false, false, false, false);
  }
    ...
    throws JAXBException
  {
    ...
    if (paramCollection != null) {
      localHashMap.put("com.sun.xml.internal.bind.typeReferences", paramCollection);
    }
    if (paramMap != null) {
      localHashMap.put("com.sun.xml.internal.bind.subclassReplacements", paramMap);
    }
    if (paramString != null) {
      localHashMap.put("com.sun.xml.internal.bind.defaultNamespaceRemap", paramString);
    }
    if (paramRuntimeAnnotationReader != null) {
      localHashMap.put(ANNOTATION_READER, paramRuntimeAnnotationReader);
    }
    localHashMap.put("com.sun.xml.internal.bind.c14n", Boolean.valueOf(paramBoolean1));
    localHashMap.put("com.sun.xml.internal.bind.XmlAccessorFactory", Boolean.valueOf(paramBoolean2));
    localHashMap.put("com.sun.xml.internal.bind.treatEverythingNillable", Boolean.valueOf(paramBoolean3));
    localHashMap.put("retainReferenceToInfo", Boolean.valueOf(paramBoolean4));
    localHashMap.put("supressAccessorWarnings", Boolean.valueOf(paramBoolean5));
    return (JAXBRIContext)ContextFactory.createContext(paramArrayOfClass, localHashMap);
  }
  
  /**
   * @deprecated
   */
  public static JAXBRIContext newInstance(@NotNull Class[] paramArrayOfClass, @Nullable Collection<TypeReference> paramCollection, @Nullable String paramString, boolean paramBoolean)
    throws JAXBException
  {
    return newInstance(paramArrayOfClass, paramCollection, Collections.emptyMap(), paramString, paramBoolean, null);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\bind\api\JAXBRIContext.class
