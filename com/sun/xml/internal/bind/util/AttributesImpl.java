  ...
  implements Attributes
{
  ...
  public int getIndexFast(String paramString1, String paramString2)
  {
    for (int i = (length - 1) * 5; i >= 0; i -= 5) {
      if ((data[(i + 1)] == paramString2) && (data[i] == paramString1)) {
        return i / 5;
      }
    }
    return -1;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\bind\util\AttributesImpl.class
