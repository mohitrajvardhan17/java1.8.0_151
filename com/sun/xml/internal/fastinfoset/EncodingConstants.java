...
public final class EncodingConstants
{
  ...
  public static final int XML_NAMESPACE_PREFIX_LENGTH = "xml".length();
  public static final String XML_NAMESPACE_NAME = "http://www.w3.org/XML/1998/namespace";
  public static final int XML_NAMESPACE_NAME_LENGTH = "http://www.w3.org/XML/1998/namespace".length();
  public static final String XMLNS_NAMESPACE_PREFIX = "xmlns";
  public static final int XMLNS_NAMESPACE_PREFIX_LENGTH = "xmlns".length();
  public static final String XMLNS_NAMESPACE_NAME = "http://www.w3.org/2000/xmlns/";
  public static final int XMLNS_NAMESPACE_NAME_LENGTH = "http://www.w3.org/2000/xmlns/".length();
  public static final QualifiedName DEFAULT_NAMESPACE_DECLARATION = new QualifiedName("", "http://www.w3.org/2000/xmlns/", "xmlns", "xmlns");
  ...
  static final int[] OCTET_STRING_LENGTH_2ND_BIT_VALUES = { 65, 321, 64, 96 };
  ...
  static final int[] OCTET_STRING_LENGTH_5TH_BIT_VALUES = { 9, 265, 8, 12 };
  ...
  static final int[] OCTET_STRING_LENGTH_7TH_BIT_VALUES = { 3, 259, 2, 3 };
  ...
  static final int[] INTEGER_2ND_BIT_VALUES = { 64, 8256, 1048576, 64, 96, -1 };
  ...
  static final int[] INTEGER_3RD_BIT_VALUES = { 32, 2080, 526368, 32, 40, 48 };
  ...
  static final int[] INTEGER_4TH_BIT_VALUES = { 16, 1040, 263184, 16, 20, 24 };
  static final byte[] BINARY_HEADER = { -32, 0, 0, 1 };
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\fastinfoset\EncodingConstants.class
