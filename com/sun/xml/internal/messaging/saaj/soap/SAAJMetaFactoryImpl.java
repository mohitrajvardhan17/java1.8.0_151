  ...
  extends SAAJMetaFactory
{
  ...
  protected MessageFactory newMessageFactory(String paramString)
  ...
  protected SOAPFactory newSOAPFactory(String paramString)
    throws SOAPException
  {
    if ("SOAP 1.1 Protocol".equals(paramString)) {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\SAAJMetaFactoryImpl.class
