  ...
  implements SOAPDocument
{
  ...
  public SOAPDocumentImpl(SOAPPartImpl paramSOAPPartImpl)
  {
    enclosingSOAPPart = paramSOAPPartImpl;
  }
  ...
  public Element createElement(String paramString)
    throws DOMException
  {
    return ElementFactory.createElement(this, NameImpl.getLocalNameFromTagName(paramString), NameImpl.getPrefixFromTagName(paramString), null);
  }
  ...
  public CDATASection createCDATASection(String paramString)
    throws DOMException
  {
    return new CDATAImpl(this, paramString);
  }
  ...
  public Attr createAttribute(String paramString)
    throws DOMException
  {
    int i = paramString.indexOf(":") > 0 ? 1 : 0;
    if (i != 0)
    {
      String str1 = null;
  ...
  {
    return super.getElementsByTagName(paramString);
  }
  
  public Node importNode(Node paramNode, boolean paramBoolean)
    throws DOMException
  {
    return super.importNode(paramNode, paramBoolean);
  }
  
  public Element createElementNS(String paramString1, String paramString2)
    throws DOMException
  {
    return ElementFactory.createElement(this, NameImpl.getLocalNameFromTagName(paramString2), NameImpl.getPrefixFromTagName(paramString2), paramString1);
  }
  
  public Attr createAttributeNS(String paramString1, String paramString2)
    throws DOMException
  {
    return super.createAttributeNS(paramString1, paramString2);
  }
  
  public NodeList getElementsByTagNameNS(String paramString1, String paramString2)
  {
    return super.getElementsByTagNameNS(paramString1, paramString2);
  }
  ...
  {
    SOAPPartImpl localSOAPPartImpl = getSOAPPart().doCloneNode();
    super.cloneNode(localSOAPPartImpl.getDocument(), paramBoolean);
    return localSOAPPartImpl;
  }
  
  public void cloneNode(SOAPDocumentImpl paramSOAPDocumentImpl, boolean paramBoolean)
  {
    super.cloneNode(paramSOAPDocumentImpl, paramBoolean);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\SOAPDocumentImpl.class
