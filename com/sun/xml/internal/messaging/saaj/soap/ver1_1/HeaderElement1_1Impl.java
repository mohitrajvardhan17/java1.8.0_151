  ...
  extends HeaderElementImpl
{
  ...
  public HeaderElement1_1Impl(SOAPDocumentImpl paramSOAPDocumentImpl, Name paramName)
  {
    super(paramSOAPDocumentImpl, paramName);
  }
  
  public HeaderElement1_1Impl(SOAPDocumentImpl paramSOAPDocumentImpl, QName paramQName)
  {
  ...
  {
    HeaderElement1_1Impl localHeaderElement1_1Impl = new HeaderElement1_1Impl((SOAPDocumentImpl)getOwnerDocument(), paramQName);
    return replaceElementWithSOAPElement(this, localHeaderElement1_1Impl);
  }
  ...
  {
    return ("1".equals(paramString)) || ("true".equalsIgnoreCase(paramString));
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\ver1_1\HeaderElement1_1Impl.class
