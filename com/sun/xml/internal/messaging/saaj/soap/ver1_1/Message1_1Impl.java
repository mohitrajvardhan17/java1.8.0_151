  ...
  implements SOAPConstants
{
  ...
  public Message1_1Impl(boolean paramBoolean1, boolean paramBoolean2)
  {
    super(paramBoolean1, paramBoolean2);
  }
  
  public Message1_1Impl(SOAPMessage paramSOAPMessage)
  {
    super(paramSOAPMessage);
  }
  
  public Message1_1Impl(MimeHeaders paramMimeHeaders, InputStream paramInputStream)
    throws IOException, SOAPExceptionImpl
  {
    super(paramMimeHeaders, paramInputStream);
  }
  
  public Message1_1Impl(MimeHeaders paramMimeHeaders, ContentType paramContentType, int paramInt, InputStream paramInputStream)
  ...
  protected String getExpectedAcceptHeader()
  {
    ...
    return acceptFastInfoset ? "application/fastinfoset, " + str : str;
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\ver1_1\Message1_1Impl.class
