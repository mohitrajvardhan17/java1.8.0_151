  ...
  extends BodyImpl
{
  ...
  public Body1_2Impl(SOAPDocumentImpl paramSOAPDocumentImpl, String paramString)
  {
    super(paramSOAPDocumentImpl, NameImpl.createBody1_2Name(paramString));
  }
  
  protected NameImpl getFaultName(String paramString)
  {
    return NameImpl.createFault1_2Name(paramString, null);
  }
  
  protected SOAPBodyElement createBodyElement(Name paramName)
  {
    return new BodyElement1_2Impl(((SOAPDocument)getOwnerDocument()).getDocument(), paramName);
  }
  
  protected SOAPBodyElement createBodyElement(QName paramQName)
  {
    return new BodyElement1_2Impl(((SOAPDocument)getOwnerDocument()).getDocument(), paramQName);
  }
  ...
  protected boolean isFault(SOAPElement paramSOAPElement)
  {
    return (paramSOAPElement.getElementName().getURI().equals("http://www.w3.org/2003/05/soap-envelope")) && (paramSOAPElement.getElementName().getLocalName().equals("Fault"));
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\ver1_2\Body1_2Impl.class
