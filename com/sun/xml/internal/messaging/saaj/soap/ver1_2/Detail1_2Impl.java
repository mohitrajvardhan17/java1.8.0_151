  ...
  extends DetailImpl
{
  ...
  public Detail1_2Impl(SOAPDocumentImpl paramSOAPDocumentImpl, String paramString)
  {
    super(paramSOAPDocumentImpl, NameImpl.createSOAP12Name("Detail", paramString));
  }
  
  public Detail1_2Impl(SOAPDocumentImpl paramSOAPDocumentImpl)
  {
    super(paramSOAPDocumentImpl, NameImpl.createSOAP12Name("Detail"));
  }
  
  protected DetailEntry createDetailEntry(Name paramName)
  {
    return new DetailEntry1_2Impl(((SOAPDocument)getOwnerDocument()).getDocument(), paramName);
  }
  
  protected DetailEntry createDetailEntry(QName paramQName)
  {
    return new DetailEntry1_2Impl(((SOAPDocument)getOwnerDocument()).getDocument(), paramQName);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\ver1_2\Detail1_2Impl.class
