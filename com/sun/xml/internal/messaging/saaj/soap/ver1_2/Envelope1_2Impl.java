  ...
  extends EnvelopeImpl
{
  ...
  public Envelope1_2Impl(SOAPDocumentImpl paramSOAPDocumentImpl, String paramString)
  {
    super(paramSOAPDocumentImpl, NameImpl.createEnvelope1_2Name(paramString));
  }
  
  public Envelope1_2Impl(SOAPDocumentImpl paramSOAPDocumentImpl, String paramString, boolean paramBoolean1, boolean paramBoolean2)
    throws SOAPException
  {
    super(paramSOAPDocumentImpl, NameImpl.createEnvelope1_2Name(paramString), paramBoolean1, paramBoolean2);
  }
  
  protected NameImpl getBodyName(String paramString)
  {
    return NameImpl.createBody1_2Name(paramString);
  }
  
  protected NameImpl getHeaderName(String paramString)
  {
    return NameImpl.createHeader1_2Name(paramString);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\ver1_2\Envelope1_2Impl.class
