  ...
  extends HeaderImpl
{
  ...
  public Header1_2Impl(SOAPDocumentImpl paramSOAPDocumentImpl, String paramString)
  {
    super(paramSOAPDocumentImpl, NameImpl.createHeader1_2Name(paramString));
  }
  ...
  public SOAPHeaderElement addNotUnderstoodHeaderElement(QName paramQName)
    throws SOAPException
  {
    ...
    NameImpl localNameImpl = getNotUnderstoodName();
    SOAPHeaderElement localSOAPHeaderElement = (SOAPHeaderElement)addChildElement(localNameImpl);
    localSOAPHeaderElement.addAttribute(NameImpl.createFromUnqualifiedName("qname"), getQualifiedName(new QName(paramQName.getNamespaceURI(), paramQName.getLocalPart(), str)));
    localSOAPHeaderElement.addNamespaceDeclaration(str, paramQName.getNamespaceURI());
  ...
  protected SOAPHeaderElement createHeaderElement(Name paramName)
    throws SOAPException
  {
  ...
  protected SOAPHeaderElement createHeaderElement(QName paramQName)
    throws SOAPException
  {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\messaging\saaj\soap\ver1_2\Header1_2Impl.class
