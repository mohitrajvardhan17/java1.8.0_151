...
public abstract class Stubs
{
  ...
  @Deprecated
  public static Dispatch<Source> createSourceDispatch(QName paramQName, WSService paramWSService, WSBinding paramWSBinding, Service.Mode paramMode, Tube paramTube, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return DispatchImpl.createSourceDispatch(paramQName, paramMode, (WSServiceDelegate)paramWSService, paramTube, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  
  public static Dispatch<Source> createSourceDispatch(WSPortInfo paramWSPortInfo, WSBinding paramWSBinding, Service.Mode paramMode, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return DispatchImpl.createSourceDispatch(paramWSPortInfo, paramMode, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  ...
  @Deprecated
  public static Dispatch<Object> createJAXBDispatch(QName paramQName, WSService paramWSService, WSBinding paramWSBinding, JAXBContext paramJAXBContext, Service.Mode paramMode, Tube paramTube, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return new JAXBDispatch(paramQName, paramJAXBContext, paramMode, (WSServiceDelegate)paramWSService, paramTube, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  
  public static Dispatch<Object> createJAXBDispatch(WSPortInfo paramWSPortInfo, WSBinding paramWSBinding, JAXBContext paramJAXBContext, Service.Mode paramMode, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return new JAXBDispatch(paramWSPortInfo, paramJAXBContext, paramMode, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  
  @Deprecated
  public static Dispatch<Message> createMessageDispatch(QName paramQName, WSService paramWSService, WSBinding paramWSBinding, Tube paramTube, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return new MessageDispatch(paramQName, (WSServiceDelegate)paramWSService, paramTube, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  
  public static Dispatch<Message> createMessageDispatch(WSPortInfo paramWSPortInfo, WSBinding paramWSBinding, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return new MessageDispatch(paramWSPortInfo, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  
  public static Dispatch<Packet> createPacketDispatch(QName paramQName, WSService paramWSService, WSBinding paramWSBinding, Tube paramTube, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return new PacketDispatch(paramQName, (WSServiceDelegate)paramWSService, paramTube, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  
  public static Dispatch<Packet> createPacketDispatch(WSPortInfo paramWSPortInfo, WSBinding paramWSBinding, @Nullable WSEndpointReference paramWSEndpointReference)
  {
    return new PacketDispatch(paramWSPortInfo, (BindingImpl)paramWSBinding, paramWSEndpointReference);
  }
  ...
  {
    SEIStub localSEIStub = new SEIStub((WSServiceDelegate)paramWSService, (BindingImpl)paramWSBinding, (SOAPSEIModel)paramSEIModel, paramTube, paramWSEndpointReference);
    return (T)paramClass.cast(Proxy.newProxyInstance(paramClass.getClassLoader(), new Class[] { paramClass, WSBindingProvider.class }, localSEIStub));
  }
  ...
  {
    SEIStub localSEIStub = new SEIStub(paramWSPortInfo, (BindingImpl)paramWSBinding, (SOAPSEIModel)paramSEIModel, paramWSEndpointReference);
    return (T)paramClass.cast(Proxy.newProxyInstance(paramClass.getClassLoader(), new Class[] { paramClass, WSBindingProvider.class }, localSEIStub));
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\ws\api\pipe\Stubs.class
