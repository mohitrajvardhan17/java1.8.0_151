  ...
  implements MethodVisitor
{
  ...
  MethodWriter(ClassWriter paramClassWriter, int paramInt, String paramString1, String paramString2, String paramString3, String[] paramArrayOfString, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((paramBoolean1) || (paramBoolean2))
    {
      ...
      i = getArgumentsAndReturnSizes(descriptor) >> 2;
      if ((paramInt & 0x8) != 0) {
        i--;
      }
      maxLocals = i;
  ...
  public void visitFrame(int paramInt1, int paramInt2, Object[] paramArrayOfObject1, int paramInt3, Object[] paramArrayOfObject2)
  {
    ...
    if (paramInt1 == -1)
    {
      startFrame(code.length, paramInt2, paramInt3);
      for (i = 0; i < paramInt2; i++) {
        if ((paramArrayOfObject1[i] instanceof String)) {
          frame[(frameIndex++)] = (0x1700000 | cw.addType((String)paramArrayOfObject1[i]));
        } else if ((paramArrayOfObject1[i] instanceof Integer)) {
          frame[(frameIndex++)] = ((Integer)paramArrayOfObject1[i]).intValue();
        } else {
          frame[(frameIndex++)] = (0x1800000 | cw.addUninitializedType("", position));
        }
      }
      for (i = 0; i < paramInt3; i++) {
        if ((paramArrayOfObject2[i] instanceof String)) {
          frame[(frameIndex++)] = (0x1700000 | cw.addType((String)paramArrayOfObject2[i]));
        } else if ((paramArrayOfObject2[i] instanceof Integer)) {
          frame[(frameIndex++)] = ((Integer)paramArrayOfObject2[i]).intValue();
        } else {
          frame[(frameIndex++)] = (0x1800000 | cw.addUninitializedType("", position));
        }
      }
  ...
  public void visitMethodInsn(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    Item localItem = cw.newMethodItem(paramString1, paramString2, paramString3, bool);
    int i = intVal;
    if (currentBlock != null) {
      if (compute == 0)
      {
    ...
    for (int i = paramInt1; i < paramInt2; i++)
    {
      ...
      else
      {
        ...
        if ((j & 0xFF00000) == 24117248)
        {
          ...
          localStringBuffer.append(cw.typeTable[(j & 0xFFFFF)].strVal1);
          localStringBuffer.append(';');
        }
        else
        {
        ...
        stackMap.putByte(7).putShort(cw.newClass(localStringBuffer.toString()));
      }
    }
  }
  ...
  final void put(ByteVector paramByteVector)
  {
    ...
    if (code.length > 0)
    {
      j = 12 + code.length + 8 * handlerCount;
      if (localVar != null) {
        j += 8 + localVar.length;
      }
      if (localVarType != null) {
        j += 8 + localVarType.length;
      }
      if (lineNumber != null) {
        j += 8 + lineNumber.length;
      }
      if (stackMap != null) {
        j += 8 + stackMap.length;
      }
      if (cattrs != null) {
        j += cattrs.getSize(cw, code.data, code.length, maxStack, maxLocals);
      }
      paramByteVector.putShort(cw.newUTF8("Code")).putInt(j);
      ...
      if (stackMap != null)
      {
        int k = (cw.version & 0xFFFF) >= 50 ? 1 : 0;
        paramByteVector.putShort(cw.newUTF8(k != 0 ? "StackMapTable" : "StackMap"));
    ...
    if (exceptionCount > 0)
    {
      ...
      for (j = 0; j < exceptionCount; j++) {
        paramByteVector.putShort(exceptions[j]);
      }
    }
    if (((access & 0x1000) != 0) && ((cw.version & 0xFFFF) < 49)) {
  ...
  private void resizeInstructions()
  {
    ...
    if (frameCount > 0) {
      if (compute == 0)
      {
        ...
        owner = labels;
        localObject4 = Type.getArgumentTypes(descriptor);
        ((Frame)localObject3).initInputFrame(cw, access, (Type[])localObject4, maxLocals);
        visitFrame((Frame)localObject3);
        for (localObject5 = labels; localObject5 != null; localObject5 = successor)
        {
          i = position - 3;
          if (((status & 0x20) != 0) || ((i >= 0) && (arrayOfBoolean[i] != 0)))
          {
            getNewOffset((int[])localObject1, (int[])localObject2, (Label)localObject5);
            visitFrame(frame);
          }
        }
      }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\ws\org\objectweb\asm\MethodWriter.class
