...
public final class AddressingMessages
{
  ...
  public static Localizable localizableINVALID_WSAW_ANONYMOUS(Object paramObject)
  {
    return messageFactory.getMessage("invalid.wsaw.anonymous", new Object[] { paramObject });
  }
  
  public static String INVALID_WSAW_ANONYMOUS(Object paramObject)
  {
    return localizer.localize(localizableINVALID_WSAW_ANONYMOUS(paramObject));
  }
  ...
  public static Localizable localizableWSDL_BOUND_OPERATION_NOT_FOUND(Object paramObject)
  {
    return messageFactory.getMessage("wsdlBoundOperation.notFound", new Object[] { paramObject });
  }
  
  public static String WSDL_BOUND_OPERATION_NOT_FOUND(Object paramObject)
  {
    return localizer.localize(localizableWSDL_BOUND_OPERATION_NOT_FOUND(paramObject));
  }
  
  public static Localizable localizableNON_UNIQUE_OPERATION_SIGNATURE(Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4)
  {
    return messageFactory.getMessage("non.unique.operation.signature", new Object[] { paramObject1, paramObject2, paramObject3, paramObject4 });
  }
  
  public static String NON_UNIQUE_OPERATION_SIGNATURE(Object paramObject1, Object paramObject2, Object paramObject3, Object paramObject4)
  {
    return localizer.localize(localizableNON_UNIQUE_OPERATION_SIGNATURE(paramObject1, paramObject2, paramObject3, paramObject4));
  }
  ...
  public static Localizable localizableACTION_NOT_SUPPORTED_EXCEPTION(Object paramObject)
  {
    return messageFactory.getMessage("action.not.supported.exception", new Object[] { paramObject });
  }
  
  public static String ACTION_NOT_SUPPORTED_EXCEPTION(Object paramObject)
  {
    return localizer.localize(localizableACTION_NOT_SUPPORTED_EXCEPTION(paramObject));
  }
  
  public static Localizable localizableNON_ANONYMOUS_RESPONSE_NULL_HEADERS(Object paramObject)
  {
    return messageFactory.getMessage("nonAnonymous.response.nullHeaders", new Object[] { paramObject });
  }
  
  public static String NON_ANONYMOUS_RESPONSE_NULL_HEADERS(Object paramObject)
  {
    return localizer.localize(localizableNON_ANONYMOUS_RESPONSE_NULL_HEADERS(paramObject));
  }
  
  public static Localizable localizableNON_ANONYMOUS_RESPONSE_SENDING(Object paramObject)
  {
    return messageFactory.getMessage("nonAnonymous.response.sending", new Object[] { paramObject });
  }
  
  public static String NON_ANONYMOUS_RESPONSE_SENDING(Object paramObject)
  {
    return localizer.localize(localizableNON_ANONYMOUS_RESPONSE_SENDING(paramObject));
  }
  ...
  public static Localizable localizableINVALID_ADDRESSING_HEADER_EXCEPTION(Object paramObject1, Object paramObject2)
  {
    return messageFactory.getMessage("invalid.addressing.header.exception", new Object[] { paramObject1, paramObject2 });
  }
  
  public static String INVALID_ADDRESSING_HEADER_EXCEPTION(Object paramObject1, Object paramObject2)
  {
    return localizer.localize(localizableINVALID_ADDRESSING_HEADER_EXCEPTION(paramObject1, paramObject2));
  }
  ...
  public static Localizable localizableMISSING_HEADER_EXCEPTION(Object paramObject)
  {
    return messageFactory.getMessage("missing.header.exception", new Object[] { paramObject });
  }
  
  public static String MISSING_HEADER_EXCEPTION(Object paramObject)
  {
    return localizer.localize(localizableMISSING_HEADER_EXCEPTION(paramObject));
  }
  ...
  public static Localizable localizableWRONG_ADDRESSING_VERSION(Object paramObject1, Object paramObject2)
  {
    return messageFactory.getMessage("wrong.addressing.version", new Object[] { paramObject1, paramObject2 });
  }
  
  public static String WRONG_ADDRESSING_VERSION(Object paramObject1, Object paramObject2)
  {
    return localizer.localize(localizableWRONG_ADDRESSING_VERSION(paramObject1, paramObject2));
  }
  
  public static Localizable localizableADDRESSING_NOT_ENABLED(Object paramObject)
  {
    return messageFactory.getMessage("addressing.notEnabled", new Object[] { paramObject });
  }
  
  public static String ADDRESSING_NOT_ENABLED(Object paramObject)
  {
    return localizer.localize(localizableADDRESSING_NOT_ENABLED(paramObject));
  }
  
  public static Localizable localizableNON_ANONYMOUS_UNKNOWN_PROTOCOL(Object paramObject)
  {
    return messageFactory.getMessage("nonAnonymous.unknown.protocol", new Object[] { paramObject });
  }
  
  public static String NON_ANONYMOUS_UNKNOWN_PROTOCOL(Object paramObject)
  {
    return localizer.localize(localizableNON_ANONYMOUS_UNKNOWN_PROTOCOL(paramObject));
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\ws\resources\AddressingMessages.class
