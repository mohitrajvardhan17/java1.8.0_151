...
public final class XmlmessageMessages
{
  ...
  public XmlmessageMessages() {}
  
  public static Localizable localizableXML_NULL_HEADERS()
  {
    return messageFactory.getMessage("xml.null.headers", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.set.payload.err", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.content-type.mustbe.multipart", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.unknown.Content-Type", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.get.ds.err", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.Content-Type.parse.err", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.get.source.err", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.cannot.internalize.message", new Object[0]);
  }
  ...
  {
    return messageFactory.getMessage("xml.no.Content-Type", new Object[0]);
  }
  ...
  public static Localizable localizableXML_ROOT_PART_INVALID_CONTENT_TYPE(Object paramObject)
  {
    return messageFactory.getMessage("xml.root.part.invalid.Content-Type", new Object[] { paramObject });
  }
  
  public static String XML_ROOT_PART_INVALID_CONTENT_TYPE(Object paramObject)
  {
    return localizer.localize(localizableXML_ROOT_PART_INVALID_CONTENT_TYPE(paramObject));
  }
  
  public static Localizable localizableXML_INVALID_CONTENT_TYPE(Object paramObject)
  {
    return messageFactory.getMessage("xml.invalid.content-type", new Object[] { paramObject });
  }
  
  public static String XML_INVALID_CONTENT_TYPE(Object paramObject)
  {
    return localizer.localize(localizableXML_INVALID_CONTENT_TYPE(paramObject));
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\ws\resources\XmlmessageMessages.class
