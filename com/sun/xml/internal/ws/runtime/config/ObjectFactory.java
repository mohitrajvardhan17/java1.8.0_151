...
public class ObjectFactory
{
  ...
  public JAXBElement<Tubelines> createTubelines(Tubelines paramTubelines)
  {
    return new JAXBElement(_Tubelines_QNAME, Tubelines.class, null, paramTubelines);
  }
  
  @XmlElementDecl(namespace="http://java.sun.com/xml/ns/metro/config", name="tubeline-mapping")
  public JAXBElement<TubelineMapping> createTubelineMapping(TubelineMapping paramTubelineMapping)
  {
    return new JAXBElement(_TubelineMapping_QNAME, TubelineMapping.class, null, paramTubelineMapping);
  }
  
  @XmlElementDecl(namespace="http://java.sun.com/xml/ns/metro/config", name="tubeline")
  public JAXBElement<TubelineDefinition> createTubeline(TubelineDefinition paramTubelineDefinition)
  {
    return new JAXBElement(_Tubeline_QNAME, TubelineDefinition.class, null, paramTubelineDefinition);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\ws\runtime\config\ObjectFactory.class
