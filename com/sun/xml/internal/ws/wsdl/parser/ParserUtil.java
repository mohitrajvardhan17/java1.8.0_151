...
public class ParserUtil
{
  ...
  public static String getAttribute(XMLStreamReader paramXMLStreamReader, String paramString)
  {
    return paramXMLStreamReader.getAttributeValue(null, paramString);
  }
  
  public static String getAttribute(XMLStreamReader paramXMLStreamReader, String paramString1, String paramString2)
  {
    return paramXMLStreamReader.getAttributeValue(paramString1, paramString2);
  }
  
  public static String getAttribute(XMLStreamReader paramXMLStreamReader, QName paramQName)
  {
    return paramXMLStreamReader.getAttributeValue(paramQName.getNamespaceURI(), paramQName.getLocalPart());
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\ws\wsdl\parser\ParserUtil.class
