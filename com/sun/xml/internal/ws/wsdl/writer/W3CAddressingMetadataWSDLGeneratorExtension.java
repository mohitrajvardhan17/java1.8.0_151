  ...
  extends WSDLGeneratorExtension
{
  ...
  public void start(WSDLGenExtnContext paramWSDLGenExtnContext)
  {
    ...
    localTypedXmlWriter._namespace("http://www.w3.org/2007/05/addressing/metadata", "wsam");
  }
  
  public void addOperationInputExtension(TypedXmlWriter paramTypedXmlWriter, JavaMethod paramJavaMethod)
  {
    paramTypedXmlWriter._attribute(W3CAddressingMetadataConstants.WSAM_ACTION_QNAME, getInputAction(paramJavaMethod));
  }
  
  public void addOperationOutputExtension(TypedXmlWriter paramTypedXmlWriter, JavaMethod paramJavaMethod)
  {
    paramTypedXmlWriter._attribute(W3CAddressingMetadataConstants.WSAM_ACTION_QNAME, getOutputAction(paramJavaMethod));
  }
  ...
  {
    paramTypedXmlWriter._attribute(W3CAddressingMetadataConstants.WSAM_ACTION_QNAME, getFaultAction(paramJavaMethod, paramCheckedException));
  }
  ...
  protected static final String getDefaultFaultAction(JavaMethod paramJavaMethod, CheckedException paramCheckedException)
  {
    return WsaActionUtil.getDefaultFaultAction(paramJavaMethod, paramCheckedException);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\com\sun\xml\internal\ws\wsdl\writer\W3CAddressingMetadataWSDLGeneratorExtension.class
