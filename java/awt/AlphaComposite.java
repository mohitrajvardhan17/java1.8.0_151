  ...
  implements Composite
{
  ...
  {
    if (paramFloat == 1.0F) {
      return getInstance(paramInt);
    }
    return new AlphaComposite(paramInt, paramFloat);
  }
  ...
  {
    return rule == paramInt ? this : getInstance(paramInt, extraAlpha);
  }
  
  public AlphaComposite derive(float paramFloat)
  {
    return extraAlpha == paramFloat ? this : getInstance(rule, paramFloat);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    AlphaComposite localAlphaComposite = (AlphaComposite)paramObject;
    if (rule != rule) {
      return false;
    }
    return extraAlpha == extraAlpha;
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\AlphaComposite.class
