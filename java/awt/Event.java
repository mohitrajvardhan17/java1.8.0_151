  ...
  implements Serializable
{
  ...
  public Object arg;
  public Event evt;
  private static final int[][] actionKeyCodes = { { 36, 1000 }, { 35, 1001 }, { 33, 1002 }, { 34, 1003 }, { 38, 1004 }, { 40, 1005 }, { 37, 1006 }, { 39, 1007 }, { 112, 1008 }, { 113, 1009 }, { 114, 1010 }, { 115, 1011 }, { 116, 1012 }, { 117, 1013 }, { 118, 1014 }, { 119, 1015 }, { 120, 1016 }, { 121, 1017 }, { 122, 1018 }, { 123, 1019 }, { 154, 1020 }, { 145, 1021 }, { 20, 1022 }, { 144, 1023 }, { 19, 1024 }, { 155, 1025 } };
  ...
  {
    this(paramObject, paramLong, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, null);
  }
  
  public Event(Object paramObject1, int paramInt, Object paramObject2)
  {
    this(paramObject1, 0L, paramInt, 0, 0, 0, 0, paramObject2);
  }
  ...
  static int getOldEventKey(KeyEvent paramKeyEvent)
  {
    ...
    for (int j = 0; j < actionKeyCodes.length; j++) {
      if (actionKeyCodes[j][0] == i) {
        return actionKeyCodes[j][1];
      }
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\Event.class
