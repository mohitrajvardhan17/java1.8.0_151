  ...
  implements Cloneable
{
  ...
  public void setOrientationRequested(OrientationRequestedType paramOrientationRequestedType)
  {
    ...
    orientationRequested = paramOrientationRequestedType;
  }
  ...
  public void setPrintQuality(PrintQualityType paramPrintQualityType)
  {
    ...
    printQuality = paramPrintQualityType;
  }
  ...
  public int[] getPrinterResolution()
  {
    ...
    arrayOfInt[0] = printerResolution[0];
    arrayOfInt[1] = printerResolution[1];
    arrayOfInt[2] = printerResolution[2];
    return arrayOfInt;
  }
  ...
  public void setPrinterResolution(int[] paramArrayOfInt)
  {
    ...
    printerResolution = arrayOfInt;
  }
  
  public void setPrinterResolution(int paramInt)
  {
    setPrinterResolution(new int[] { paramInt, paramInt, 3 });
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    PageAttributes localPageAttributes = (PageAttributes)paramObject;
    return (color == color) && (media == media) && (orientationRequested == orientationRequested) && (origin == origin) && (printQuality == printQuality) && (printerResolution[0] == printerResolution[0]) && (printerResolution[1] == printerResolution[1]) && (printerResolution[2] == printerResolution[2]);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\PageAttributes.class
