  ...
  extends InputEvent
{
  ...
  char keyChar;
  int keyLocation;
  private transient long rawCode = 0L;
  private transient long primaryLevelUnicode = 0L;
  private transient long scancode = 0L;
  private transient long extendedKeyCode = 0L;
  ...
  public static String getKeyText(int paramInt)
  {
    ...
    {
      str = Toolkit.getProperty("AWT.numpad", "NumPad");
  ...
  public String paramString()
  {
    ...
    {
    case 401: 
      localStringBuilder.append("KEY_PRESSED");
      break;
    case 402: 
      localStringBuilder.append("KEY_RELEASED");
      break;
    case 400: 
      localStringBuilder.append("KEY_TYPED");
      break;
    default: 
      localStringBuilder.append("unknown type");
    }
    localStringBuilder.append(",keyCode=").append(keyCode);
    localStringBuilder.append(",keyText=").append(getKeyText(keyCode));
    localStringBuilder.append(",keyChar=");
    switch (keyChar)
    {
    case '\b': 
      localStringBuilder.append(getKeyText(8));
      break;
    case '\t': 
      localStringBuilder.append(getKeyText(9));
      break;
    case '\n': 
      localStringBuilder.append(getKeyText(10));
      break;
    case '\030': 
      localStringBuilder.append(getKeyText(3));
      break;
    case '\033': 
      localStringBuilder.append(getKeyText(27));
      break;
    case '': 
      localStringBuilder.append(getKeyText(127));
      break;
    case '￿': 
      localStringBuilder.append(Toolkit.getProperty("AWT.undefined", "Undefined"));
      localStringBuilder.append(" keyChar");
      break;
    default: 
      localStringBuilder.append("'").append(keyChar).append("'");
    }
    if (getModifiers() != 0) {
      localStringBuilder.append(",modifiers=").append(getKeyModifiersText(modifiers));
    }
    if (getModifiersEx() != 0) {
      localStringBuilder.append(",extModifiers=").append(getModifiersExText(modifiers));
    }
    ...
    localStringBuilder.append(",rawCode=").append(rawCode);
    localStringBuilder.append(",primaryLevelUnicode=").append(primaryLevelUnicode);
    localStringBuilder.append(",scancode=").append(scancode);
    localStringBuilder.append(",extendedKeyCode=0x").append(Long.toHexString(extendedKeyCode));
    return localStringBuilder.toString();
  }
  ...
  {
    return ExtendedKeyCodes.getExtendedKeyCodeForChar(paramInt);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\event\KeyEvent.class
