...
public abstract interface OpenType
{
  ...
  public abstract byte[] getFontTable(int paramInt);
  
  public abstract byte[] getFontTable(String paramString);
  
  public abstract byte[] getFontTable(int paramInt1, int paramInt2, int paramInt3);
  
  public abstract byte[] getFontTable(String paramString, int paramInt1, int paramInt2);
  
  public abstract int getFontTableSize(int paramInt);
  
  public abstract int getFontTableSize(String paramString);
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\font\OpenType.class
