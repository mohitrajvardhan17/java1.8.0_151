  ...
  extends AttributedCharacterIterator.Attribute
{
    ...
    throws InvalidObjectException
  {
    ...
    TextAttribute localTextAttribute = (TextAttribute)instanceMap.get(getName());
    if (localTextAttribute != null) {
      return localTextAttribute;
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\font\TextAttribute.class
