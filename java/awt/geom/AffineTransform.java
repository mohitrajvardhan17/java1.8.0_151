  ...
  implements Cloneable, Serializable
{
  ...
  {
    m00 = paramArrayOfDouble[0];
    m10 = paramArrayOfDouble[1];
    m01 = paramArrayOfDouble[2];
    m11 = paramArrayOfDouble[3];
    if (paramArrayOfDouble.length > 5)
    {
      m02 = paramArrayOfDouble[4];
      m12 = paramArrayOfDouble[5];
    }
    updateState();
  }
  ...
  private void calculateType()
  {
    ...
    case 6: 
      double d3;
      double d4;
      if ((d1 = m00) * (d3 = m01) + (d4 = m10) * (d2 = m11) != 0.0D)
      {
        type = 32;
        return;
      }
  ...
  {
    paramArrayOfDouble[0] = m00;
    paramArrayOfDouble[1] = m10;
    paramArrayOfDouble[2] = m01;
    paramArrayOfDouble[3] = m11;
    if (paramArrayOfDouble.length > 5)
    {
      paramArrayOfDouble[4] = m02;
      paramArrayOfDouble[5] = m12;
    }
  }
  ...
  public void translate(double paramDouble1, double paramDouble2)
  {
    ...
    default: 
      ...
      return;
    case 7: 
      m02 = (paramDouble1 * m00 + paramDouble2 * m01 + m02);
      m12 = (paramDouble1 * m10 + paramDouble2 * m11 + m12);
      if ((m02 == 0.0D) && (m12 == 0.0D))
      {
        state = 6;
        if (type != -1) {
      ...
      return;
    case 6: 
      m02 = (paramDouble1 * m00 + paramDouble2 * m01);
      m12 = (paramDouble1 * m10 + paramDouble2 * m11);
      if ((m02 != 0.0D) || (m12 != 0.0D))
      {
        state = 7;
        type |= 0x1;
      ...
      return;
    case 5: 
      m02 = (paramDouble2 * m01 + m02);
      m12 = (paramDouble1 * m10 + m12);
      if ((m02 == 0.0D) && (m12 == 0.0D))
      {
        state = 4;
        if (type != -1) {
      ...
      return;
    case 4: 
      m02 = (paramDouble2 * m01);
      m12 = (paramDouble1 * m10);
      if ((m02 != 0.0D) || (m12 != 0.0D))
      {
        state = 5;
        type |= 0x1;
      ...
      return;
    case 3: 
      m02 = (paramDouble1 * m00 + m02);
      m12 = (paramDouble2 * m11 + m12);
      if ((m02 == 0.0D) && (m12 == 0.0D))
      {
        state = 2;
        if (type != -1) {
      ...
      return;
    case 2: 
      m02 = (paramDouble1 * m00);
      m12 = (paramDouble2 * m11);
      if ((m02 != 0.0D) || (m12 != 0.0D))
      {
        state = 3;
        type |= 0x1;
      ...
      return;
    case 1: 
      m02 = (paramDouble1 + m02);
      m12 = (paramDouble2 + m12);
      if ((m02 == 0.0D) && (m12 == 0.0D))
      {
        state = 0;
        type = 0;
  ...
  private final void rotate90()
  {
    ...
    m10 = m11;
    m11 = (-d);
    int i = rot90conversion[state];
    if (((i & 0x6) == 2) && (m00 == 1.0D) && (m11 == 1.0D)) {
      i -= 2;
    }
    state = i;
    type = -1;
  ...
  public void quadrantRotate(int paramInt, double paramDouble1, double paramDouble2)
  {
    ...
    case 0: 
      return;
    case 1: 
      m02 += paramDouble1 * (m00 - m01) + paramDouble2 * (m01 + m00);
      m12 += paramDouble1 * (m10 - m11) + paramDouble2 * (m11 + m10);
      rotate90();
      break;
    case 2: 
      m02 += paramDouble1 * (m00 + m00) + paramDouble2 * (m01 + m01);
      m12 += paramDouble1 * (m10 + m10) + paramDouble2 * (m11 + m11);
      rotate180();
      break;
    case 3: 
      m02 += paramDouble1 * (m00 + m01) + paramDouble2 * (m01 - m00);
  ...
  public void shear(double paramDouble1, double paramDouble2)
  {
    ...
    case 7: 
      double d1 = m00;
      double d2 = m01;
      m00 = (d1 + d2 * paramDouble2);
      m01 = (d1 * paramDouble1 + d2);
      d1 = m10;
      d2 = m11;
      m10 = (d1 + d2 * paramDouble2);
      m11 = (d1 * paramDouble1 + d2);
      updateState();
      return;
    case 4: 
    case 5: 
      m00 = (m01 * paramDouble2);
      m11 = (m10 * paramDouble1);
      if ((m00 != 0.0D) || (m11 != 0.0D)) {
        state = (i | 0x2);
      }
      type = -1;
      return;
    case 2: 
    case 3: 
      m01 = (m00 * paramDouble1);
      m10 = (m11 * paramDouble2);
      if ((m01 != 0.0D) || (m10 != 0.0D)) {
        state = (i | 0x4);
      }
      type = -1;
  ...
  public void setToRotation(double paramDouble1, double paramDouble2, double paramDouble3)
  {
    ...
    double d1 = m10;
    double d2 = 1.0D - m00;
    m02 = (paramDouble2 * d2 + paramDouble3 * d1);
    m12 = (paramDouble3 * d2 - paramDouble2 * d1);
    if ((m02 != 0.0D) || (m12 != 0.0D))
    {
      state |= 0x1;
      type |= 0x1;
  ...
  public void setToRotation(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4)
  {
    ...
    double d1 = m10;
    double d2 = 1.0D - m00;
    m02 = (paramDouble3 * d2 + paramDouble4 * d1);
    m12 = (paramDouble4 * d2 - paramDouble3 * d1);
    if ((m02 != 0.0D) || (m12 != 0.0D))
    {
      state |= 0x1;
      type |= 0x1;
  ...
  public void setToQuadrantRotation(int paramInt, double paramDouble1, double paramDouble2)
  {
    ...
    case 1: 
      ...
      m01 = -1.0D;
      m11 = 0.0D;
      m02 = (paramDouble1 + paramDouble2);
      m12 = (paramDouble2 - paramDouble1);
      if ((m02 == 0.0D) && (m12 == 0.0D))
      {
        state = 4;
        type = 8;
    ...
    case 2: 
      ...
      m01 = 0.0D;
      m11 = -1.0D;
      m02 = (paramDouble1 + paramDouble1);
      m12 = (paramDouble2 + paramDouble2);
      if ((m02 == 0.0D) && (m12 == 0.0D))
      {
        state = 2;
        type = 8;
    ...
    throws NoninvertibleTransformException
  {
    ...
    case 7: 
      ...
      return new AffineTransform(m11 / d, -m10 / d, -m01 / d, m00 / d, (m01 * m12 - m11 * m02) / d, (m10 * m02 - m00 * m12) / d, 7);
    case 6: 
      d = m00 * m11 - m01 * m10;
      if (Math.abs(d) <= Double.MIN_VALUE) {
        throw new NoninvertibleTransformException("Determinant is " + d);
      }
      return new AffineTransform(m11 / d, -m10 / d, -m01 / d, m00 / d, 0.0D, 0.0D, 6);
    case 5: 
      if ((m01 == 0.0D) || (m10 == 0.0D)) {
        throw new NoninvertibleTransformException("Determinant is 0");
      }
      return new AffineTransform(0.0D, 1.0D / m01, 1.0D / m10, 0.0D, -m12 / m10, -m02 / m01, 5);
    case 4: 
      if ((m01 == 0.0D) || (m10 == 0.0D)) {
        throw new NoninvertibleTransformException("Determinant is 0");
      }
      return new AffineTransform(0.0D, 1.0D / m01, 1.0D / m10, 0.0D, 0.0D, 0.0D, 4);
    case 3: 
      if ((m00 == 0.0D) || (m11 == 0.0D)) {
        throw new NoninvertibleTransformException("Determinant is 0");
      }
      return new AffineTransform(1.0D / m00, 0.0D, 0.0D, 1.0D / m11, -m02 / m00, -m12 / m11, 3);
    case 2: 
      if ((m00 == 0.0D) || (m11 == 0.0D)) {
        throw new NoninvertibleTransformException("Determinant is 0");
      }
      return new AffineTransform(1.0D / m00, 0.0D, 0.0D, 1.0D / m11, 0.0D, 0.0D, 2);
    case 1: 
      return new AffineTransform(1.0D, 0.0D, 0.0D, 1.0D, -m02, -m12, 1);
    }
  ...
  public Point2D transform(Point2D paramPoint2D1, Point2D paramPoint2D2)
  {
    ...
    default: 
      ...
      return null;
    case 7: 
      paramPoint2D2.setLocation(d1 * m00 + d2 * m01 + m02, d1 * m10 + d2 * m11 + m12);
      return paramPoint2D2;
    case 6: 
      paramPoint2D2.setLocation(d1 * m00 + d2 * m01, d1 * m10 + d2 * m11);
      return paramPoint2D2;
    case 5: 
      paramPoint2D2.setLocation(d2 * m01 + m02, d1 * m10 + m12);
      return paramPoint2D2;
    case 4: 
      paramPoint2D2.setLocation(d2 * m01, d1 * m10);
      return paramPoint2D2;
    case 3: 
      paramPoint2D2.setLocation(d1 * m00 + m02, d2 * m11 + m12);
      return paramPoint2D2;
    case 2: 
      paramPoint2D2.setLocation(d1 * m00, d2 * m11);
      return paramPoint2D2;
    case 1: 
      paramPoint2D2.setLocation(d1 + m02, d2 + m12);
      return paramPoint2D2;
    }
  ...
  public void transform(Point2D[] paramArrayOfPoint2D1, int paramInt1, Point2D[] paramArrayOfPoint2D2, int paramInt2, int paramInt3)
  {
    ...
    for (;;)
    {
      ...
      Object localObject = paramArrayOfPoint2D2[(paramInt2++)];
      if (localObject == null)
      {
      ...
      default: 
        ...
        return;
      case 7: 
        ((Point2D)localObject).setLocation(d1 * m00 + d2 * m01 + m02, d1 * m10 + d2 * m11 + m12);
        break;
      case 6: 
        ((Point2D)localObject).setLocation(d1 * m00 + d2 * m01, d1 * m10 + d2 * m11);
        break;
      case 5: 
        ((Point2D)localObject).setLocation(d2 * m01 + m02, d1 * m10 + m12);
        break;
      case 4: 
        ((Point2D)localObject).setLocation(d2 * m01, d1 * m10);
        break;
      case 3: 
        ((Point2D)localObject).setLocation(d1 * m00 + m02, d2 * m11 + m12);
        break;
      case 2: 
        ((Point2D)localObject).setLocation(d1 * m00, d2 * m11);
        break;
      case 1: 
        ((Point2D)localObject).setLocation(d1 + m02, d2 + m12);
        break;
      case 0: 
  ...
  public void transform(double[] paramArrayOfDouble1, int paramInt1, double[] paramArrayOfDouble2, int paramInt2, int paramInt3)
  {
    ...
    case 1: 
      ...
      for (;;)
      {
        ...
        paramArrayOfDouble1[(paramInt1++)] += d3;
        paramArrayOfDouble1[(paramInt1++)] += d6;
      }
      return;
    }
    ...
    throws NoninvertibleTransformException
  {
    ...
    case 4: 
      ...
      paramPoint2D2.setLocation(d2 / m10, d1 / m01);
      return paramPoint2D2;
    case 3: 
      d1 -= m02;
      d2 -= m12;
    ...
    throws NoninvertibleTransformException
  {
    ...
    case 4: 
      ...
      for (;;)
      {
        ...
        d8 = paramArrayOfDouble1[(paramInt1++)];
        paramArrayOfDouble1[(paramInt1++)] /= d4;
        paramArrayOfDouble2[(paramInt2++)] = (d8 / d2);
      }
      return;
    case 3: 
    ...
    case 2: 
      ...
      for (;;)
      {
        ...
        paramArrayOfDouble1[(paramInt1++)] /= d5;
      }
      return;
    case 1: 
      d3 = m02;
  ...
  public int hashCode()
  {
    ...
    l = l * 31L + Double.doubleToLongBits(m01);
    l = l * 31L + Double.doubleToLongBits(m02);
    l = l * 31L + Double.doubleToLongBits(m10);
    l = l * 31L + Double.doubleToLongBits(m11);
    l = l * 31L + Double.doubleToLongBits(m12);
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\geom\AffineTransform.class
