  ...
  extends RectangularShape
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof Rectangle2D))
    {
      ...
      return (getX() == localRectangle2D.getX()) && (getY() == localRectangle2D.getY()) && (getWidth() == localRectangle2D.getWidth()) && (getHeight() == localRectangle2D.getHeight());
    }
    return false;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\awt\geom\Rectangle2D.class
