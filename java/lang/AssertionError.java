  ...
  extends Error
{
  ...
  {
    this(String.valueOf(paramBoolean));
  }
  
  public AssertionError(char paramChar)
  {
    this(String.valueOf(paramChar));
  }
  ...
  {
    this(String.valueOf(paramLong));
  }
  
  public AssertionError(float paramFloat)
  {
    this(String.valueOf(paramFloat));
  }
  
  public AssertionError(double paramDouble)
  {
    this(String.valueOf(paramDouble));
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\lang\AssertionError.class
