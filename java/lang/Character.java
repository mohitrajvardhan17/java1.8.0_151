  ...
  implements Serializable, Comparable<Character>
{
  ...
  {
    if (paramChar <= '') {
      return CharacterCache.cache[paramChar];
    }
  ...
  {
    return (isHighSurrogate(paramChar1)) && (isLowSurrogate(paramChar2));
  }
  
  public static int charCount(int paramInt)
  {
    return paramInt >= 65536 ? 2 : 1;
  }
  ...
  {
    return codePointAtImpl(paramArrayOfChar, paramInt, paramArrayOfChar.length);
  }
  ...
  {
    char c1 = paramCharSequence.charAt(--paramInt);
    if ((isLowSurrogate(c1)) && (paramInt > 0))
    {
      char c2 = paramCharSequence.charAt(--paramInt);
      if (isHighSurrogate(c2)) {
        return toCodePoint(c2, c1);
      }
    }
    return c1;
  }
  ...
  {
    return codePointBeforeImpl(paramArrayOfChar, paramInt, 0);
  }
  ...
  {
    char c1 = paramArrayOfChar[(--paramInt1)];
    if ((isLowSurrogate(c1)) && (paramInt1 > paramInt2))
    {
      char c2 = paramArrayOfChar[(--paramInt1)];
      if (isHighSurrogate(c2)) {
        return toCodePoint(c2, c1);
  ...
  {
    return isLowerCase(paramChar);
  }
  
  public static boolean isLowerCase(int paramInt)
  {
    return (getType(paramInt) == 2) || (CharacterData.of(paramInt).isOtherLowercase(paramInt));
  }
  
  public static boolean isUpperCase(char paramChar)
  {
    return isUpperCase(paramChar);
  }
  
  public static boolean isUpperCase(int paramInt)
  {
    return (getType(paramInt) == 1) || (CharacterData.of(paramInt).isOtherUppercase(paramInt));
  }
  
  public static boolean isTitleCase(char paramChar)
  {
    return isTitleCase(paramChar);
  }
  ...
  {
    return CharacterData.of(paramInt).isJavaIdentifierStart(paramInt);
  }
  ...
  {
    return getDirectionality(paramChar);
  }
  
  public static byte getDirectionality(int paramInt)
  {
    return CharacterData.of(paramInt).getDirectionality(paramInt);
  }
  
  public static boolean isMirrored(char paramChar)
  {
    return isMirrored(paramChar);
  }
  
  public static boolean isMirrored(int paramInt)
  {
    return CharacterData.of(paramInt).isMirrored(paramInt);
  }
  ...
  {
    return (char)((paramChar & 0xFF00) >> '\b' | paramChar << '\b');
  }
  ...
  public static String getName(int paramInt)
  {
    ...
    UnicodeBlock localUnicodeBlock = UnicodeBlock.of(paramInt);
    if (localUnicodeBlock != null) {
      return localUnicodeBlock.toString().replace('_', ' ') + " " + Integer.toHexString(paramInt).toUpperCase(Locale.ENGLISH);
    }
    ...
    extends Character.Subset
  {
    ...
    public static UnicodeBlock of(int paramInt)
    {
      ...
      for (int k = i / 2; i - j > 1; k = (i + j) / 2) {
        if (paramInt >= blockStarts[k]) {
          j = k;
        } else {
          i = k;
        }
    ...
    {
      UnicodeBlock localUnicodeBlock = (UnicodeBlock)map.get(paramString.toUpperCase(Locale.US));
      if (localUnicodeBlock == null) {
        throw new IllegalArgumentException();
      }
  ...
  public static enum UnicodeScript
  {
    ...
    public static UnicodeScript of(int paramInt)
    {
      ...
      int j = Arrays.binarySearch(scriptStarts, paramInt);
      if (j < 0) {
        j = -j - 2;
      }
      return scripts[j];
    ...
    public static final UnicodeScript forName(String paramString)
    {
      ...
      UnicodeScript localUnicodeScript = (UnicodeScript)aliases.get(paramString);
      if (localUnicodeScript != null) {
        return localUnicodeScript;
      }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\lang\Character.class
