...
public final class Math
{
  ...
  static double twoToTheDoubleScaleDown = powerOfTwoD(65024);
  ...
  public static long round(double paramDouble)
  {
    ...
    long l2 = (l1 & 0x7FF0000000000000) >> 52;
    long l3 = 1074L - l2;
    if ((l3 & 0xFFFFFFFFFFFFFFC0) == 0L)
    {
      long l4 = l1 & 0xFFFFFFFFFFFFF | 0x10000000000000;
      if (l1 < 0L) {
        l4 = -l4;
      }
  ...
  public static long multiplyExact(long paramLong1, long paramLong2)
  {
    ...
    if (((l2 | l3) >>> 31 != 0L) && (((paramLong2 != 0L) && (l1 / paramLong2 != paramLong1)) || ((paramLong1 == Long.MIN_VALUE) && (paramLong2 == -1L)))) {
      throw new ArithmeticException("long overflow");
    }
    return l1;
  }
  ...
  {
    int i = paramInt1 - floorDiv(paramInt1, paramInt2) * paramInt2;
    return i;
  }
  ...
  public static float max(float paramFloat1, float paramFloat2)
  {
    ...
    if ((paramFloat1 == 0.0F) && (paramFloat2 == 0.0F) && (Float.floatToRawIntBits(paramFloat1) == negativeZeroFloatBits)) {
      return paramFloat2;
    }
  ...
  public static double max(double paramDouble1, double paramDouble2)
  {
    ...
    if ((paramDouble1 == 0.0D) && (paramDouble2 == 0.0D) && (Double.doubleToRawLongBits(paramDouble1) == negativeZeroDoubleBits)) {
      return paramDouble2;
    }
  ...
  public static float min(float paramFloat1, float paramFloat2)
  {
    ...
    if ((paramFloat1 == 0.0F) && (paramFloat2 == 0.0F) && (Float.floatToRawIntBits(paramFloat2) == negativeZeroFloatBits)) {
      return paramFloat2;
    }
    return paramFloat1 <= paramFloat2 ? paramFloat1 : paramFloat2;
  }
  ...
  public static double min(double paramDouble1, double paramDouble2)
  {
    ...
    if ((paramDouble1 == 0.0D) && (paramDouble2 == 0.0D) && (Double.doubleToRawLongBits(paramDouble2) == negativeZeroDoubleBits)) {
      return paramDouble2;
    }
    return paramDouble1 <= paramDouble2 ? paramDouble1 : paramDouble2;
  }
  ...
  public static double ulp(double paramDouble)
  {
    ...
    assert ((i <= 1023) && (i >= 64514));
    i -= 52;
    if (i >= 64514) {
      return powerOfTwoD(i);
    }
    return Double.longBitsToDouble(1L << i - 64462);
  }
  ...
  public static float ulp(float paramFloat)
  {
    ...
    return Float.intBitsToFloat(1 << i - 65387);
  }
  
  public static double signum(double paramDouble)
  {
    return (paramDouble == 0.0D) || (Double.isNaN(paramDouble)) ? paramDouble : copySign(1.0D, paramDouble);
  }
  
  public static float signum(float paramFloat)
  {
    return (paramFloat == 0.0F) || (Float.isNaN(paramFloat)) ? paramFloat : copySign(1.0F, paramFloat);
  }
  ...
  {
    return Double.longBitsToDouble(Double.doubleToRawLongBits(paramDouble2) & 0x8000000000000000 | Double.doubleToRawLongBits(paramDouble1) & 0x7FFFFFFFFFFFFFFF);
  }
  ...
  {
    return (int)(((Double.doubleToRawLongBits(paramDouble) & 0x7FF0000000000000) >> 52) - 1023L);
  }
  ...
  {
    if ((Double.isNaN(paramDouble)) || (paramDouble == Double.NEGATIVE_INFINITY)) {
      return paramDouble;
    }
    if (paramDouble == 0.0D) {
      return -4.9E-324D;
  ...
  {
    if ((Float.isNaN(paramFloat)) || (paramFloat == Float.NEGATIVE_INFINITY)) {
      return paramFloat;
    }
    if (paramFloat == 0.0F) {
      return -1.4E-45F;
  ...
  {
    paramInt = max(min(paramInt, 278), 65258);
    return (float)(paramFloat * powerOfTwoD(paramInt));
  }
  
  static double powerOfTwoD(int paramInt)
  {
    assert ((paramInt >= 64514) && (paramInt <= 1023));
    return Double.longBitsToDouble(paramInt + 1023L << 52 & 0x7FF0000000000000);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\lang\Math.class
