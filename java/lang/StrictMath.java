...
public final class StrictMath
{
  ...
  {
    return floorOrCeil(paramDouble, -0.0D, 1.0D, 1.0D);
  }
  ...
  private static double floorOrCeil(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4)
  {
    ...
    double d = Double.longBitsToDouble(l1 & (l2 ^ 0xFFFFFFFFFFFFFFFF));
  ...
  {
    return Math.floorDiv(paramLong1, paramLong2);
  }
  ...
  {
    return Math.floorMod(paramLong1, paramLong2);
  }
  ...
  {
    return Math.copySign(paramDouble1, Double.isNaN(paramDouble2) ? 1.0D : paramDouble2);
  }
  
  public static float copySign(float paramFloat1, float paramFloat2)
  {
    return Math.copySign(paramFloat1, Float.isNaN(paramFloat2) ? 1.0F : paramFloat2);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\lang\StrictMath.class
