  ...
  implements Serializable, CharSequence
{
  ...
  {
    return super.lastIndexOf(paramString);
  }
    ...
    throws IOException, ClassNotFoundException
  {
    ...
    count = paramObjectInputStream.readInt();
    value = ((char[])paramObjectInputStream.readObject());
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\lang\StringBuilder.class
