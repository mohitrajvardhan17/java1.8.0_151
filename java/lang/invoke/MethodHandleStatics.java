...
class MethodHandleStatics
{
  ...
  static String getNameString(MethodHandle paramMethodHandle, MethodType paramMethodType)
  {
    ...
    if (paramMethodHandle != null) {
      localMemberName = paramMethodHandle.internalMemberName();
    }
    if (localMemberName == null) {
      return "invoke" + paramMethodType;
    }
    return localMemberName.getName() + paramMethodType;
  }
  
  static String getNameString(MethodHandle paramMethodHandle1, MethodHandle paramMethodHandle2)
  {
    return getNameString(paramMethodHandle1, paramMethodHandle2 == null ? (MethodType)null : paramMethodHandle2.type());
  }
  
  static String getNameString(MethodHandle paramMethodHandle)
  {
    return getNameString(paramMethodHandle, (MethodType)null);
  }
  ...
  {
    return new InternalError(paramString);
  }
  ...
  {
    return new IllegalStateException(message(paramString, paramObject));
  }
  ...
  {
    return new IllegalArgumentException(message(paramString, paramObject));
  }
  
  static RuntimeException newIllegalArgumentException(String paramString, Object paramObject1, Object paramObject2)
  {
    return new IllegalArgumentException(message(paramString, paramObject1, paramObject2));
  }
  ...
  static
  {
    ...
    AccessController.doPrivileged(new PrivilegedAction()
    {
      public Void run()
      {
        val$values[0] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.DEBUG_NAMES"));
        val$values[1] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.DUMP_CLASS_FILES"));
        val$values[2] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.TRACE_INTERPRETER"));
        val$values[3] = Boolean.valueOf(Boolean.getBoolean("java.lang.invoke.MethodHandle.TRACE_METHOD_LINKAGE"));
        val$values[4] = Integer.getInteger("java.lang.invoke.MethodHandle.COMPILE_THRESHOLD", 0);
        val$values[5] = Integer.getInteger("java.lang.invoke.MethodHandle.DONT_INLINE_THRESHOLD", 30);
        val$values[6] = Integer.getInteger("java.lang.invoke.MethodHandle.PROFILE_LEVEL", 0);
        val$values[7] = Boolean.valueOf(Boolean.parseBoolean(System.getProperty("java.lang.invoke.MethodHandle.PROFILE_GWT", "true")));
        val$values[8] = Integer.getInteger("java.lang.invoke.MethodHandle.CUSTOMIZE_THRESHOLD", 127);
        return null;
      }
    });
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\lang\invoke\MethodHandleStatics.class
