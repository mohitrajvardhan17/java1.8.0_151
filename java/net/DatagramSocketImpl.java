  ...
  implements SocketOptions
{
  ...
  <T> void setOption(SocketOption<T> paramSocketOption, T paramT)
    throws IOException
  {
  ...
  <T> T getOption(SocketOption<T> paramSocketOption)
    throws IOException
  {
    if (paramSocketOption == StandardSocketOptions.SO_SNDBUF) {
    ...
    {
      Integer localInteger = Integer.valueOf(getTimeToLive());
      return localInteger;
    }
