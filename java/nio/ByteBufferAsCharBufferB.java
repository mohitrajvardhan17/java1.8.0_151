  ...
  extends CharBuffer
{
  ...
  public CharBuffer slice()
  {
    ...
    int m = (i << 1) + offset;
    assert (m >= 0);
    return new ByteBufferAsCharBufferB(bb, -1, 0, k, k, m);
  }
  
  public CharBuffer duplicate()
  {
    return new ByteBufferAsCharBufferB(bb, markValue(), position(), limit(), capacity(), offset);
  }
  ...
  {
    return Bits.getCharB(bb, ix(checkIndex(paramInt)));
  }
  
  char getUnchecked(int paramInt)
  {
    return Bits.getCharB(bb, ix(paramInt));
  }
  
  public CharBuffer put(char paramChar)
  {
    Bits.putCharB(bb, ix(nextPutIndex()), paramChar);
    return this;
  }
  
  public CharBuffer put(int paramInt, char paramChar)
  {
    Bits.putCharB(bb, ix(checkIndex(paramInt)), paramChar);
    return this;
  }
  ...
  public CharBuffer subSequence(int paramInt1, int paramInt2)
  {
    ...
    return new ByteBufferAsCharBufferB(bb, -1, i + paramInt1, i + paramInt2, capacity(), offset);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\nio\ByteBufferAsCharBufferB.class
