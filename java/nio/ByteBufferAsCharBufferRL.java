  ...
  extends ByteBufferAsCharBufferL
{
  ...
  public CharBuffer slice()
  {
    ...
    int m = (i << 1) + offset;
    assert (m >= 0);
    return new ByteBufferAsCharBufferRL(bb, -1, 0, k, k, m);
  }
  ...
  public CharBuffer subSequence(int paramInt1, int paramInt2)
  {
    ...
    return new ByteBufferAsCharBufferRL(bb, -1, i + paramInt1, i + paramInt2, capacity(), offset);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\nio\ByteBufferAsCharBufferRL.class
