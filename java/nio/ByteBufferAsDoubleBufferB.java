  ...
  extends DoubleBuffer
{
  ...
  public DoubleBuffer slice()
  {
    ...
    int m = (i << 3) + offset;
    assert (m >= 0);
    return new ByteBufferAsDoubleBufferB(bb, -1, 0, k, k, m);
  }
  
  public DoubleBuffer duplicate()
  {
    return new ByteBufferAsDoubleBufferB(bb, markValue(), position(), limit(), capacity(), offset);
  }
  
  public DoubleBuffer asReadOnlyBuffer()
  {
    return new ByteBufferAsDoubleBufferRB(bb, markValue(), position(), limit(), capacity(), offset);
  }
  ...
  {
    return Bits.getDoubleB(bb, ix(checkIndex(paramInt)));
  }
  
  public DoubleBuffer put(double paramDouble)
  {
    Bits.putDoubleB(bb, ix(nextPutIndex()), paramDouble);
    return this;
  }
  
  public DoubleBuffer put(int paramInt, double paramDouble)
  {
    Bits.putDoubleB(bb, ix(checkIndex(paramInt)), paramDouble);
    return this;
  }
