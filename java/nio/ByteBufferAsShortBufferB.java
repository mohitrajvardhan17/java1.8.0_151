  ...
  extends ShortBuffer
{
  ...
  public ShortBuffer slice()
  {
    ...
    int m = (i << 1) + offset;
    assert (m >= 0);
    return new ByteBufferAsShortBufferB(bb, -1, 0, k, k, m);
  }
  
  public ShortBuffer duplicate()
  {
    return new ByteBufferAsShortBufferB(bb, markValue(), position(), limit(), capacity(), offset);
  }
  ...
  {
    return Bits.getShortB(bb, ix(checkIndex(paramInt)));
  }
  
  public ShortBuffer put(short paramShort)
  {
    Bits.putShortB(bb, ix(nextPutIndex()), paramShort);
    return this;
  }
  
  public ShortBuffer put(int paramInt, short paramShort)
  {
    Bits.putShortB(bb, ix(checkIndex(paramInt)), paramShort);
    return this;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\nio\ByteBufferAsShortBufferB.class
