  ...
  implements DirectBuffer
{
  ...
  public CharBuffer asCharBuffer()
  {
    ...
    if ((!unaligned) && ((address + i) % 2L != 0L)) {
      return bigEndian ? new ByteBufferAsCharBufferRB(this, -1, 0, m, m, i) : new ByteBufferAsCharBufferRL(this, -1, 0, m, m, i);
    }
    return nativeByteOrder ? new DirectCharBufferRU(this, -1, 0, m, m, i) : new DirectCharBufferRS(this, -1, 0, m, m, i);
  }
  ...
  public ShortBuffer asShortBuffer()
  {
    ...
    int m = k >> 1;
    if ((!unaligned) && ((address + i) % 2L != 0L)) {
      return bigEndian ? new ByteBufferAsShortBufferRB(this, -1, 0, m, m, i) : new ByteBufferAsShortBufferRL(this, -1, 0, m, m, i);
    }
    return nativeByteOrder ? new DirectShortBufferRU(this, -1, 0, m, m, i) : new DirectShortBufferRS(this, -1, 0, m, m, i);
  }
  ...
  public IntBuffer asIntBuffer()
  {
    ...
    if ((!unaligned) && ((address + i) % 4L != 0L)) {
      return bigEndian ? new ByteBufferAsIntBufferRB(this, -1, 0, m, m, i) : new ByteBufferAsIntBufferRL(this, -1, 0, m, m, i);
    }
    return nativeByteOrder ? new DirectIntBufferRU(this, -1, 0, m, m, i) : new DirectIntBufferRS(this, -1, 0, m, m, i);
  }
  ...
  public LongBuffer asLongBuffer()
  {
    ...
    if ((!unaligned) && ((address + i) % 8L != 0L)) {
      return bigEndian ? new ByteBufferAsLongBufferRB(this, -1, 0, m, m, i) : new ByteBufferAsLongBufferRL(this, -1, 0, m, m, i);
    }
    return nativeByteOrder ? new DirectLongBufferRU(this, -1, 0, m, m, i) : new DirectLongBufferRS(this, -1, 0, m, m, i);
  }
  ...
  public FloatBuffer asFloatBuffer()
  {
    ...
    int m = k >> 2;
    if ((!unaligned) && ((address + i) % 4L != 0L)) {
      return bigEndian ? new ByteBufferAsFloatBufferRB(this, -1, 0, m, m, i) : new ByteBufferAsFloatBufferRL(this, -1, 0, m, m, i);
    }
    return nativeByteOrder ? new DirectFloatBufferRU(this, -1, 0, m, m, i) : new DirectFloatBufferRS(this, -1, 0, m, m, i);
  }
  ...
  public DoubleBuffer asDoubleBuffer()
  {
    ...
    int m = k >> 3;
    if ((!unaligned) && ((address + i) % 8L != 0L)) {
      return bigEndian ? new ByteBufferAsDoubleBufferRB(this, -1, 0, m, m, i) : new ByteBufferAsDoubleBufferRL(this, -1, 0, m, m, i);
    }
    return nativeByteOrder ? new DirectDoubleBufferRU(this, -1, 0, m, m, i) : new DirectDoubleBufferRS(this, -1, 0, m, m, i);
  }
}
