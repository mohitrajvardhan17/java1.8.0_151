  ...
  implements DirectBuffer
{
  ...
  public DoubleBuffer slice()
  {
    ...
    int m = i << 3;
    assert (m >= 0);
    return new DirectDoubleBufferU(this, -1, 0, k, k, m);
  }
  ...
  public DoubleBuffer put(DoubleBuffer paramDoubleBuffer)
  {
    ...
    if ((paramDoubleBuffer instanceof DirectDoubleBufferU))
    {
      ...
      DirectDoubleBufferU localDirectDoubleBufferU = (DirectDoubleBufferU)paramDoubleBuffer;
      j = localDirectDoubleBufferU.position();
      k = localDirectDoubleBufferU.limit();
      assert (j <= k);
      int m = j <= k ? k - j : 0;
      int n = position();
      int i1 = limit();
      ...
      unsafe.copyMemory(localDirectDoubleBufferU.ix(j), ix(n), m << 3);
      localDirectDoubleBufferU.position(j + m);
      position(n + m);
    }
    else if (hb != null)
    {
