...
{
  DirectFloatBufferRU(DirectBuffer paramDirectBuffer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
  ...
  public FloatBuffer slice()
  {
    ...
    int m = i << 2;
    assert (m >= 0);
    return new DirectFloatBufferRU(this, -1, 0, k, k, m);
  }
