  ...
  implements DirectBuffer
{
  ...
  {
    return new DirectLongBufferS(this, markValue(), position(), limit(), capacity(), 0);
  }
  ...
  {
    return Bits.swap(unsafe.getLong(ix(checkIndex(paramInt))));
  }
  ...
  public LongBuffer put(LongBuffer paramLongBuffer)
  {
    ...
    if ((paramLongBuffer instanceof DirectLongBufferS))
    {
      ...
      DirectLongBufferS localDirectLongBufferS = (DirectLongBufferS)paramLongBuffer;
      j = localDirectLongBufferS.position();
      k = localDirectLongBufferS.limit();
      assert (j <= k);
      int m = j <= k ? k - j : 0;
      int n = position();
      int i1 = limit();
      ...
      unsafe.copyMemory(localDirectLongBufferS.ix(j), ix(n), m << 3);
      localDirectLongBufferS.position(j + m);
      position(n + m);
    }
    else if (hb != null)
    {
