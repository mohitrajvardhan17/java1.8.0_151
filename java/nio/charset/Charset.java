  ...
  implements Comparable<Charset>
{
  ...
  private static void checkName(String paramString)
  {
    ...
    for (int j = 0; j < i; j++)
    {
      ...
      if (((k < 65) || (k > 90)) && ((k < 97) || (k > 122)) && ((k < 48) || (k > 57)) && ((k != 45) || (j == 0)) && ((k != 43) || (j == 0)) && ((k != 58) || (j == 0)) && ((k != 95) || (j == 0)) && ((k != 46) || (j == 0))) {
        throw new IllegalCharsetNameException(paramString);
      }
    }
  }
  ...
  private static Iterator<CharsetProvider> providers()
  {
    new Iterator()
    {
      ...
      public CharsetProvider next()
      {
        ...
        CharsetProvider localCharsetProvider = next;
        next = null;
        return localCharsetProvider;
      }
  ...
  private static Charset lookupViaProviders(String paramString)
  {
    ...
    {
      gate.set(gate);
      Charset localCharset = (Charset)AccessController.doPrivileged(new PrivilegedAction()
      {
        public Charset run()
        {
          Iterator localIterator = Charset.access$000();
          while (localIterator.hasNext())
          {
            CharsetProvider localCharsetProvider = (CharsetProvider)localIterator.next();
            Charset localCharset = localCharsetProvider.charsetForName(val$charsetName);
  ...
  {
    (SortedMap)AccessController.doPrivileged(new PrivilegedAction()
    {
  ...
  public final Set<String> aliases()
  {
    ...
    for (int j = 0; j < i; j++) {
      localHashSet.add(aliases[j]);
    }
    aliasSet = Collections.unmodifiableSet(localHashSet);
    return aliasSet;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    return name.equals(((Charset)paramObject).name());
  }
  ...
  private static class ExtendedProviderHolder
  {
    ...
    {
      (CharsetProvider)AccessController.doPrivileged(new PrivilegedAction()
      {
