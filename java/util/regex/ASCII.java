...
final class ASCII
{
  ...
  {
    return (paramInt & 0xFFFFFF80) == 0 ? ctype[paramInt] : 0;
  }
  ...
  {
    return isType(paramInt, 67328);
  }
  
  static int toDigit(int paramInt)
  {
    return ctype[(paramInt & 0x7F)] & 0x3F;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\java\util\regex\ASCII.class
