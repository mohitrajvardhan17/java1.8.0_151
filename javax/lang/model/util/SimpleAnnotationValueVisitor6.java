  ...
  extends AbstractAnnotationValueVisitor6<R, P>
{
  ...
  {
    return (R)defaultAction(Boolean.valueOf(paramBoolean), paramP);
  }
  
  public R visitByte(byte paramByte, P paramP)
  {
    return (R)defaultAction(Byte.valueOf(paramByte), paramP);
  }
  
  public R visitChar(char paramChar, P paramP)
  {
    return (R)defaultAction(Character.valueOf(paramChar), paramP);
  }
  
  public R visitDouble(double paramDouble, P paramP)
  {
    return (R)defaultAction(Double.valueOf(paramDouble), paramP);
  }
  
  public R visitFloat(float paramFloat, P paramP)
  {
    return (R)defaultAction(Float.valueOf(paramFloat), paramP);
  }
  
  public R visitInt(int paramInt, P paramP)
  {
    return (R)defaultAction(Integer.valueOf(paramInt), paramP);
  }
  
  public R visitLong(long paramLong, P paramP)
  {
    return (R)defaultAction(Long.valueOf(paramLong), paramP);
  }
  
  public R visitShort(short paramShort, P paramP)
  {
    return (R)defaultAction(Short.valueOf(paramShort), paramP);
  }
  
  public R visitString(String paramString, P paramP)
  {
    return (R)defaultAction(paramString, paramP);
  }
  
  public R visitType(TypeMirror paramTypeMirror, P paramP)
  {
    return (R)defaultAction(paramTypeMirror, paramP);
  }
  ...
  {
    return (R)defaultAction(paramAnnotationMirror, paramP);
  }
  
  public R visitArray(List<? extends AnnotationValue> paramList, P paramP)
  {
    return (R)defaultAction(paramList, paramP);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\lang\model\util\SimpleAnnotationValueVisitor6.class
