  ...
  implements RMIConnection
{
    ...
    throws IOException, InstanceNotFoundException
  {
    try
    {
      ref.invoke(this, $method_addNotificationListener_0, new Object[] { paramObjectName1, paramObjectName2, paramMarshalledObject1, paramMarshalledObject2, paramSubject }, -8578317696269497109L);
    }
    ...
    throws IOException, InstanceNotFoundException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_addNotificationListeners_1, new Object[] { paramArrayOfObjectName, paramArrayOfMarshalledObject, paramArrayOfSubject }, -5321691879380783377L);
    ...
    throws IOException, InstanceAlreadyExistsException, MBeanException, MBeanRegistrationException, NotCompliantMBeanException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_createMBean_3, new Object[] { paramString, paramObjectName, paramMarshalledObject, paramArrayOfString, paramSubject }, 4867822117947806114L);
    ...
    throws IOException, InstanceAlreadyExistsException, InstanceNotFoundException, MBeanException, MBeanRegistrationException, NotCompliantMBeanException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_createMBean_4, new Object[] { paramString, paramObjectName1, paramObjectName2, paramMarshalledObject, paramArrayOfString, paramSubject }, -6604955182088909937L);
      return (ObjectInstance)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceAlreadyExistsException, InstanceNotFoundException, MBeanException, MBeanRegistrationException, NotCompliantMBeanException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_createMBean_5, new Object[] { paramString, paramObjectName1, paramObjectName2, paramSubject }, -8679469989872508324L);
      return (ObjectInstance)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceAlreadyExistsException, MBeanException, MBeanRegistrationException, NotCompliantMBeanException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_createMBean_6, new Object[] { paramString, paramObjectName, paramSubject }, 2510753813974665446L);
      return (ObjectInstance)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_fetchNotifications_7, new Object[] { new Long(paramLong1), new Integer(paramInt), new Long(paramLong2) }, -5037523307973544478L);
    ...
    throws IOException, AttributeNotFoundException, InstanceNotFoundException, MBeanException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getAttribute_8, new Object[] { paramObjectName, paramString, paramSubject }, -1089783104982388203L);
      return localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceNotFoundException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getAttributes_9, new Object[] { paramObjectName, paramArrayOfString, paramSubject }, 6285293806596348999L);
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getConnectionId_10, null, -67907180346059933L);
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getDefaultDomain_11, new Object[] { paramSubject }, 6047668923998658472L);
      return (String)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getDomains_12, new Object[] { paramSubject }, -6662314179953625551L);
      return (String[])localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getMBeanCount_13, new Object[] { paramSubject }, -2042362057335820635L);
      return (Integer)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceNotFoundException, IntrospectionException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getMBeanInfo_14, new Object[] { paramObjectName, paramSubject }, -7404813916326233354L);
    ...
    throws IOException, InstanceNotFoundException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getObjectInstance_15, new Object[] { paramObjectName, paramSubject }, 6950095694996159938L);
      return (ObjectInstance)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceNotFoundException, MBeanException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_invoke_16, new Object[] { paramObjectName, paramString, paramMarshalledObject, paramArrayOfString, paramSubject }, 1434350937885235744L);
      return localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceNotFoundException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_isInstanceOf_17, new Object[] { paramObjectName, paramString, paramSubject }, -2147516868461740814L);
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_isRegistered_18, new Object[] { paramObjectName, paramSubject }, 8325683335228268564L);
      return ((Boolean)localObject).booleanValue();
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_queryMBeans_19, new Object[] { paramObjectName, paramMarshalledObject, paramSubject }, 2915881009400597976L);
    ...
    throws IOException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_queryNames_20, new Object[] { paramObjectName, paramMarshalledObject, paramSubject }, 9152567528369059802L);
      return (Set)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceNotFoundException, ListenerNotFoundException
  {
    try
    {
      ref.invoke(this, $method_removeNotificationListener_21, new Object[] { paramObjectName1, paramObjectName2, paramMarshalledObject1, paramMarshalledObject2, paramSubject }, 2578029900065214857L);
    }
    catch (RuntimeException localRuntimeException)
    {
      throw localRuntimeException;
    ...
    throws IOException, InstanceNotFoundException, ListenerNotFoundException
  {
    try
    {
      ref.invoke(this, $method_removeNotificationListener_22, new Object[] { paramObjectName1, paramObjectName2, paramSubject }, 6604721169198089513L);
    }
    catch (RuntimeException localRuntimeException)
    {
      throw localRuntimeException;
    ...
    throws IOException, InstanceNotFoundException, ListenerNotFoundException
  {
    try
    {
      ref.invoke(this, $method_removeNotificationListeners_23, new Object[] { paramObjectName, paramArrayOfInteger, paramSubject }, 2549120024456183446L);
    }
    catch (RuntimeException localRuntimeException)
    {
      throw localRuntimeException;
    ...
    throws IOException, AttributeNotFoundException, InstanceNotFoundException, InvalidAttributeValueException, MBeanException, ReflectionException
  {
    try
    {
      ref.invoke(this, $method_setAttribute_24, new Object[] { paramObjectName, paramMarshalledObject, paramSubject }, 6738606893952597516L);
    }
    catch (RuntimeException localRuntimeException)
    {
      throw localRuntimeException;
    ...
    throws IOException, InstanceNotFoundException, ReflectionException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_setAttributes_25, new Object[] { paramObjectName, paramMarshalledObject, paramSubject }, -230470228399681820L);
      return (AttributeList)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws IOException, InstanceNotFoundException, MBeanRegistrationException
  {
    try
    {
      ref.invoke(this, $method_unregisterMBean_26, new Object[] { paramObjectName, paramSubject }, -159498580868721452L);
    }
    catch (RuntimeException localRuntimeException)
    {
      throw localRuntimeException;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\management\remote\rmi\RMIConnectionImpl_Stub.class
