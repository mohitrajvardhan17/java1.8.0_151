  ...
  implements Context
{
  ...
  protected void init(Hashtable<?, ?> paramHashtable)
    throws NamingException
  {
    myProps = ResourceManager.getInitialEnvironment(paramHashtable);
  ...
  public static <T> T doLookup(Name paramName)
    throws NamingException
  {
    return (T)new InitialContext().lookup(paramName);
  }
  
  public static <T> T doLookup(String paramString)
    throws NamingException
  {
    return (T)new InitialContext().lookup(paramString);
  }
    ...
    throws NamingException
  {
    ...
    if (str != null)
    {
      Context localContext = NamingManager.getURLContext(str, myProps);
    ...
    throws NamingException
  {
    ...
    if (paramName.size() > 0)
    {
      ...
      if (str2 != null)
      {
        Context localContext = NamingManager.getURLContext(str2, myProps);
        if (localContext != null) {
          return localContext;
        }
      }
  ...
  public Object lookup(String paramString)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramString).lookup(paramString);
  }
  
  public Object lookup(Name paramName)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramName).lookup(paramName);
  }
  
  public void bind(String paramString, Object paramObject)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramString).bind(paramString, paramObject);
  }
  
  public void bind(Name paramName, Object paramObject)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramName).bind(paramName, paramObject);
  }
  
  public void rebind(String paramString, Object paramObject)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramString).rebind(paramString, paramObject);
  }
  
  public void rebind(Name paramName, Object paramObject)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramName).rebind(paramName, paramObject);
  }
  
  public void unbind(String paramString)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramString).unbind(paramString);
  }
  
  public void unbind(Name paramName)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramName).unbind(paramName);
  }
  
  public void rename(String paramString1, String paramString2)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramString1).rename(paramString1, paramString2);
  }
  
  public void rename(Name paramName1, Name paramName2)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramName1).rename(paramName1, paramName2);
  }
  
  public NamingEnumeration<NameClassPair> list(String paramString)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramString).list(paramString);
  }
  
  public NamingEnumeration<NameClassPair> list(Name paramName)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramName).list(paramName);
  }
  
  public NamingEnumeration<Binding> listBindings(String paramString)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramString).listBindings(paramString);
  }
  
  public NamingEnumeration<Binding> listBindings(Name paramName)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramName).listBindings(paramName);
  }
  
  public void destroySubcontext(String paramString)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramString).destroySubcontext(paramString);
  }
  
  public void destroySubcontext(Name paramName)
    throws NamingException
  {
    getURLOrDefaultInitCtx(paramName).destroySubcontext(paramName);
  }
  
  public Context createSubcontext(String paramString)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramString).createSubcontext(paramString);
  }
  
  public Context createSubcontext(Name paramName)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramName).createSubcontext(paramName);
  }
  
  public Object lookupLink(String paramString)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramString).lookupLink(paramString);
  }
  
  public Object lookupLink(Name paramName)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramName).lookupLink(paramName);
  }
  
  public NameParser getNameParser(String paramString)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramString).getNameParser(paramString);
  }
  
  public NameParser getNameParser(Name paramName)
    throws NamingException
  {
    return getURLOrDefaultInitCtx(paramName).getNameParser(paramName);
  }
