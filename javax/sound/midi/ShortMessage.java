  ...
  extends MidiMessage
{
    ...
    throws InvalidMidiDataException
  {
    ...
    if (length > 1)
    {
      data[1] = ((byte)(paramInt2 & 0xFF));
      if (length > 2) {
        data[2] = ((byte)(paramInt3 & 0xFF));
      }
    }
  }
  ...
  public Object clone()
  {
    ...
    ShortMessage localShortMessage = new ShortMessage(arrayOfByte);
    return localShortMessage;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\sound\midi\ShortMessage.class
