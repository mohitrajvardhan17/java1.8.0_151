...
public class BorderFactory
{
  ...
  {
    return createSharedBevel(paramInt);
  }
  
  public static Border createBevelBorder(int paramInt, Color paramColor1, Color paramColor2)
  {
    return new BevelBorder(paramInt, paramColor1, paramColor2);
  }
  ...
  {
    return new BevelBorder(paramInt, paramColor1, paramColor2, paramColor3, paramColor4);
  }
  ...
  {
    return new SoftBevelBorder(paramInt, paramColor1, paramColor2);
  }
  ...
  {
    return new SoftBevelBorder(paramInt, paramColor1, paramColor2, paramColor3, paramColor4);
  }
  ...
  {
    return new EtchedBorder(paramColor1, paramColor2);
  }
  ...
  {
    return new TitledBorder(paramBorder, paramString, paramInt1, paramInt2, paramFont);
  }
  ...
  {
    return new TitledBorder(paramBorder, paramString, paramInt1, paramInt2, paramFont, paramColor);
  }
  ...
  {
    return new EmptyBorder(paramInt1, paramInt2, paramInt3, paramInt4);
  }
  ...
  {
    int i = (!paramBoolean) && (paramPaint == null) && (paramFloat1 == 1.0F) && (paramFloat2 == 1.0F) && (paramFloat3 == 1.0F) ? 1 : 0;
    if ((i != 0) && (sharedDashedBorder != null)) {
    ...
    int j = paramBoolean ? 1 : 2;
    int k = paramBoolean ? 1 : 0;
    float[] arrayOfFloat = { paramFloat1 * (paramFloat2 - 1.0F), paramFloat1 * (paramFloat3 + 1.0F) };
    Border localBorder = createStrokeBorder(new BasicStroke(paramFloat1, j, k, paramFloat1 * 2.0F, arrayOfFloat, 0.0F), paramPaint);
    if (i != 0) {
      sharedDashedBorder = localBorder;
    }
    return localBorder;
  }
}
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\swing\BorderFactory.class
