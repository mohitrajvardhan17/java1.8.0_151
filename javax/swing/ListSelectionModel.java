...
public abstract interface ListSelectionModel
{
  ...
  public abstract void insertIndexInterval(int paramInt1, int paramInt2, boolean paramBoolean);
  ...
  public abstract void addListSelectionListener(ListSelectionListener paramListSelectionListener);
  
  public abstract void removeListSelectionListener(ListSelectionListener paramListSelectionListener);
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\swing\ListSelectionModel.class
