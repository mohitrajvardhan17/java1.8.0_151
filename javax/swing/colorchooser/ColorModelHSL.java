  ...
  extends ColorModel
{
  ...
  {
    return paramInt == 2 ? 0.5F : paramInt == 0 ? -1.0F : 1.0F;
  }
  ...
  private static float normalize(float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    if (paramFloat3 < 4.0F) {
      return paramFloat2 + (paramFloat1 - paramFloat2) * (4.0F - paramFloat3);
    }
    return paramFloat2;
  }
}
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\swing\colorchooser\ColorModelHSL.class
