  ...
  extends ColorModel
{
  ...
  {
    return paramInt == 0 ? 360 : 100;
  }
  
  float getDefault(int paramInt)
  {
    return paramInt == 0 ? -1.0F : 1.0F;
  }
  ...
  private static float[] HSVtoRGB(float[] paramArrayOfFloat1, float[] paramArrayOfFloat2)
  {
    ...
    if (f2 > 0.0F)
    {
      ...
      {
      case 0: 
        paramArrayOfFloat2[1] *= (1.0F - f2 * (1.0F - f4));
        paramArrayOfFloat2[2] *= (1.0F - f2);
        break;
      case 1: 
        paramArrayOfFloat2[0] *= (1.0F - f2 * f4);
        paramArrayOfFloat2[2] *= (1.0F - f2);
        break;
      case 2: 
        paramArrayOfFloat2[0] *= (1.0F - f2);
        paramArrayOfFloat2[2] *= (1.0F - f2 * (1.0F - f4));
        break;
      case 3: 
        paramArrayOfFloat2[0] *= (1.0F - f2);
        paramArrayOfFloat2[1] *= (1.0F - f2 * f4);
        break;
      case 4: 
        paramArrayOfFloat2[0] *= (1.0F - f2 * (1.0F - f4));
        paramArrayOfFloat2[1] *= (1.0F - f2);
        break;
      case 5: 
        paramArrayOfFloat2[1] *= (1.0F - f2);
        paramArrayOfFloat2[2] *= (1.0F - f2 * f4);
      }
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\swing\colorchooser\ColorModelHSV.class
