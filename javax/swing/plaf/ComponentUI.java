...
public abstract class ComponentUI
{
  ...
  {
    return paramJComponent.inside(paramInt1, paramInt2);
  }
  ...
  {
    return SwingUtilities.getAccessibleChildrenCount(paramJComponent);
  }
  
  public Accessible getAccessibleChild(JComponent paramJComponent, int paramInt)
  {
    return SwingUtilities.getAccessibleChild(paramJComponent, paramInt);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\swing\plaf\ComponentUI.class
