  ...
  extends ComboBoxUI
{
  ...
  {
    boolean bool = ((ComboBoxUI)uis.elementAt(0)).isFocusTraversable(paramJComboBox);
    for (int i = 1; i < uis.size(); i++) {
      ((ComboBoxUI)uis.elementAt(i)).isFocusTraversable(paramJComboBox);
    }
    return bool;
  }
  ...
  public void setPopupVisible(JComboBox paramJComboBox, boolean paramBoolean)
  {
    for (int i = 0; i < uis.size(); i++) {
      ((ComboBoxUI)uis.elementAt(i)).setPopupVisible(paramJComboBox, paramBoolean);
    }
  }
  
  public boolean isPopupVisible(JComboBox paramJComboBox)
  {
    boolean bool = ((ComboBoxUI)uis.elementAt(0)).isPopupVisible(paramJComboBox);
    for (int i = 1; i < uis.size(); i++) {
      ((ComboBoxUI)uis.elementAt(i)).isPopupVisible(paramJComboBox);
    }
    return bool;
  }
  ...
  public static ComponentUI createUI(JComponent paramJComponent)
  {
    ...
    return MultiLookAndFeel.createUIs(localMultiComboBoxUI, uis, paramJComponent);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\swing\plaf\multi\MultiComboBoxUI.class
