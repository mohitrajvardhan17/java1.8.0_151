...
final class NimbusDefaults
{
  ...
  void initializeDefaults(UIDefaults paramUIDefaults)
  {
    ...
    paramUIDefaults.put("defaultFont", new FontUIResource(defaultFont));
  ...
  void register(Region paramRegion, String paramString)
  {
    ...
    Object localObject = (List)m.get(paramRegion);
    if (localObject == null)
    {
      localObject = new LinkedList();
      ((List)localObject).add(new LazyStyle(paramString, null));
      m.put(paramRegion, localObject);
    }
    else
    {
      ...
      {
        LazyStyle localLazyStyle = (LazyStyle)localIterator.next();
    ...
    registeredRegions.put(paramRegion.getName(), paramRegion);
  }
  ...
  SynthStyle getStyle(JComponent paramJComponent, Region paramRegion)
  {
    ...
    List localList = (List)m.get(paramRegion);
    ...
    {
      LazyStyle localLazyStyle = (LazyStyle)localIterator.next();
      if ((localLazyStyle.matches(paramJComponent)) && ((localObject == null) || (parts.length < parts.length) || ((parts.length == parts.length) && (simple) && (!simple)))) {
        localObject = localLazyStyle;
      }
    }
    return localObject == null ? defaultStyle : ((LazyStyle)localObject).getStyle(paramJComponent, paramRegion);
  }
  
  public void clearOverridesCache(JComponent paramJComponent)
  {
    overridesCache.remove(paramJComponent);
  }
  ...
  {
    ColorUIResource localColorUIResource = new ColorUIResource(new Color(paramInt1, paramInt2, paramInt3, paramInt4));
    colorTree.addColor(paramString, localColorUIResource);
    paramUIDefaults.put(paramString, localColorUIResource);
  }
  ...
  {
    addColor(paramUIDefaults, paramString1, paramString2, paramFloat1, paramFloat2, paramFloat3, paramInt, true);
  }
  ...
  {
    DerivedColor localDerivedColor = getDerivedColor(paramString1, paramString2, paramFloat1, paramFloat2, paramFloat3, paramInt, paramBoolean);
    paramUIDefaults.put(paramString1, localDerivedColor);
  }
  ...
  {
    return getDerivedColor(null, paramString, paramFloat1, paramFloat2, paramFloat3, paramInt, paramBoolean);
  }
  ...
  private DerivedColor getDerivedColor(String paramString1, String paramString2, float paramFloat1, float paramFloat2, float paramFloat3, int paramInt, boolean paramBoolean)
  {
    Object localObject;
    if (paramBoolean) {
      localObject = new DerivedColor.UIResource(paramString2, paramFloat1, paramFloat2, paramFloat3, paramInt);
    } else {
      localObject = new DerivedColor(paramString2, paramFloat1, paramFloat2, paramFloat3, paramInt);
    }
    if (derivedColors.containsKey(localObject)) {
      return (DerivedColor)derivedColors.get(localObject);
    }
    derivedColors.put(localObject, localObject);
    ((DerivedColor)localObject).rederiveColor();
    colorTree.addColor(paramString1, (Color)localObject);
    return (DerivedColor)localObject;
  }
    ...
    implements PropertyChangeListener
  {
    ...
    {
      return nodes.get(paramString)).color;
    }
    
    public void addColor(String paramString, Color paramColor)
    {
      Node localNode1 = getParentNode(paramColor);
      Node localNode2 = new Node(paramColor, localNode1);
      children.add(localNode2);
      if (paramString != null) {
        nodes.put(paramString, localNode2);
      }
    }
    ...
    private Node getParentNode(Color paramColor)
    {
      ...
      if ((paramColor instanceof DerivedColor))
      {
        String str = ((DerivedColor)paramColor).getUiDefaultParentName();
        Node localNode = (Node)nodes.get(str);
        if (localNode != null) {
    ...
    public void propertyChange(PropertyChangeEvent paramPropertyChangeEvent)
    {
      ...
      Node localNode1 = (Node)nodes.get(str);
      if (localNode1 != null)
      {
        parent.children.remove(localNode1);
        Color localColor = (Color)paramPropertyChangeEvent.getNewValue();
        Node localNode2 = getParentNode(localColor);
        localNode1.set(localColor, localNode2);
        children.add(localNode1);
        localNode1.update();
      }
    }
    ...
    class Node
    {
      ...
      Node(Color paramColor, Node paramNode)
      {
        set(paramColor, paramNode);
      }
    ...
    implements UIDefaults.ActiveValue
  {
    ...
    public DerivedFont(String paramString, float paramFloat, Boolean paramBoolean1, Boolean paramBoolean2)
    {
      ...
      parentKey = paramString;
      sizeOffset = paramFloat;
      bold = paramBoolean1;
    ...
    {
      Font localFont = paramUIDefaults.getFont(parentKey);
      if (localFont != null)
      {
        float f = Math.round(localFont.getSize2D() * sizeOffset);
        ...
        return localFont.deriveFont(i, f);
      }
      return null;
    }
  }
    ...
    implements UIDefaults.LazyValue
  {
    ...
    LazyPainter(String paramString, int paramInt, Insets paramInsets, Dimension paramDimension, boolean paramBoolean)
    {
      ...
      which = paramInt;
      ctx = new AbstractRegionPainter.PaintContext(paramInsets, paramDimension, paramBoolean);
    }
    ...
    LazyPainter(String paramString, int paramInt, Insets paramInsets, Dimension paramDimension, boolean paramBoolean, AbstractRegionPainter.PaintContext.CacheMode paramCacheMode, double paramDouble1, double paramDouble2)
    {
      ...
      className = paramString;
      which = paramInt;
      ctx = new AbstractRegionPainter.PaintContext(paramInsets, paramDimension, paramBoolean, paramCacheMode, paramDouble1, paramDouble2);
    }
    ...
    public Object createValue(UIDefaults paramUIDefaults)
    {
      ...
      {
        Object localObject;
        if ((paramUIDefaults == null) || (!((localObject = paramUIDefaults.get("ClassLoader")) instanceof ClassLoader)))
        {
        ...
        Class localClass = Class.forName(className, true, (ClassLoader)localObject);
        Constructor localConstructor = localClass.getConstructor(new Class[] { AbstractRegionPainter.PaintContext.class, Integer.TYPE });
        if (localConstructor == null) {
          throw new NullPointerException("Failed to find the constructor for the class: " + className);
        }
        return localConstructor.newInstance(new Object[] { ctx, Integer.valueOf(which) });
      }
  ...
  private final class LazyStyle
  {
    ...
    private LazyStyle(String paramString)
    {
      if (paramString == null) {
      ...
      List localList = split(str);
      parts = new Part[localList.size()];
      for (int i = 0; i < parts.length; i++)
      {
        parts[i] = new Part((String)localList.get(i));
        if (parts[i].named) {
          simple = false;
        }
      }
    ...
    SynthStyle getStyle(JComponent paramJComponent, Region paramRegion)
    {
      if (paramJComponent.getClientProperty("Nimbus.Overrides") != null)
      {
        Object localObject1 = (Map)overridesCache.get(paramJComponent);
        Object localObject2 = null;
        if (localObject1 == null)
        {
          localObject1 = new HashMap();
          overridesCache.put(paramJComponent, localObject1);
        }
        else
        {
          localObject2 = (SynthStyle)((Map)localObject1).get(paramRegion);
        }
        if (localObject2 == null)
        {
          localObject2 = new NimbusStyle(prefix, paramJComponent);
          ((Map)localObject1).put(paramRegion, localObject2);
        }
        return (SynthStyle)localObject2;
      }
      if (style == null) {
    ...
    {
      return matches(paramJComponent, parts.length - 1);
    }
    ...
    private boolean matches(Component paramComponent, int paramInt)
    {
      ...
      if ((parts[paramInt].named) && (parts[paramInt].s.equals(str))) {
        return matches(paramComponent.getParent(), paramInt - 1);
      }
      if (!parts[paramInt].named)
      {
        Class localClass = parts[paramInt].c;
        if ((localClass != null) && (localClass.isAssignableFrom(paramComponent.getClass()))) {
          return matches(paramComponent.getParent(), paramInt - 1);
        }
        if ((localClass == null) && (registeredRegions.containsKey(parts[paramInt].s)))
        {
          Region localRegion = (Region)registeredRegions.get(parts[paramInt].s);
          Object localObject = localRegion.isSubregion() ? paramComponent : paramComponent.getParent();
          if ((localRegion == Region.INTERNAL_FRAME_TITLE_PANE) && (localObject != null) && ((localObject instanceof JInternalFrame.JDesktopIcon)))
          {
            JInternalFrame.JDesktopIcon localJDesktopIcon = (JInternalFrame.JDesktopIcon)localObject;
            localObject = localJDesktopIcon.getInternalFrame();
          }
          return matches((Component)localObject, paramInt - 1);
        }
      }
      return false;
    }
    ...
    private List<String> split(String paramString)
    {
      ...
      for (int m = 0; m < paramString.length(); m++)
      {
        ...
        else if (n == 93)
        {
          i--;
          if (i < 0) {
            throw new RuntimeException("Malformed prefix: " + paramString);
          }
        }
        else if ((n == 58) && (j == 0) && (i == 0))
        {
          localArrayList.add(paramString.substring(k, m));
          k = m + 1;
        }
      }
      if ((k < paramString.length() - 1) && (j == 0) && (i == 0)) {
    ...
    private final class Part
    {
      ...
      Part(String paramString)
      {
        named = ((paramString.charAt(0) == '"') && (paramString.charAt(paramString.length() - 1) == '"'));
        if (named)
        {
          s = paramString.substring(1, paramString.length() - 1);
        }
        else
        {
          s = paramString;
          try
          {
            c = Class.forName("javax.swing.J" + paramString);
          }
          catch (Exception localException1) {}
          try
          {
            c = Class.forName(paramString.replace("_", "."));
          }
    ...
    implements Border, UIResource
  {
    ...
    public void paintBorder(Component paramComponent, Graphics paramGraphics, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
    {
      ...
      {
        painter.paint((Graphics2D)paramGraphics, paramComponent, paramInt3, paramInt4);
      }
      else
      {
        BufferedImage localBufferedImage = new BufferedImage(paramInt3, paramInt4, 2);
        Graphics2D localGraphics2D = localBufferedImage.createGraphics();
        painter.paint(localGraphics2D, paramComponent, paramInt3, paramInt4);
        localGraphics2D.dispose();
        paramGraphics.drawImage(localBufferedImage, paramInt1, paramInt2, null);
