  ...
  extends AbstractRegionPainter
{
  ...
  private Paint decodeGradient4(Shape paramShape)
  {
    ...
    float f3 = (float)localRectangle2D.getWidth();
    float f4 = (float)localRectangle2D.getHeight();
    return decodeGradient(0.5F * f3 + f1, 0.0F * f4 + f2, 0.5F * f3 + f1, 1.0F * f4 + f2, new float[] { 0.0F, 0.1684492F, 1.0F }, new Color[] { color10, decodeColor(color10, color11, 0.5F), color11 });
  }
  ...
  private Paint decodeGradient5(Shape paramShape)
  {
    ...
    float f3 = (float)localRectangle2D.getWidth();
    float f4 = (float)localRectangle2D.getHeight();
    return decodeGradient(0.5F * f3 + f1, 0.0F * f4 + f2, 0.5F * f3 + f1, 1.0F * f4 + f2, new float[] { 0.0F, 0.49573863F, 0.99147725F }, new Color[] { color8, decodeColor(color8, color15, 0.5F), color15 });
  }
}
