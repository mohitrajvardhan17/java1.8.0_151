...
public class HTML
{
  ...
  {
    Tag localTag = (Tag)tagHashtable.get(paramString);
    return localTag == null ? null : localTag;
  }
  
  static Tag getTagForStyleConstantsKey(StyleConstants paramStyleConstants)
  {
    return (Tag)scMapping.get(paramStyleConstants);
  }
  ...
  {
    Attribute localAttribute = (Attribute)attHashtable.get(paramString);
  ...
  public static class Tag
  {
    ...
    {
      name = paramString;
      breakTag = paramBoolean1;
      blockTag = paramBoolean2;
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((paramObject instanceof UnknownTag)) {
      ...
      throws IOException
    {
      ...
      paramObjectOutputStream.writeBoolean(blockTag);
      paramObjectOutputStream.writeBoolean(breakTag);
      paramObjectOutputStream.writeBoolean(unknown);
      ...
      throws ClassNotFoundException, IOException
    {
      ...
      blockTag = paramObjectInputStream.readBoolean();
      breakTag = paramObjectInputStream.readBoolean();
      unknown = paramObjectInputStream.readBoolean();
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\swing\text\html\HTML.class
