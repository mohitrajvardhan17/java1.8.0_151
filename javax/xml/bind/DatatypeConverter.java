  ...
  public static void setDatatypeConverter(DatatypeConverterInterface paramDatatypeConverterInterface)
  {
    ...
    if (theConverter == null)
    {
      ...
      if (localSecurityManager != null) {
        localSecurityManager.checkPermission(SET_DATATYPE_CONVERTER_PERMISSION);
      }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\xml\bind\DatatypeConverter.class
