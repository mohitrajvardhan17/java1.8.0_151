  ...
  implements Marshaller
{
  ...
  public final void marshal(Object paramObject, OutputStream paramOutputStream)
  ...
  public void marshal(Object paramObject, File paramFile)
    throws JAXBException
  {
    ...
    try
    {
      ...
      try
      {
        marshal(paramObject, new StreamResult(localBufferedOutputStream));
      }
      finally
      {
  ...
  public final void marshal(Object paramObject, Writer paramWriter)
    throws JAXBException
  {
  ...
  public final void marshal(Object paramObject, ContentHandler paramContentHandler)
    throws JAXBException
  {
  ...
  public final void marshal(Object paramObject, Node paramNode)
    throws JAXBException
  {
  ...
  protected void setEncoding(String paramString)
  {
  ...
  protected void setSchemaLocation(String paramString)
  {
  ...
  protected void setNoNSSchemaLocation(String paramString)
  {
    noNSSchemaLocation = paramString;
  }
  ...
  protected void setFormattedOutput(boolean paramBoolean)
  {
    formattedOutput = paramBoolean;
  }
  ...
  protected void setFragment(boolean paramBoolean)
  {
    fragment = paramBoolean;
  }
  
  protected String getJavaEncoding(String paramString)
    throws UnsupportedEncodingException
  {
    ...
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      for (int i = 0; i < aliases.length; i += 2) {
        if (paramString.equals(aliases[i]))
        {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\xml\bind\helpers\AbstractMarshallerImpl.class
