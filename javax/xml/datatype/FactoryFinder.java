...
class FactoryFinder
{
    ...
    throws DatatypeConfigurationException
  {
    ...
    {
      throw new DatatypeConfigurationException("Provider " + paramString + " not found", localClassNotFoundException);
    }
    catch (Exception localException)
    {
      throw new DatatypeConfigurationException("Provider " + paramString + " could not be instantiated: " + localException, localException);
    }
  }
    ...
    throws DatatypeConfigurationException
  {
    ...
    if (paramString == null) {
      throw new DatatypeConfigurationException("Provider for " + str1 + " cannot be found");
    }
    ...
    throws DatatypeConfigurationException
  {
    ...
    {
      DatatypeConfigurationException localDatatypeConfigurationException = new DatatypeConfigurationException("Provider for " + paramClass + " cannot be found", localServiceConfigurationError);
      throw localDatatypeConfigurationException;
    }
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\xml\datatype\FactoryFinder.class
