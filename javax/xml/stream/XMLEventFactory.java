...
public abstract class XMLEventFactory
{
  ...
  {
    return (XMLEventFactory)FactoryFinder.find(XMLEventFactory.class, "com.sun.xml.internal.stream.events.XMLEventFactoryImpl");
  }
   ...
   * @deprecated
   */
  public static XMLEventFactory newInstance(String paramString, ClassLoader paramClassLoader)
    throws FactoryConfigurationError
  {
    return (XMLEventFactory)FactoryFinder.find(XMLEventFactory.class, paramString, paramClassLoader, null);
  }
  
  public static XMLEventFactory newFactory(String paramString, ClassLoader paramClassLoader)
    throws FactoryConfigurationError
  {
    return (XMLEventFactory)FactoryFinder.find(XMLEventFactory.class, paramString, paramClassLoader, null);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\xml\stream\XMLEventFactory.class
