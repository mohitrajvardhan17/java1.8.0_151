    ...
    throws TransformerFactoryConfigurationError
  {
    ...
    try
    {
      ...
      if (str2 != null)
      {
        ...
        return (T)newInstance(paramClass, str2, null, true, true);
      }
    }
    ...
    try
    {
      ...
      if (??? != null)
      {
        ...
        return (T)newInstance(paramClass, (String)???, null, true, true);
      }
    }
    catch (Exception localException)
    {
    ...
    return (T)newInstance(paramClass, paramString, null, true, true);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\javax\xml\transform\FactoryFinder.class
