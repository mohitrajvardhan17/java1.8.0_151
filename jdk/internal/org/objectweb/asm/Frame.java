...
final class Frame
{
  ...
  private int init(ClassWriter paramClassWriter, int paramInt)
  {
    ...
    for (int j = 0; j < initializationCount; j++)
    {
      ...
      int n = k & 0xF000000;
      if (n == 33554432) {
        k = m + inputLocals[(k & 0x7FFFFF)];
      } else if (n == 50331648) {
        k = m + inputStack[(inputStack.length - (k & 0x7FFFFF))];
      }
      if (paramInt == k) {
        return i;
      }
  ...
  void execute(int paramInt1, int paramInt2, ClassWriter paramClassWriter, Item paramItem)
  {
    ...
    case 58: 
      ...
      if (paramInt2 > 0)
      {
        ...
        } else if ((j & 0xF000000) != 16777216) {
          set(paramInt2 - 1, j | 0x800000);
        }
      }
      break;
    case 55: 
    ...
    for (int i = 0; i < i1; i++)
    {
      if ((outputLocals != null) && (i < outputLocals.length))
      {
        ...
        else
        {
          ...
          {
            if (m == 33554432) {
              n = k + inputLocals[(j & 0x7FFFFF)];
            } else {
              n = k + inputStack[(i2 - (j & 0x7FFFFF))];
            }
            if (((j & 0x800000) != 0) && ((n == 16777220) || (n == 16777219))) {
              n = 16777216;
            }
          }
        }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\jdk\internal\org\objectweb\asm\Frame.class
