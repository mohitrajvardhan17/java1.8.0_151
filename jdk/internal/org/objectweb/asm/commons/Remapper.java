...
public abstract class Remapper
{
  ...
  public String mapMethodDesc(String paramString)
  {
    ...
    for (int i = 0; i < arrayOfType.length; i++) {
      localStringBuilder.append(mapDesc(arrayOfType[i].getDescriptor()));
    }
    ...
    localStringBuilder.append(')').append(mapDesc(localType.getDescriptor()));
    return localStringBuilder.toString();
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\jdk\internal\org\objectweb\asm\commons\Remapper.class
