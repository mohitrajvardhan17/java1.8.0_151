  ...
  implements Opcodes
{
  ...
  public BasicValue newOperation(AbstractInsnNode paramAbstractInsnNode)
    throws AnalyzerException
  {
    ...
    case 18: 
      ...
      {
        int i = ((Type)localObject).getSort();
        if ((i == 10) || (i == 9)) {
        ...
        throw new IllegalArgumentException("Illegal LDC constant " + localObject);
      }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\jdk\internal\org\objectweb\asm\tree\analysis\BasicInterpreter.class
