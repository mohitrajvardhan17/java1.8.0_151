  ...
  extends BasicInterpreter
{
    ...
    throws AnalyzerException
  {
    ...
    case 175: 
      ...
      break;
    case 180: 
      localBasicValue = newValue(Type.getObjectType(owner));
      break;
    case 192: 
      if (!paramBasicValue.isReference()) {
        throw new AnalyzerException(paramAbstractInsnNode, null, "an object reference", paramBasicValue);
    ...
    case 199: 
      ...
      return super.unaryOperation(paramAbstractInsnNode, paramBasicValue);
    case 179: 
      localBasicValue = newValue(Type.getType(desc));
      break;
    case 120: 
    case 121: 
    case 122: 
    ...
    throws AnalyzerException
  {
    ...
    case 181: 
      ...
      localBasicValue1 = newValue(Type.getObjectType(owner));
      localBasicValue2 = newValue(Type.getType(desc));
      break;
    case 54: 
    case 55: 
    case 56: 
  ...
  public BasicValue naryOperation(AbstractInsnNode paramAbstractInsnNode, List<? extends BasicValue> paramList)
    throws AnalyzerException
  {
    ...
    else
    {
      ...
      if ((i != 184) && (i != 186))
      {
        localObject = Type.getObjectType(owner);
      ...
      Object localObject = i == 186 ? desc : desc;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\jdk\internal\org\objectweb\asm\tree\analysis\BasicVerifier.class
