...
public final class ResourceNatives
{
  ...
  private static int enabledFeatures = featuresEnabled0();
  ...
  {
    return (featuresEnabled() & 0x1) == 1;
  }
  
  public static boolean isHeapRetainedEnabled()
  {
    return (featuresEnabled() & 0x2) == 2;
  }
  ...
  {
    getThreadStats0(paramArrayOfLong1, paramArrayOfLong2, paramArrayOfLong3);
  }
  ...
  {
    return getContextsRetainedMemory0(paramArrayOfInt, paramArrayOfLong, paramArrayOfByte);
  }
  
  public static void setRetainedMemoryNotificationEnabled(Object paramObject)
  {
    setRetainedMemoryNotificationEnabled0(paramObject);
  }
  
  public static void computeRetainedMemory(int[] paramArrayOfInt, int paramInt)
  {
    computeRetainedMemory0(paramArrayOfInt, (byte)paramInt);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\jdk\management\resource\internal\ResourceNatives.class
