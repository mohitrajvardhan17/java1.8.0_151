  ...
  extends XMLSignatureFactory
{
  ...
  private XMLSignature unmarshal(Node paramNode, XMLCryptoContext paramXMLCryptoContext)
    throws MarshalException
  {
    paramNode.normalize();
    ...
    if (str.equals("Signature")) {
      return new DOMXMLSignature(localElement, paramXMLCryptoContext, getProvider());
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\org\jcp\xml\dsig\internal\dom\DOMXMLSignatureFactory.class
