  ...
  implements IDLEntity
{
  ...
  public abstract void read_value(InputStream paramInputStream, TypeCode paramTypeCode)
    throws MARSHAL;
  ...
  public abstract void insert_Value(Serializable paramSerializable, TypeCode paramTypeCode)
    throws MARSHAL;
  
  public abstract void insert_Object(Object paramObject, TypeCode paramTypeCode)
    throws BAD_PARAM;
  ...
  public abstract void insert_string(String paramString)
    throws DATA_CONVERSION, MARSHAL;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\org\omg\CORBA\Any.class
