...
public abstract class AddressHelper
{
  ...
  public static synchronized TypeCode type()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = ORB.init().create_alias_tc(id(), "Address", __typeCode);
    }
    return __typeCode;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\org\omg\CosNaming\NamingContextExtPackage\AddressHelper.class
