...
public abstract class InvalidValueHelper
{
  ...
  public static void insert(Any paramAny, InvalidValue paramInvalidValue)
  {
    ...
    paramAny.type(type());
    write(localOutputStream, paramInvalidValue);
    paramAny.read_value(localOutputStream.create_input_stream(), type());
  }
  
  public static InvalidValue extract(Any paramAny)
  {
  ...
  {
    InvalidValue localInvalidValue = new InvalidValue();
    paramInputStream.read_string();
    return localInvalidValue;
  }
  
  public static void write(OutputStream paramOutputStream, InvalidValue paramInvalidValue)
  {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\org\omg\DynamicAny\DynAnyPackage\InvalidValueHelper.class
