...
public abstract class ForwardRequestHelper
{
    ...
    if (__typeCode == null) {
      synchronized (TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          arrayOfStructMember[0] = new StructMember("forward_reference", localTypeCode, null);
  ...
  public static ForwardRequest read(InputStream paramInputStream)
  {
    ...
    forward_reference = ObjectHelper.read(paramInputStream);
  ...
  public static void write(OutputStream paramOutputStream, ForwardRequest paramForwardRequest)
  {
    ...
    ObjectHelper.write(paramOutputStream, forward_reference);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\org\omg\PortableServer\ForwardRequestHelper.class
