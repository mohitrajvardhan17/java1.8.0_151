...
public abstract class WrongAdapterHelper
{
  ...
  public static void insert(Any paramAny, WrongAdapter paramWrongAdapter)
  {
    ...
    paramAny.type(type());
    write(localOutputStream, paramWrongAdapter);
  ...
  {
    WrongAdapter localWrongAdapter = new WrongAdapter();
    paramInputStream.read_string();
    return localWrongAdapter;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\org\omg\PortableServer\POAPackage\WrongAdapterHelper.class
