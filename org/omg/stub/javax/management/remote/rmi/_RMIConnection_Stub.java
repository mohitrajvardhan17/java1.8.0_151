  ...
  implements RMIConnection
{
    ...
    throws InstanceNotFoundException, IOException
  {
    ...
    try
    {
      ...
      ((RMIConnection)servant).addNotificationListener((ObjectName)localObject5, localObjectName, localMarshalledObject1, localMarshalledObject2, localSubject);
    }
    ...
    throws InstanceNotFoundException, IOException
  {
    ...
    try
    {
      ...
      Integer[] arrayOfInteger2 = ((RMIConnection)servant).addNotificationListeners((ObjectName[])localObject5, arrayOfMarshalledObject, arrayOfSubject);
    ...
    throws ReflectionException, InstanceAlreadyExistsException, MBeanRegistrationException, MBeanException, NotCompliantMBeanException, IOException
  {
    ...
    try
    {
      ...
      Subject localSubject = (Subject)arrayOfObject[4];
      ObjectInstance localObjectInstance2 = ((RMIConnection)servant).createMBean((String)localObject5, localObjectName, localMarshalledObject, arrayOfString, localSubject);
    ...
    throws ReflectionException, InstanceAlreadyExistsException, MBeanRegistrationException, MBeanException, NotCompliantMBeanException, InstanceNotFoundException, IOException
  {
    ...
    try
    {
      ...
      ObjectInstance localObjectInstance2 = ((RMIConnection)servant).createMBean((String)localObject5, localObjectName1, localObjectName2, localMarshalledObject, arrayOfString, localSubject);
      localObjectInstance1 = (ObjectInstance)Util.copyObject(localObjectInstance2, _orb());
      return localObjectInstance1;
    }
    catch (Throwable localThrowable)
    ...
    throws ReflectionException, InstanceAlreadyExistsException, MBeanRegistrationException, MBeanException, NotCompliantMBeanException, InstanceNotFoundException, IOException
  {
    ...
    try
    {
      ...
      ObjectInstance localObjectInstance2 = ((RMIConnection)servant).createMBean((String)localObject5, localObjectName1, localObjectName2, localSubject);
      localObjectInstance1 = (ObjectInstance)Util.copyObject(localObjectInstance2, _orb());
      return localObjectInstance1;
    }
    catch (Throwable localThrowable)
    ...
    throws ReflectionException, InstanceAlreadyExistsException, MBeanRegistrationException, MBeanException, NotCompliantMBeanException, IOException
  {
    ...
    try
    {
      ...
      ObjectInstance localObjectInstance2 = ((RMIConnection)servant).createMBean((String)localObject5, localObjectName, localSubject);
      localObjectInstance1 = (ObjectInstance)Util.copyObject(localObjectInstance2, _orb());
      return localObjectInstance1;
    }
    catch (Throwable localThrowable)
    ...
    throws IOException
  {
    ...
    try
    {
      NotificationResult localNotificationResult2 = ((RMIConnection)servant).fetchNotifications(paramLong1, paramInt, paramLong2);
    ...
    throws MBeanException, AttributeNotFoundException, InstanceNotFoundException, ReflectionException, IOException
  {
    ...
    try
    {
      ...
      Subject localSubject = (Subject)arrayOfObject[2];
      Object localObject7 = ((RMIConnection)servant).getAttribute((ObjectName)localObject6, str, localSubject);
    ...
    throws InstanceNotFoundException, ReflectionException, IOException
  {
    ...
    try
    {
      ...
      Subject localSubject = (Subject)arrayOfObject[2];
      AttributeList localAttributeList2 = ((RMIConnection)servant).getAttributes((ObjectName)localObject5, arrayOfString, localSubject);
    ...
    throws IOException
  {
    ...
    try
    {
      str = ((RMIConnection)servant).getConnectionId();
      return str;
    }
    catch (Throwable localThrowable)
    {
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      str = ((RMIConnection)servant).getDefaultDomain(localSubject);
      return str;
    }
    catch (Throwable localThrowable)
    {
    ...
    throws IOException
  {
    ...
    {
      Subject localSubject = (Subject)Util.copyObject(paramSubject, _orb());
      localObject5 = ((RMIConnection)servant).getDomains(localSubject);
    ...
    throws IOException
  {
    ...
    {
      Subject localSubject = (Subject)Util.copyObject(paramSubject, _orb());
      localObject5 = ((RMIConnection)servant).getMBeanCount(localSubject);
    ...
    throws InstanceNotFoundException, IntrospectionException, ReflectionException, IOException
  {
    ...
    try
    {
      ...
      MBeanInfo localMBeanInfo2 = ((RMIConnection)servant).getMBeanInfo((ObjectName)localObject5, localSubject);
    ...
    throws InstanceNotFoundException, IOException
  {
    ...
    try
    {
      ...
      localObject5 = (ObjectName)arrayOfObject[0];
      Subject localSubject = (Subject)arrayOfObject[1];
      ObjectInstance localObjectInstance2 = ((RMIConnection)servant).getObjectInstance((ObjectName)localObject5, localSubject);
      localObjectInstance1 = (ObjectInstance)Util.copyObject(localObjectInstance2, _orb());
      return localObjectInstance1;
    }
    catch (Throwable localThrowable)
    ...
    throws InstanceNotFoundException, MBeanException, ReflectionException, IOException
  {
    ...
    try
    {
      ...
      String[] arrayOfString = (String[])arrayOfObject[3];
      Subject localSubject = (Subject)arrayOfObject[4];
      Object localObject7 = ((RMIConnection)servant).invoke((ObjectName)localObject6, str, localMarshalledObject, arrayOfString, localSubject);
      localObject1 = Util.copyObject(localObject7, _orb());
      return localObject1;
    }
    catch (Throwable localThrowable)
    ...
    throws InstanceNotFoundException, IOException
  {
    ...
    try
    {
      ...
      String str = (String)arrayOfObject[1];
      Subject localSubject = (Subject)arrayOfObject[2];
      bool = ((RMIConnection)servant).isInstanceOf((ObjectName)localObject5, str, localSubject);
      return bool;
    }
    catch (Throwable localThrowable)
    {
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      localObject5 = (ObjectName)arrayOfObject[0];
      Subject localSubject = (Subject)arrayOfObject[1];
      bool = ((RMIConnection)servant).isRegistered((ObjectName)localObject5, localSubject);
      return bool;
    }
    catch (Throwable localThrowable)
    {
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      Subject localSubject = (Subject)arrayOfObject[2];
      Set localSet2 = ((RMIConnection)servant).queryMBeans((ObjectName)localObject5, localMarshalledObject, localSubject);
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      MarshalledObject localMarshalledObject = (MarshalledObject)arrayOfObject[1];
      Subject localSubject = (Subject)arrayOfObject[2];
      Set localSet2 = ((RMIConnection)servant).queryNames((ObjectName)localObject5, localMarshalledObject, localSubject);
      localSet1 = (Set)Util.copyObject(localSet2, _orb());
      return localSet1;
    }
    catch (Throwable localThrowable)
    ...
    throws InstanceNotFoundException, ListenerNotFoundException, IOException
  {
    ...
    try
    {
      ...
      MarshalledObject localMarshalledObject2 = (MarshalledObject)arrayOfObject[3];
      Subject localSubject = (Subject)arrayOfObject[4];
      ((RMIConnection)servant).removeNotificationListener((ObjectName)localObject5, localObjectName, localMarshalledObject1, localMarshalledObject2, localSubject);
    }
    catch (Throwable localThrowable)
    {
      localObject5 = (Throwable)Util.copyObject(localThrowable, _orb());
    ...
    throws InstanceNotFoundException, ListenerNotFoundException, IOException
  {
    ...
    try
    {
      ...
      ObjectName localObjectName = (ObjectName)arrayOfObject[1];
      Subject localSubject = (Subject)arrayOfObject[2];
      ((RMIConnection)servant).removeNotificationListener((ObjectName)localObject5, localObjectName, localSubject);
    }
    catch (Throwable localThrowable)
    {
      localObject5 = (Throwable)Util.copyObject(localThrowable, _orb());
    ...
    throws InstanceNotFoundException, ListenerNotFoundException, IOException
  {
    ...
    try
    {
      ...
      Subject localSubject = (Subject)arrayOfObject[2];
      ((RMIConnection)servant).removeNotificationListeners((ObjectName)localObject5, arrayOfInteger, localSubject);
    }
    catch (Throwable localThrowable)
    {
      localObject5 = (Throwable)Util.copyObject(localThrowable, _orb());
    ...
    throws InstanceNotFoundException, AttributeNotFoundException, InvalidAttributeValueException, MBeanException, ReflectionException, IOException
  {
    ...
    try
    {
      ...
      MarshalledObject localMarshalledObject = (MarshalledObject)arrayOfObject[1];
      Subject localSubject = (Subject)arrayOfObject[2];
      ((RMIConnection)servant).setAttribute((ObjectName)localObject5, localMarshalledObject, localSubject);
    }
    catch (Throwable localThrowable)
    {
      localObject5 = (Throwable)Util.copyObject(localThrowable, _orb());
    ...
    throws InstanceNotFoundException, ReflectionException, IOException
  {
    ...
    try
    {
      ...
      MarshalledObject localMarshalledObject = (MarshalledObject)arrayOfObject[1];
      Subject localSubject = (Subject)arrayOfObject[2];
      AttributeList localAttributeList2 = ((RMIConnection)servant).setAttributes((ObjectName)localObject5, localMarshalledObject, localSubject);
      localAttributeList1 = (AttributeList)Util.copyObject(localAttributeList2, _orb());
      return localAttributeList1;
    }
    catch (Throwable localThrowable)
    ...
    throws InstanceNotFoundException, MBeanRegistrationException, IOException
  {
    ...
    try
    {
      ...
      localObject5 = (ObjectName)arrayOfObject[0];
      Subject localSubject = (Subject)arrayOfObject[1];
      ((RMIConnection)servant).unregisterMBean((ObjectName)localObject5, localSubject);
    }
    catch (Throwable localThrowable)
    {
      localObject5 = (Throwable)Util.copyObject(localThrowable, _orb());
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\org\omg\stub\javax\management\remote\rmi\_RMIConnection_Stub.class
