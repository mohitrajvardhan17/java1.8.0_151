  ...
  implements ComponentFactory, KeyboardFocusManagerPeerProvider
{
  ...
  public HeadlessToolkit(Toolkit paramToolkit)
  {
    ...
    if ((paramToolkit instanceof ComponentFactory)) {
      componentFactory = ((ComponentFactory)paramToolkit);
    }
  }
  ...
  {
    return tk.getFontMetrics(paramFont);
  }
  ...
  {
    tk.addPropertyChangeListener(paramString, paramPropertyChangeListener);
  }
  
  public void removePropertyChangeListener(String paramString, PropertyChangeListener paramPropertyChangeListener)
  {
    tk.removePropertyChangeListener(paramString, paramPropertyChangeListener);
  }
  ...
  {
    tk.addAWTEventListener(paramAWTEventListener, paramLong);
  }
  
  public void removeAWTEventListener(AWTEventListener paramAWTEventListener)
  {
    tk.removeAWTEventListener(paramAWTEventListener);
  }
  ...
  {
    return tk.getAWTEventListeners(paramLong);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\awt\HeadlessToolkit.class
