  ...
  implements JPEGImageEncoder
{
  ...
  {
    param = new JPEGParam(paramJPEGEncodeParam);
  }
    ...
    throws IOException, ImageFormatException
  {
    ...
    if ((paramBufferedImage.getWidth() != param.getWidth()) || (paramBufferedImage.getHeight() != param.getHeight())) {
      throw new ImageFormatException("Param block's width/height doesn't match the BufferedImage");
    }
    if (param.getEncodedColorID() != getDefaultColorId(paramBufferedImage.getColorModel())) {
    ...
    throws IOException, ImageFormatException
  {
    ...
    if ((paramRaster.getWidth() != param.getWidth()) || (paramRaster.getHeight() != param.getHeight())) {
      throw new ImageFormatException("Param block's width/height doesn't match the Raster");
    }
    if ((param.getEncodedColorID() != 0) && (param.getNumComponents() != paramRaster.getNumBands())) {
    ...
    throws IOException, ImageFormatException
  {
    ...
    {
      writeJPEGStream(param, paramColorModel, outStream, null, 0, 0);
      return;
    }
    ...
    if ((i2 != 0) && (useGiven(paramRaster)))
    {
      ...
      n = localDataBuffer.getOffset() + ((ComponentSampleModel)localObject2).getOffset(paramRaster.getMinX() - paramRaster.getSampleModelTranslateX(), paramRaster.getMinY() - paramRaster.getSampleModelTranslateY());
    ...
    else if ((i2 != 0) && (canPack(paramRaster)))
    {
      ...
      n = localDataBuffer.getOffset() + ((SinglePixelPackedSampleModel)localObject2).getOffset(paramRaster.getMinX() - paramRaster.getSampleModelTranslateX(), paramRaster.getMinY() - paramRaster.getSampleModelTranslateY());
    ...
    writeJPEGStream(param, paramColorModel, outStream, localObject1, n, m);
  }
  
  private void verify(int paramInt1, int paramInt2, int paramInt3)
    throws ImageFormatException
  {
    int i = param.getWidth();
    int j = param.getHeight();
    int k = pack ? 1 : param.getNumComponents();
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\awt\image\codec\JPEGImageEncoderImpl.class
