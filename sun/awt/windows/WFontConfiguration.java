  ...
  extends FontConfiguration
{
  ...
  {
    super(paramSunFontManager, paramBoolean1, paramBoolean2);
  }
  ...
  {
    return new WDefaultFontCharset(paramString);
  }
  ...
  {
    return getFileNameFromPlatformName(paramString);
  }
  ...
  private String findFontWithCharset(FontDescriptor[] paramArrayOfFontDescriptor, String paramString)
  {
    ...
    for (int i = 0; i < paramArrayOfFontDescriptor.length; i++)
    {
      String str = paramArrayOfFontDescriptor[i].getNativeName();
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\awt\windows\WFontConfiguration.class
