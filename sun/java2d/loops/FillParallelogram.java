  ...
  extends GraphicsPrimitive
{
    ...
    extends FillParallelogram
  {
    ...
    {
      super(paramFillParallelogram.getCompositeType(), paramFillParallelogram.getDestType());
      target = paramFillParallelogram;
    }
    ...
    public void FillParallelogram(SunGraphics2D paramSunGraphics2D, SurfaceData paramSurfaceData, double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6)
    {
      ...
      target.FillParallelogram(paramSunGraphics2D, paramSurfaceData, paramDouble1, paramDouble2, paramDouble3, paramDouble4, paramDouble5, paramDouble6);
    }
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\java2d\loops\FillParallelogram.class
