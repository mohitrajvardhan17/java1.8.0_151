...
public final class SurfaceType
{
  ...
  {
    Integer localInteger = (Integer)surfaceUIDMap.get(paramString);
    if (localInteger == null)
    {
      ...
      surfaceUIDMap.put(paramString, localInteger);
    }
  ...
  {
    return pixelConverter.rgbToPixel(paramInt, paramColorModel);
  }
  
  public int rgbFor(int paramInt, ColorModel paramColorModel)
  {
    return pixelConverter.pixelToRgb(paramInt, paramColorModel);
  }
  ...
  {
    if ((paramObject instanceof SurfaceType)) {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\java2d\loops\SurfaceType.class
