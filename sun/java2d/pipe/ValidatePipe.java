  ...
  implements PixelDrawPipe, PixelFillPipe, ShapeDrawPipe, TextPipe, DrawImagePipe
{
  ...
  public void drawLine(SunGraphics2D paramSunGraphics2D, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    if (validate(paramSunGraphics2D)) {
      drawpipe.drawLine(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      drawpipe.drawRect(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      fillpipe.fillRect(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      drawpipe.drawRoundRect(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      fillpipe.fillRoundRect(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      drawpipe.drawOval(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      fillpipe.fillOval(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      drawpipe.drawArc(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      fillpipe.fillArc(paramSunGraphics2D, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      drawpipe.drawPolyline(paramSunGraphics2D, paramArrayOfInt1, paramArrayOfInt2, paramInt);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      drawpipe.drawPolygon(paramSunGraphics2D, paramArrayOfInt1, paramArrayOfInt2, paramInt);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      fillpipe.fillPolygon(paramSunGraphics2D, paramArrayOfInt1, paramArrayOfInt2, paramInt);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      shapepipe.draw(paramSunGraphics2D, paramShape);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      shapepipe.fill(paramSunGraphics2D, paramShape);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      textpipe.drawString(paramSunGraphics2D, paramString, paramDouble1, paramDouble2);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      textpipe.drawGlyphVector(paramSunGraphics2D, paramGlyphVector, paramFloat1, paramFloat2);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      textpipe.drawChars(paramSunGraphics2D, paramArrayOfChar, paramInt1, paramInt2, paramInt3, paramInt4);
    }
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      return imagepipe.copyImage(paramSunGraphics2D, paramImage, paramInt1, paramInt2, paramColor, paramImageObserver);
    }
    return false;
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      return imagepipe.copyImage(paramSunGraphics2D, paramImage, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramColor, paramImageObserver);
    }
    return false;
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      return imagepipe.scaleImage(paramSunGraphics2D, paramImage, paramInt1, paramInt2, paramInt3, paramInt4, paramColor, paramImageObserver);
    }
    return false;
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      return imagepipe.scaleImage(paramSunGraphics2D, paramImage, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, paramInt6, paramInt7, paramInt8, paramColor, paramImageObserver);
    }
    return false;
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      return imagepipe.transformImage(paramSunGraphics2D, paramImage, paramAffineTransform, paramImageObserver);
    }
    return false;
  }
  ...
  {
    if (validate(paramSunGraphics2D)) {
      imagepipe.transformImage(paramSunGraphics2D, paramBufferedImage, paramBufferedImageOp, paramInt1, paramInt2);
    }
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\java2d\pipe\ValidatePipe.class
