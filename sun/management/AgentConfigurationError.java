...
public class AgentConfigurationError
  extends Error
{
  ...
  {
    error = paramString;
    params = ((String[])paramVarArgs.clone());
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\management\AgentConfigurationError.class
