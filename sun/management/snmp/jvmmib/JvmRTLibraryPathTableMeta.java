  ...
  implements Serializable
{
  ...
  {
    return new JvmRTLibraryPathEntryMeta(paramSnmpMib, objectserver);
  }
  ...
  {
    node = createJvmRTLibraryPathEntryMetaNode("JvmRTLibraryPathEntry", "JvmRTLibraryPathTable", paramSnmpMib, paramMBeanServer);
  }
  ...
  public void get(SnmpMibSubRequest paramSnmpMibSubRequest, SnmpOid paramSnmpOid, int paramInt)
    throws SnmpStatusException
  {
    JvmRTLibraryPathEntryMBean localJvmRTLibraryPathEntryMBean = (JvmRTLibraryPathEntryMBean)getEntry(paramSnmpOid);
    synchronized (this)
    {
      node.setInstance(localJvmRTLibraryPathEntryMBean);
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\management\snmp\jvmmib\JvmRTLibraryPathTableMeta.class
