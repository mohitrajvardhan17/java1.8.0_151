  ...
  implements Serializable, SnmpStandardMetaServer
{
    ...
    throws SnmpStatusException
  {
    ...
    case 6: 
      if ((paramSnmpValue instanceof SnmpInt))
      {
        try
        {
          node.setJvmThreadCpuTimeMonitoring(new EnumJvmThreadCpuTimeMonitoring(((SnmpInt)paramSnmpValue).toInteger()));
        }
    ...
    case 5: 
      if ((paramSnmpValue instanceof SnmpInt))
      {
        try
        {
          node.setJvmThreadContentionMonitoring(new EnumJvmThreadContentionMonitoring(((SnmpInt)paramSnmpValue).toInteger()));
        }
    ...
    case 7: 
      ...
      {
        node.setJvmThreadPeakCountReset(((SnmpCounter64)paramSnmpValue).toLong());
        return new SnmpCounter64(node.getJvmThreadPeakCountReset());
      }
      throw new SnmpStatusException(7);
    }
    ...
    throws SnmpStatusException
  {
    ...
    case 6: 
      if ((paramSnmpValue instanceof SnmpInt)) {
        try
        {
          node.checkJvmThreadCpuTimeMonitoring(new EnumJvmThreadCpuTimeMonitoring(((SnmpInt)paramSnmpValue).toInteger()));
        }
        catch (IllegalArgumentException localIllegalArgumentException1)
        {
          throw new SnmpStatusException(10);
    ...
    case 5: 
      if ((paramSnmpValue instanceof SnmpInt)) {
        try
        {
          node.checkJvmThreadContentionMonitoring(new EnumJvmThreadContentionMonitoring(((SnmpInt)paramSnmpValue).toInteger()));
        }
        catch (IllegalArgumentException localIllegalArgumentException2)
        {
          throw new SnmpStatusException(10);
    ...
    case 7: 
      if ((paramSnmpValue instanceof SnmpCounter64)) {
        node.checkJvmThreadPeakCountReset(((SnmpCounter64)paramSnmpValue).toLong());
      } else {
        throw new SnmpStatusException(7);
      }
      break;
  ...
  {
    tableJvmThreadInstanceTable = createJvmThreadInstanceTableMetaNode("JvmThreadInstanceTable", "JvmThreading", paramSnmpMib, paramMBeanServer);
    if (tableJvmThreadInstanceTable != null)
    {
      tableJvmThreadInstanceTable.registerEntryNode(paramSnmpMib, paramMBeanServer);
      paramSnmpMib.registerTableMeta("JvmThreadInstanceTable", tableJvmThreadInstanceTable);
    }
  }
  ...
  {
    return new JvmThreadInstanceTableMeta(paramSnmpMib, objectserver);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\management\snmp\jvmmib\JvmThreadingMeta.class
