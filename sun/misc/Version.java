...
public class Version
{
  ...
  private static final String java_version = "1.8.0_151";
  private static final String java_runtime_name = "Java(TM) SE Runtime Environment";
  private static final String java_profile_name = "";
  private static final String java_runtime_version = "1.8.0_151-b12";
  ...
  public static void init()
  {
    ...
    System.setProperty("java.runtime.version", "1.8.0_151-b12");
  ...
  public static void print(PrintStream paramPrintStream)
  {
    ...
    paramPrintStream.println("java version \"1.8.0_151\"");
    paramPrintStream.print("Java(TM) SE Runtime Environment (build 1.8.0_151-b12");
    if ("".length() > 0) {
  ...
  private static synchronized void initVersions()
  {
    ...
    if (!jvmVersionInfoAvailable)
    {
      ...
      if ((((CharSequence)localObject).length() >= 5) && (Character.isDigit(((CharSequence)localObject).charAt(0))) && (((CharSequence)localObject).charAt(1) == '.') && (Character.isDigit(((CharSequence)localObject).charAt(2))) && (((CharSequence)localObject).charAt(3) == '.') && (Character.isDigit(((CharSequence)localObject).charAt(4))))
      {
        ...
        if ((((CharSequence)localObject).charAt(0) == '_') && (((CharSequence)localObject).length() >= 3))
        {
          int i = 0;
          if ((Character.isDigit(((CharSequence)localObject).charAt(1))) && (Character.isDigit(((CharSequence)localObject).charAt(2))) && (Character.isDigit(((CharSequence)localObject).charAt(3)))) {
            i = 4;
          } else if ((Character.isDigit(((CharSequence)localObject).charAt(1))) && (Character.isDigit(((CharSequence)localObject).charAt(2)))) {
            i = 3;
          }
          try
          {
            String str1 = ((CharSequence)localObject).subSequence(1, i).toString();
            jvm_update_version = Integer.valueOf(str1).intValue();
            if (((CharSequence)localObject).length() >= i + 1)
            {
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\misc\Version.class
