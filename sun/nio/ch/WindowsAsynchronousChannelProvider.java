  ...
  extends AsynchronousChannelProvider
{
  ...
  public AsynchronousChannelGroup openAsynchronousChannelGroup(int paramInt, ThreadFactory paramThreadFactory)
    throws IOException
  {
    return new Iocp(this, ThreadPool.create(paramInt, paramThreadFactory)).start();
  }
  
  public AsynchronousChannelGroup openAsynchronousChannelGroup(ExecutorService paramExecutorService, int paramInt)
    throws IOException
  {
    return new Iocp(this, ThreadPool.wrap(paramExecutorService, paramInt)).start();
  }
  
  private Iocp toIocp(AsynchronousChannelGroup paramAsynchronousChannelGroup)
    throws IOException
  {
  ...
  public AsynchronousServerSocketChannel openAsynchronousServerSocketChannel(AsynchronousChannelGroup paramAsynchronousChannelGroup)
    throws IOException
  {
    return new WindowsAsynchronousServerSocketChannelImpl(toIocp(paramAsynchronousChannelGroup));
  }
  
  public AsynchronousSocketChannel openAsynchronousSocketChannel(AsynchronousChannelGroup paramAsynchronousChannelGroup)
    throws IOException
  {
    return new WindowsAsynchronousSocketChannelImpl(toIocp(paramAsynchronousChannelGroup));
  }
}
