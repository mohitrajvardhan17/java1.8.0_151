...
class UnsafeBooleanFieldAccessorImpl
  extends UnsafeFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getBoolean(paramObject, fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putBoolean(paramObject1, fieldOffset, ((Boolean)paramObject2).booleanValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putBoolean(paramObject, fieldOffset, paramBoolean);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeBooleanFieldAccessorImpl.class
