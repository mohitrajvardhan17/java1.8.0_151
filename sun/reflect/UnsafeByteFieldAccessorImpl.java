...
class UnsafeByteFieldAccessorImpl
  extends UnsafeFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getByte(paramObject, fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putByte(paramObject1, fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putByte(paramObject, fieldOffset, paramByte);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeByteFieldAccessorImpl.class
