  ...
  extends UnsafeQualifiedFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getBooleanVolatile(paramObject, fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putBooleanVolatile(paramObject1, fieldOffset, ((Boolean)paramObject2).booleanValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putBooleanVolatile(paramObject, fieldOffset, paramBoolean);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeQualifiedBooleanFieldAccessorImpl.class
