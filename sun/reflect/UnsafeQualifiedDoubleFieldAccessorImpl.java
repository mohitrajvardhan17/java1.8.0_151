  ...
  extends UnsafeQualifiedFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getDoubleVolatile(paramObject, fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putDoubleVolatile(paramObject1, fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    if ((paramObject2 instanceof Short))
    {
      unsafe.putDoubleVolatile(paramObject1, fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    if ((paramObject2 instanceof Character))
    {
      unsafe.putDoubleVolatile(paramObject1, fieldOffset, ((Character)paramObject2).charValue());
      return;
    }
    if ((paramObject2 instanceof Integer))
    {
      unsafe.putDoubleVolatile(paramObject1, fieldOffset, ((Integer)paramObject2).intValue());
      return;
    }
    if ((paramObject2 instanceof Long))
    {
      unsafe.putDoubleVolatile(paramObject1, fieldOffset, ((Long)paramObject2).longValue());
      return;
    }
    if ((paramObject2 instanceof Float))
    {
      unsafe.putDoubleVolatile(paramObject1, fieldOffset, ((Float)paramObject2).floatValue());
      return;
    }
    if ((paramObject2 instanceof Double))
    {
      unsafe.putDoubleVolatile(paramObject1, fieldOffset, ((Double)paramObject2).doubleValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putDoubleVolatile(paramObject, fieldOffset, paramDouble);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeQualifiedDoubleFieldAccessorImpl.class
