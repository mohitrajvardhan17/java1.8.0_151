  ...
  extends UnsafeQualifiedFieldAccessorImpl
{
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getShortVolatile(paramObject, fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putShortVolatile(paramObject1, fieldOffset, (short)((Byte)paramObject2).byteValue());
      return;
    }
    if ((paramObject2 instanceof Short))
    {
      unsafe.putShortVolatile(paramObject1, fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putShortVolatile(paramObject, fieldOffset, paramShort);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeQualifiedShortFieldAccessorImpl.class
