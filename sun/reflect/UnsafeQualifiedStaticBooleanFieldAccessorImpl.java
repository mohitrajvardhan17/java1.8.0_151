  ...
  extends UnsafeQualifiedStaticFieldAccessorImpl
{
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putBooleanVolatile(base, fieldOffset, ((Boolean)paramObject2).booleanValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putBooleanVolatile(base, fieldOffset, paramBoolean);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeQualifiedStaticBooleanFieldAccessorImpl.class
