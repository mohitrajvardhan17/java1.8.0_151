  ...
  extends UnsafeQualifiedStaticFieldAccessorImpl
{
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putCharVolatile(base, fieldOffset, ((Character)paramObject2).charValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putCharVolatile(base, fieldOffset, paramChar);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeQualifiedStaticCharacterFieldAccessorImpl.class
