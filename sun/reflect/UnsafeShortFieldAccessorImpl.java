...
class UnsafeShortFieldAccessorImpl
  extends UnsafeFieldAccessorImpl
{
  UnsafeShortFieldAccessorImpl(Field paramField)
  {
    super(paramField);
  }
    ...
    throws IllegalArgumentException
  {
    ...
    return unsafe.getShort(paramObject, fieldOffset);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putShort(paramObject1, fieldOffset, (short)((Byte)paramObject2).byteValue());
      return;
    }
    if ((paramObject2 instanceof Short))
    {
      unsafe.putShort(paramObject1, fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putShort(paramObject, fieldOffset, paramShort);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeShortFieldAccessorImpl.class
