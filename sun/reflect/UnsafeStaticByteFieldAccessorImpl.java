...
class UnsafeStaticByteFieldAccessorImpl
  extends UnsafeStaticFieldAccessorImpl
{
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putByte(base, fieldOffset, ((Byte)paramObject2).byteValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putByte(base, fieldOffset, paramByte);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeStaticByteFieldAccessorImpl.class
