...
class UnsafeStaticShortFieldAccessorImpl
  extends UnsafeStaticFieldAccessorImpl
{
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    {
      unsafe.putShort(base, fieldOffset, (short)((Byte)paramObject2).byteValue());
      return;
    }
    if ((paramObject2 instanceof Short))
    {
      unsafe.putShort(base, fieldOffset, ((Short)paramObject2).shortValue());
      return;
    }
    throwSetIllegalArgumentException(paramObject2);
  }
    ...
    throws IllegalArgumentException, IllegalAccessException
  {
    ...
    unsafe.putShort(base, fieldOffset, paramShort);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\reflect\UnsafeStaticShortFieldAccessorImpl.class
