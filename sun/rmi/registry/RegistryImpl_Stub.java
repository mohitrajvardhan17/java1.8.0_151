  ...
  implements Registry, Remote
{
    ...
    throws AccessException, AlreadyBoundException, RemoteException
  {
    try
    {
      RemoteCall localRemoteCall = ref.newCall(this, operations, 0, 4905912898345647071L);
      try
      {
    ...
    throws AccessException, RemoteException
  {
    try
    {
      RemoteCall localRemoteCall = ref.newCall(this, operations, 1, 4905912898345647071L);
      ref.invoke(localRemoteCall);
    ...
    throws AccessException, NotBoundException, RemoteException
  {
    try
    {
      RemoteCall localRemoteCall = ref.newCall(this, operations, 2, 4905912898345647071L);
      try
      {
        ObjectOutput localObjectOutput = localRemoteCall.getOutputStream();
        localObjectOutput.writeObject(paramString);
    ...
    throws AccessException, RemoteException
  {
    try
    {
      RemoteCall localRemoteCall = ref.newCall(this, operations, 3, 4905912898345647071L);
      try
      {
        ObjectOutput localObjectOutput = localRemoteCall.getOutputStream();
        localObjectOutput.writeObject(paramString);
    ...
    throws AccessException, NotBoundException, RemoteException
  {
    try
    {
      RemoteCall localRemoteCall = ref.newCall(this, operations, 4, 4905912898345647071L);
      try
      {
        ObjectOutput localObjectOutput = localRemoteCall.getOutputStream();
        localObjectOutput.writeObject(paramString);
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\rmi\registry\RegistryImpl_Stub.class
