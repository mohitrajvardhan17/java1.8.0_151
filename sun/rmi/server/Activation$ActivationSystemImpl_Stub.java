  ...
  implements ActivationSystem, Remote
{
  ...
  static
  {
    try
    {
      $method_activeGroup_0 = ActivationSystem.class.getMethod("activeGroup", new Class[] { ActivationGroupID.class, ActivationInstantiator.class, Long.TYPE });
    ...
    throws RemoteException, ActivationException, UnknownGroupException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_activeGroup_0, new Object[] { paramActivationGroupID, paramActivationInstantiator, new Long(paramLong) }, -4575843150759415294L);
    ...
    throws RemoteException, ActivationException, UnknownObjectException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getActivationDesc_1, new Object[] { paramActivationID }, 4830055440982622087L);
    ...
    throws RemoteException, ActivationException, UnknownGroupException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_getActivationGroupDesc_2, new Object[] { paramActivationGroupID }, -8701843806548736528L);
    ...
    throws RemoteException, ActivationException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_registerGroup_3, new Object[] { paramActivationGroupDesc }, 6921515268192657754L);
    ...
    throws RemoteException, ActivationException, UnknownGroupException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_registerObject_4, new Object[] { paramActivationDesc }, -3006759798994351347L);
    ...
    throws RemoteException, ActivationException, UnknownGroupException, UnknownObjectException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_setActivationDesc_5, new Object[] { paramActivationID, paramActivationDesc }, 7128043237057180796L);
      return (ActivationDesc)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws RemoteException, ActivationException, UnknownGroupException
  {
    try
    {
      Object localObject = ref.invoke(this, $method_setActivationGroupDesc_6, new Object[] { paramActivationGroupID, paramActivationGroupDesc }, 1213918527826541191L);
      return (ActivationGroupDesc)localObject;
    }
    catch (RuntimeException localRuntimeException)
    {
    ...
    throws RemoteException, ActivationException, UnknownGroupException
  {
    try
    {
      ref.invoke(this, $method_unregisterGroup_8, new Object[] { paramActivationGroupID }, 3768097077835970701L);
    }
    catch (RuntimeException localRuntimeException)
    {
      throw localRuntimeException;
    ...
    throws RemoteException, ActivationException, UnknownObjectException
  {
    try
    {
      ref.invoke(this, $method_unregisterObject_9, new Object[] { paramActivationID }, -6843850585331411084L);
    }
    catch (RuntimeException localRuntimeException)
    {
      throw localRuntimeException;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\rmi\server\Activation$ActivationSystemImpl_Stub.class
