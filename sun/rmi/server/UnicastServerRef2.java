  ...
  extends UnicastServerRef
{
  ...
  {
    super(paramLiveRef, paramObjectInputFilter);
  }
  ...
  {
    super(new LiveRef(paramInt, paramRMIClientSocketFactory, paramRMIServerSocketFactory), paramObjectInputFilter);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\rmi\server\UnicastServerRef2.class
