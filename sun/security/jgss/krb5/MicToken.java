  ...
  extends MessageToken
{
  public MicToken(Krb5Context paramKrb5Context, byte[] paramArrayOfByte, int paramInt1, int paramInt2, MessageProp paramMessageProp)
    throws GSSException
  {
    super(257, paramKrb5Context, paramArrayOfByte, paramInt1, paramInt2, paramMessageProp);
  }
  
  public MicToken(Krb5Context paramKrb5Context, InputStream paramInputStream, MessageProp paramMessageProp)
    throws GSSException
  {
    super(257, paramKrb5Context, paramInputStream, paramMessageProp);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\jgss\krb5\MicToken.class
