  ...
  extends EncKDCRepPart
{
  ...
  {
    super(paramEncryptionKey, paramLastReq, paramInt, paramKerberosTime1, paramTicketFlags, paramKerberosTime2, paramKerberosTime3, paramKerberosTime4, paramKerberosTime5, paramPrincipalName, paramHostAddresses, 26);
  }
  ...
  public EncTGSRepPart(DerValue paramDerValue)
    throws Asn1Exception, IOException, KrbException
  {
    init(paramDerValue);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\krb5\internal\EncTGSRepPart.class
