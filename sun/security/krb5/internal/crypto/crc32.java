  ...
  implements Cloneable
{
  ...
  public Object clone()
  {
    try
    {
      crc32 localcrc32 = (crc32)super.clone();
      localcrc32.init();
      return localcrc32;
    }
  ...
  private void processData(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    for (int j = 0; j < paramInt2; j++) {
      i = i >>> 8 ^ crc32Table[((i ^ paramArrayOfByte[j]) & 0xFF)];
    }
    seed = i;
  }
  ...
  public static void printcrc32Table()
  {
    ...
    for (int i = 0; i < 256; i++)
    {
      ...
      String str1 = Integer.toHexString(int2crc32(i));
      System.out.print("0x" + str2.substring(str1.length()) + str1);
      if (i != 255) {
        System.out.print(", ");
      }
    }
  ...
  {
    return byte2crc32sum(paramInt, paramArrayOfByte, paramArrayOfByte.length);
  }
  
  public static int byte2crc32sum(byte[] paramArrayOfByte)
  {
    return byte2crc32sum(0, paramArrayOfByte);
  }
  
  public static int byte2crc32(byte[] paramArrayOfByte)
  {
    return byte2crc32sum(-1, paramArrayOfByte) ^ 0xFFFFFFFF;
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\krb5\internal\crypto\crc32.class
