...
final class ByteArrayAccess
{
  ...
  static
  {
    int i = (unsafe.arrayIndexScale(byte[].class) == 1) && (unsafe.arrayIndexScale(int[].class) == 4) && (unsafe.arrayIndexScale(long[].class) == 8) && ((byteArrayOfs & 0x3) == 0) ? 1 : 0;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\provider\ByteArrayAccess.class
