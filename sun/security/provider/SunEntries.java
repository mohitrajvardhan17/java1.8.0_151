...
final class SunEntries
{
  ...
  static void putEntries(Map<Object, Object> paramMap)
  {
    ...
    int i = (seedSource.equals("file:/dev/urandom")) || (seedSource.equals("file:/dev/random")) ? 1 : 0;
    if ((bool) && (i != 0)) {
  ...
  static File getDeviceFile(URL paramURL)
    throws IOException
  {
    try
    {
      URI localURI1 = paramURL.toURI();
      if (localURI1.isOpaque())
      {
        URI localURI2 = new File(System.getProperty("user.dir")).toURI();
        String str = localURI2.toString() + localURI1.toString().substring(5);
        return new File(URI.create(str));
      }
      return new File(localURI1);
    }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\provider\SunEntries.class
