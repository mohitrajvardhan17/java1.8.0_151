  ...
  extends PlatformPCSC
{
  ...
  static native long SCardEstablishContext(int paramInt)
    throws PCSCException;
  
  static native String[] SCardListReaders(long paramLong)
    throws PCSCException;
  
  static native long SCardConnect(long paramLong, String paramString, int paramInt1, int paramInt2)
    throws PCSCException;
  
  static native byte[] SCardTransmit(long paramLong, int paramInt1, byte[] paramArrayOfByte, int paramInt2, int paramInt3)
    throws PCSCException;
  
  static native byte[] SCardStatus(long paramLong, byte[] paramArrayOfByte)
    throws PCSCException;
  
  static native void SCardDisconnect(long paramLong, int paramInt)
    throws PCSCException;
  
  static native int[] SCardGetStatusChange(long paramLong1, long paramLong2, int[] paramArrayOfInt, String[] paramArrayOfString)
    throws PCSCException;
  
  static native void SCardBeginTransaction(long paramLong)
    throws PCSCException;
  
  static native void SCardEndTransaction(long paramLong, int paramInt)
    throws PCSCException;
  
  static native byte[] SCardControl(long paramLong, int paramInt, byte[] paramArrayOfByte)
    throws PCSCException;
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\smartcardio\PCSC.class
