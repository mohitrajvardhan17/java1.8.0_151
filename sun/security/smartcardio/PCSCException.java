  ...
  extends Exception
{
  ...
  private static String toErrorString(int paramInt)
  {
    ...
    return "Unknown error 0x" + Integer.toHexString(paramInt);
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\smartcardio\PCSCException.class
