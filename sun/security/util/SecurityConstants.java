...
public final class SecurityConstants
{
  ...
  public static class AWT
  {
    ...
    private static PermissionFactory<?> permissionFactory()
    {
      ...
      try
      {
        localClass = Class.forName("sun.awt.AWTPermissionFactory", false, AWT.class.getClassLoader());
      }
      ...
      try
      {
        return (PermissionFactory)localClass.newInstance();
      }
    ...
    {
      return factory == null ? null : factory.newPermission(paramString);
    }
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\util\SecurityConstants.class
