...
public abstract class Validator
{
  ...
  Validator(String paramString1, String paramString2)
  {
    ...
    endEntityChecker = EndEntityChecker.getInstance(paramString1, paramString2);
  }
    ...
    throws CertificateException
  {
    ...
    if (paramArrayOfX509Certificate.length > 1) {
      endEntityChecker.check(paramArrayOfX509Certificate[0], paramObject);
    }
  ...
  {
    validationDate = paramDate;
  }
}


/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\security\validator\Validator.class
