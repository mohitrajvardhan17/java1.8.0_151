...
public abstract interface LightweightContent
{
  ...
  {
    imageBufferReset(paramArrayOfInt, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5);
  }
  
  public void imageBufferReset(int[] paramArrayOfInt, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    imageBufferReset(paramArrayOfInt, paramInt1, paramInt2, paramInt3, paramInt4, paramInt5, 1);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\swing\LightweightContent.class
