...
class JVM
{
  ...
  {
    return activate0(paramString, paramArrayOfDTraceProvider);
  }
  ...
  {
    return defineClass0(paramClassLoader, paramString, paramArrayOfByte, paramInt1, paramInt2);
  }
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\tracing\dtrace\JVM.class
