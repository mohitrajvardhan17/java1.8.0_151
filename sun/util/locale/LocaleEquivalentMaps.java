...
{
  static final Map<String, String> singleEquivMap = new HashMap();
  static final Map<String, String[]> multiEquivsMap = new HashMap();
  static final Map<String, String> regionVariantEquivMap = new HashMap();
...
/* Location:              C:\Program Files (x86)\Java\jre1.8.0_151\lib\rt.jar!\sun\util\locale\LocaleEquivalentMaps.class
